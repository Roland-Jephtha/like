const __vite__mapDeps = (i, m = __vite__mapDeps, d = (m.f || (m.f = ["assets/secp256k1-C0Lsfddy.js", "assets/vendor-ui-web3-eRcc0gXJ.js", "assets/vendor-react-CFIG0l__.js", "assets/basic-pibtUUpJ.js", "assets/index-Dh7i4oda.js", "assets/w3m-modal-f4LYPdeb.js"]))) => i.map(i => d[i]);
import {
    aY as Wr,
    ah as Nd,
    aZ as Ur,
    ...
    V as Li,
    bx as ga
} from "./vendor-ui-web3-eRcc0gXJ.js";
(function() {
    try {
        ...
        e && (t._sentryDebugIds = t._sentryDebugIds || {}, t._sentryDebugIds[e] = "c88dd76e-ff6e-4a43-bad7-20a61a36b5f0", t._sentryDebugIdIdentifier = "sentry-dbid-c88dd76e-ff6e-4a43-bad7-20a61a36b5f0")
    } catch {}
})();
var ma = {};
const z = {
        ...
        SECURE_SITE_SDK_ORIGIN: (typeof process < "u" && typeof ma < "u" ? ma.NEXT_PUBLIC_SECURE_SITE_ORIGIN : void 0) || "https://secure.walletconnect.org"
    },
    $l = {
    ...
    Rd = {
        bigNumber(t) {
            return t ? new Wr(t) : new Wr(0)
        },
        multiply(t, e) {
            if (t === void 0 || e === void 0) return new Wr(0);
            const s = new Wr(t),
                r = new Wr(e);
            return s.times(r)
        },
    ...
    Md = {
        getERC20Abi: t => z.USDT_CONTRACT_ADDRESSES.includes(t) ? Ld : Ud,
        getSwapAbi: () => Dd
    },
    as = {
...
const Z = {
    setItem(t, e) {
        Qr() && e !== void 0 && localStorage.setItem(t, e)
    },
    getItem(t) {
        if (Qr()) return localStorage.getItem(t) || void 0
    },
    removeItem(t) {
        Qr() && localStorage.removeItem(t)
    },
    clear() {
        Qr() && localStorage.clear()
    }
};
...
const Bd = Symbol(),
    ...
    ao = new WeakMap,
    jd = t => t && (ao.has(t) ? ao.get(t) : wa(t) === Object.prototype || wa(t) === Array.prototype),
    qd = t => jd(t) && t[Bd] || null,
    ya = (t, e = !0) => {
        ao.set(t, e)
    },
    on = {},
    Pn = t => typeof t == "object" && t !== null,
    ps = new WeakMap,
    ei = new WeakSet,
    Fd = (t = Object.is, e = (l, u) => new Proxy(l, u), s = l => Pn(l) && !ei.has(l) && (Array.isArray(l) || !(Symbol.iterator in l)) && !(l instanceof WeakMap) && !(l instanceof WeakSet) && !(l instanceof Error) && !(l instanceof Number) && !(l instanceof Date) && !(l instanceof String) && !(l instanceof RegExp) && !(l instanceof ArrayBuffer), r = l => {
        switch (l.status) {
            case "fulfilled":
                return l.value;
            case "rejected":
    ...
    }, i = new WeakMap, n = (l, u, d = r) => {
        const h = i.get(l);
        if (h ? .[0] === u) return h[1];
        const f = Array.isArray(l) ? [] : Object.create(Object.getPrototypeOf(l));
        return ya(f, !0), i.set(l, [u, f]), Reflect.ownKeys(l).forEach(m => {
            if (Object.getOwnPropertyDescriptor(f, m)) return;
            const w = Reflect.get(l, m),
                {
                    enumerable: g
                } = Reflect.getOwnPropertyDescriptor(l, m),
                y = {
                    value: w,
                    enumerable: g,
                    configurable: !0
            ...
            if (ei.has(w)) ya(w, !1);
            else if (w instanceof Promise) delete y.value, y.get = () => d(w);
            else if (ps.has(w)) {
                const [b, I] = ps.get(w);
                y.value = n(b, I(), d)
            }
        ...
        if (!Pn(l)) throw new Error("object required");
        const u = o.get(l);
        if (u) return u;
        let d = a[0];
        const h = new Set,
        ...
        let m = a[1];
        const w = (v = ++a[1]) => (m !== v && !h.size && (m = v, y.forEach(([$]) => {
                const E = $[1](v);
                E > d && (d = E)
            })), d),
            g = v => ($, E) => {
            ...
            y = new Map,
            b = (v, $) => {
                if ((on ? "production" : void 0) !== "production" && y.has(v)) throw new Error("prop listener already exists");
                if (h.size) {
                    const E = $[3](g(v));
                    y.set(v, [$, E])
                } else y.set(v, [$])
            ...
            I = v => {
                var $;
                const E = y.get(v);
                E && (y.delete(v), ($ = E[1]) == null || $.call(E))
            },
            O = v => (h.add(v), h.size === 1 && y.forEach(([E, L], H) => {
                if ((on ? "production" : void 0) !== "production" && L) throw new Error("remove already exists");
                const C = E[3](g(H));
                y.set(H, [E, C])
            }), () => {
                h.delete(v), h.size === 0 && y.forEach(([E, L], H) => {
                    L && (L(), y.set(H, [E]))
                })
            }),
            ...
            _ = e(x, {
                deleteProperty(v, $) {
                    const E = Reflect.get(v, $);
                    I($);
                    const L = Reflect.deleteProperty(v, $);
                    return L && f(["delete", [$], E]), L
                },
                set(v, $, E, L) {
                    const H = Reflect.has(v, $),
                        C = Reflect.get(v, $, L);
                    if (H && (t(C, E) || o.has(E) && t(C, o.get(E)))) return !0;
                    I($), Pn(E) && (E = qd(E) || E);
                    let k = E;
                    if (E instanceof Promise) E.then(A => {
                        E.status = "fulfilled", E.value = A, f(["resolve", [$], A])
                    }).catch(A => {
                        E.status = "rejected", E.reason = A, f(["reject", [$], A])
                    });
                    else {
                        !ps.has(E) && s(E) && (k = c(E));
                        const A = !ei.has(k) && ps.get(k);
                        A && b($, A)
                    }
                    return Reflect.set(v, $, k, L), f(["set", [$], E, C]), !0
                }
            });
        o.set(l, _);
        const D = [x, w, n, O];
        return ps.set(_, D), Reflect.ownKeys(l).forEach(v => {
            const $ = Object.getOwnPropertyDescriptor(l, v);
            "value" in $ && (_[v] = l[v], delete $.value, delete $.writable), Object.defineProperty(x, v, $)
        }), _
    }) => [c, ps, ei, t, e, s, r, i, n, o, a],
    [Wd] = Fd();
...
function Xe(t, e, s) {
    const r = ps.get(t);
    (on ? "production" : void 0) !== "production" && !r && console.warn("Please use proxy object");
    let i;
    const n = [],
        o = r[3];
    let a = !1;
...
function gi(t, e) {
    const s = ps.get(t);
    (on ? "production" : void 0) !== "production" && !s && console.warn("Please use proxy object");
    const [r, i, n] = s;
    return n(r, i(), e)
}
...
const xl = [{
    ...
    Hd = "WXETMuFUQmqqybHuRkSgxv:25B8LJHSfpG6LVjR2ytU5Cwh7Z4Sch2ocoU",
    be = {
    ...
    F = {
        ...
        setActiveCaipNetworkId(t) {
            try {
                Z.setItem(ee.ACTIVE_CAIP_NETWORK_ID, t), F.setActiveNamespace(t.split(":")[0])
            } catch {
        ...
        removeAddressFromBalanceCache(t) {
            try {
                ...
                Z.setItem(ee.PORTFOLIO_CACHE, JSON.stringify({ ...e,
                    [t]: void 0
                }))
            } catch {
        ...
        removeAddressFromNativeBalanceCache(t) {
            try {
                const e = F.getBalanceCache();
                Z.setItem(ee.NATIVE_BALANCE_CACHE, JSON.stringify({ ...e,
                    [t]: void 0
                }))
            } catch {
                console.info("Unable to remove address from balance cache", t)
        ...
        removeEnsFromCache(t) {
            try {
                const e = F.getEnsCache();
                Z.setItem(ee.ENS_CACHE, JSON.stringify({ ...e,
                    [t]: void 0
                }))
            } catch {
    ...
    X = {
        ...
        isPairingExpired(t) {
            return t ? t - Date.now() <= be.TEN_SEC_MS : !0
        },
        ...
        isSafeApp() {
            if (X.isClient() && window.self !== window.top) try {
        ...
        formatNativeUrl(t, e, s = null) {
            ...
            let r = t,
                i = s;
            r.includes("://") || (r = t.replaceAll("/", "").replaceAll(":", ""), r = `${r}://`), r.endsWith("/") || (r = `${r}/`), i && !i ? .endsWith("/") && (i = `${i}/`), this.isTelegram() && this.isAndroid() && (e = encodeURIComponent(e));
        ...
        generateSdkVersion(t, e, s) {
            const i = t.length === 0 ? be.ADAPTER_TYPES.UNIVERSAL : t.map(n => n.adapterType).join(",");
            return `${e}-${i}-${s}`
        },
...
const Vd = {
        ...
        filterSocialsByPlatform(t) {
            ...
            if (X.isTelegram()) {
                ...
                if (X.isAndroid()) return t.filter(e => !["facebook", "x"].includes(e))
            }
            return t
        }
    },
    ...
    S = {
        ...
        setRemoteFeatures(t) {
            ...
            K.remoteFeatures = e, K.remoteFeatures ? .socials && (K.remoteFeatures.socials = Vd.filterSocialsByPlatform(K.remoteFeatures.socials))
        },
        setFeatures(t) {
            if (!t) return;
            K.features || (K.features = be.DEFAULT_FEATURES);
            const e = { ...K.features,
                ...t
            };
            K.features = e
...
class Ar extends Error {
    constructor(e, s, r) {
        super(e), this.name = "AppKitError", this.category = s, this.originalError = r, Object.setPrototypeOf(this, Ar.prototype);
        let i = !1;
...
${a}`, i = !0
        ...
        i || (Error.captureStackTrace ? Error.captureStackTrace(this, Ar) : this.stack || (this.stack = `${this.name}: ${this.message}`))
    }
}

function ba(t, e) {
    const s = t instanceof Ar ? t : new Ar(t instanceof Error ? t.message : String(t), e, t);
    throw Xd.sendError(s, s.category), s
}

function bt(t, e = "INTERNAL_SDK_ERROR") {
    const s = {};
...
const Wt = {
    ...
    Zd = {
        handleMobileDeeplinkRedirect(t, e) {
            ...
            if (t === Wt.PHANTOM.id && !("phantom" in window)) {
                const i = s.startsWith("https") ? "https" : "http",
                    n = s.split("/")[2],
                    o = encodeURIComponent(`${i}://${n}`);
                window.location.href = `${Wt.PHANTOM.url}/ul/browse/${r}?ref=${o}`
            }
            t === Wt.SOLFLARE.id && !("solflare" in window) && (window.location.href = `${Wt.SOLFLARE.url}/ul/v1/browse/${r}?ref=${r}`), e === z.CHAIN.SOLANA && t === Wt.COINBASE.id && !("coinbaseSolana" in window) && (window.location.href = `${Wt.COINBASE.url}/dapp?cb_url=${r}`)
        }
    },
    ut = Ae({
        walletImages: {},
    ...
    Qd = {
        ...
        setConnectorImage(t, e) {
            ut.connectorImages = { ...ut.connectorImages,
                [t]: e
            }
        },
        setTokenImage(t, e) {
    ...
    Rl = {
        ...
        async fetchNetworkImage(t) {
            ...
            return e || (kn.networkImagePromises[t] || (kn.networkImagePromises[t] = V._fetchNetworkImage(t)), await kn.networkImagePromises[t], this.getNetworkImageById(t))
        },
        getWalletImageById(t) {
            if (t) return xt.state.walletImages[t]
        },
        getWalletImage(t) {
            if (t ? .image_url) return t ? .image_url;
            if (t ? .image_id) return xt.state.walletImages[t.image_id]
        },
        getNetworkImage(t) {
            if (t ? .assets ? .imageUrl) return t ? .assets ? .imageUrl;
            if (t ? .assets ? .imageId) return xt.state.networkImages[t.assets.imageId]
        },
        getNetworkImageById(t) {
            if (t) return xt.state.networkImages[t]
        },
        getConnectorImage(t) {
            if (t ? .imageUrl) return t.imageUrl;
            if (t ? .imageId) return xt.state.connectorImages[t.imageId]
        },
        getChainImage(t) {
            return xt.state.networkImages[eh[t]]
        }
    },
    ls = Ae({
        message: "",
    ...
    th = {
        ...
        open(t, e) {
            ...
            s && (ls.message = r, ls.variant = e, ls.open = !0), i && console.error(typeof i == "function" ? i() : i)
        },
        close() {
            ls.open = !1, ls.message = "", ls.variant = "info"
        }
    },
    xs = bt(th),
    sh = X.getAnalyticsUrl(),
    rh = new _i({
        baseUrl: sh,
        clientId: null
    }),
    ...
    Se = {
        ...
        async _sendAnalyticsEvent(t) {
            try {
                ...
                if (ih.includes(t.data.event) || typeof window > "u") return;
                await rh.post({
                    path: "/e",
                ...
                e instanceof Error && e.cause instanceof Response && e.cause.status === z.HTTP_STATUS_CODES.FORBIDDEN && !Jt.reportedErrors.FORBIDDEN && (xs.open({
                    shortMessage: "Invalid App Configuration",
                    longMessage: `Origin ${Qr()?window.origin:"uknown"} not found on Allowlist - update configuration on cloud.reown.com`
                }, "error"), Jt.reportedErrors.FORBIDDEN = !0)
            }
        },
        sendEvent(t) {
            Jt.timestamp = Date.now(), Jt.data = t, S.state.features ? .analytics && Se._sendAnalyticsEvent(Jt)
        }
    },
    nh = X.getApiUrl(),
    st = new _i({
    ...
    V = {
        ...
        async _fetchWalletImage(t) {
            const e = `${st.baseUrl}/getWalletImage/${t}`,
                s = await st.getBlob({
                    path: e,
        ...
        async _fetchNetworkImage(t) {
            const e = `${st.baseUrl}/public/getAssetImage/${t}`,
                s = await st.getBlob({
                    path: e,
                    params: V._getSdkProperties()
                });
        ...
        async _fetchCurrencyImage(t) {
            const e = `${st.baseUrl}/public/getCurrencyImage/${t}`,
                s = await st.getBlob({
                    path: e,
                    params: V._getSdkProperties()
                });
        ...
        async _fetchTokenImage(t) {
            const e = `${st.baseUrl}/public/getTokenImage/${t}`,
                s = await st.getBlob({
                    path: e,
                    params: V._getSdkProperties()
                });
        ...
        _filterWalletsByPlatform(t) {
            return X.isMobile() ? t ? .filter(s => s.mobile_link || s.id === Wt.COINBASE.id ? !0 : p.state.activeChain === "solana" && (s.id === Wt.SOLFLARE.id || s.id === Wt.PHANTOM.id)) : t
        },
        ...
        async fetchNetworkImages() {
            const e = p.getAllRequestedCaipNetworks() ? .map(({
                assets: s
            }) => s ? .imageId).filter(Boolean).filter(s => !Rl.getNetworkImageById(s));
        ...
        async fetchWallets(t) {
            const e = t.exclude ? ? [];
            V._getSdkProperties().sv.startsWith("html-core-") && e.push(...Object.values(Wt).map(n => n.id));
        ...
        async fetchRecommendedWallets() {
            try {
                ...
                const {
                    ...
                    excludeWalletIds: e,
                    featuredWalletIds: s
                } = S.state, r = [...e ? ? [], ...s ? ? []].filter(Boolean), i = p.getRequestedCaipNetworkIds().join(","), n = {
                    page: 1,
                    entries: va,
                    include: t,
                    exclude: r,
                    ...
                    data: o,
                    count: a
                } = await V.fetchWallets(n), c = F.getRecentWallets(), l = o.map(d => d.image_id).filter(Boolean), u = c.map(d => d.image_id).filter(Boolean);
                await Promise.allSettled([...l, ...u].map(d => V._fetchWalletImage(d))), te.recommended = o, te.allRecommended = o, te.count = a ? ? 0
            } catch {} finally {
        ...
        async fetchWalletsByPage({
            ...
            const {
                ...
                excludeWalletIds: s,
                featuredWalletIds: r
            } = S.state, i = p.getRequestedCaipNetworkIds().join(","), n = [...te.recommended.map(({
                id: u
            }) => u), ...s ? ? [], ...r ? ? []].filter(Boolean), o = {
                page: t,
                entries: oh,
                include: e,
                exclude: n,
                ...
                data: a,
                count: c
            } = await V.fetchWallets(o), l = a.slice(0, ah).map(u => u.image_id).filter(Boolean);
            await Promise.allSettled(l.map(u => V._fetchWalletImage(u))), te.wallets = X.uniqueBy([...te.wallets, ...V._filterOutExtensions(a)], "id").filter(u => u.chains ? .some(d => i.includes(d))), te.count = c > te.count ? c : te.count, te.page = t
        },
        ...
        async searchWallet({
            ...
            const {
                includeWalletIds: s,
                excludeWalletIds: r
            } = S.state, i = p.getRequestedCaipNetworkIds().join(",");
            te.search = [];
            const n = {
                    page: 1,
                    entries: 100,
            ...
            await Promise.allSettled([...a.map(c => V._fetchWalletImage(c)), X.wait(300)]), te.search = V._filterOutExtensions(o)
        },
        initPromise(t, e) {
        ...
        filterByNamespaces(t) {
            ...
            te.featured = te.allFeatured.filter(s => s.chains ? .some(r => e.includes(r))), te.recommended = te.allRecommended.filter(s => s.chains ? .some(r => e.includes(r))), te.filteredWallets = te.wallets.filter(s => s.chains ? .some(r => e.includes(r)))
        },
    ...
    ch = {
        ...
        pushTransactionStack(t) {
            ge.transactionStack.push(t)
        },
        popTransactionStack(t) {
            const e = ge.transactionStack.pop();
            if (!e) return;
            const {
                onSuccess: s,
                onError: r,
        ...
        push(t, e) {
            t !== ge.view && (ge.view = t, ge.history.push(t), ge.data = e)
        },
        reset(t, e) {
            ge.view = t, ge.history = [t], ge.data = e
        },
        replace(t, e) {
            ge.history.at(-1) === t || (ge.view = t, ge.history[ge.history.length - 1] = t, ge.data = e)
        },
        goBack() {
            const t = p.state.activeCaipAddress,
                e = re.state.view === "ConnectingFarcaster",
                s = !t && e;
            if (ge.history.length > 1) {
                ge.history.pop();
                const [r] = ge.history.slice(-1);
                r && (t && r === "Connect" ? ge.view = "Account" : ge.view = r)
            } else Fe.close();
            ge.data ? .wallet && (ge.data.wallet = void 0), setTimeout(() => {
                if (s) {
        ...
        goBackToIndex(t) {
            if (ge.history.length > 1) {
                ge.history = ge.history.slice(0, t + 1);
                const [e] = ge.history.slice(-1);
                e && (ge.view = e)
            }
        },
        goBackOrCloseModal() {
            re.state.history.length > 1 ? re.goBack() : Fe.close()
        }
    },
    re = bt(ch),
    Yt = Ae({
    ...
    co = {
        ...
        setThemeVariables(t) {
            Yt.themeVariables = { ...Yt.themeVariables,
                ...t
            };
            try {
                const e = j.getAuthConnector();
                if (e) {
                    ...
                    e.provider.syncTheme({
                        themeVariables: s,
                        w3mThemeVariables: ws(Yt.themeVariables, Yt.themeMode)
                    })
                }
            } catch {
                console.info("Unable to sync theme to auth connector")
    ...
    lh = {
        ...
        initialize(t) {
            t.forEach(e => {
                ...
                s && j.setConnectorId(s, e)
            })
        },
        setActiveConnector(t) {
            t && (ae.activeConnector = qs(t))
        },
        setConnectors(t) {
            t.filter(i => !ae.allConnectors.some(n => n.id === i.id && j.getConnectorName(n.name) === j.getConnectorName(i.name) && n.chain === i.chain)).forEach(i => {
                i.type !== "MULTI_CHAIN" && ae.allConnectors.push(qs(i))
            });
            const s = j.getEnabledNamespaces(),
                r = j.getEnabledConnectors(s);
            ae.connectors = j.mergeMultiChainConnectors(r)
        },
        filterByNamespaces(t) {
            ...
            }), j.updateConnectorsForEnabledNamespaces()
        },
        filterByNamespace(t, e) {
            ae.filterByNamespaceMap[t] = e, j.updateConnectorsForEnabledNamespaces()
        },
        updateConnectorsForEnabledNamespaces() {
            const t = j.getEnabledNamespaces(),
                e = j.getEnabledConnectors(t),
                s = j.areAllNamespacesEnabled();
            ae.connectors = j.mergeMultiChainConnectors(e), s ? V.clearFilterByNamespaces() : V.filterByNamespaces(t)
        },
        ...
        mergeMultiChainConnectors(t) {
            const e = j.generateConnectorMapByName(t),
                s = [];
            return e.forEach(r => {
                const i = r[0],
        ...
        addConnector(t) {
            if (t.id === z.CONNECTOR_ID.AUTH) {
                const e = t,
                    s = gi(S.state),
                    r = pt.getSnapshot().themeMode,
                    i = pt.getSnapshot().themeVariables;
            ...
            } else j.setConnectors([t])
        },
        getAuthConnector(t) {
            const e = t || p.state.activeChain,
                s = ae.connectors.find(r => r.id === z.CONNECTOR_ID.AUTH);
            if (s) return s ? .connectors ? .length ? s.connectors.find(i => i.chain === e) : s
        },
        getAnnouncedConnectorRdns() {
            return ae.connectors.filter(t => t.type === "ANNOUNCED").map(t => t.info ? .rdns)
        },
        getConnectorById(t) {
            return ae.allConnectors.find(e => e.id === t)
        },
        getConnector(t, e) {
            return ae.allConnectors.filter(r => r.chain === p.state.activeChain).find(r => r.explorerId === t || r.info ? .rdns === e)
        },
        ...
        getConnectorsByNamespace(t) {
            ...
            return j.mergeMultiChainConnectors(e)
        },
        selectWalletConnector(t) {
            const e = j.getConnector(t.id, t.rdns),
                s = p.state.activeChain;
            Zd.handleMobileDeeplinkRedirect(e ? .explorerId || t.id, s), e ? re.push("ConnectingExternal", {
                connector: e
            }) : re.push("ConnectingWalletConnect", {
                wallet: t
            })
        },
        getConnectors(t) {
            return t ? j.getConnectorsByNamespace(t) : j.mergeMultiChainConnectors(ae.allConnectors)
        },
        setFilterByNamespace(t) {
            ae.filterByNamespace = t, ae.connectors = j.getConnectors(t), V.setFilterByNamespace(t)
        },
        setConnectorId(t, e) {
            t && (ae.activeConnectorIds = { ...ae.activeConnectorIds,
                [e]: t
            }, F.setConnectedConnectorId(e, t))
        },
        removeConnectorId(t) {
            ae.activeConnectorIds = { ...ae.activeConnectorIds,
                [t]: void 0
            }, F.deleteConnectedConnectorId(t)
        },
        getConnectorId(t) {
            if (t) return ae.activeConnectorIds[t]
        },
        isConnected(t) {
            return t ? !!ae.activeConnectorIds[t] : Object.values(ae.activeConnectorIds).some(e => !!e)
        },
        resetConnectorIds() {
            ae.activeConnectorIds = { ...Ul
            }
        }
    },
    j = bt(lh),
    ...
    uh = {
        ...
        hide() {
            Re.message = Os.message, Re.variant = Os.variant, Re.svg = Os.svg, Re.open = Os.open, Re.autoClose = Os.autoClose
        },
        _showMessage({
            message: t,
            svg: e,
            variant: s = "success",
            autoClose: r = Os.autoClose
        }) {
            Re.open ? (Re.open = !1, setTimeout(() => {
                Re.message = t, Re.variant = s, Re.svg = e, Re.open = !0, Re.autoClose = r
            }, 150)) : (Re.message = t, Re.variant = s, Re.svg = e, Re.open = !0, Re.autoClose = r)
        }
    },
    Rt = uh,
    Ee = Ae({
    ...
    dh = {
        ...
        async fetchTransactions(t, e) {
            ...
            try {
                const s = await J.fetchTransactions({
                    ...
                    r = ti.filterSpamTransactions(s.data),
                    i = ti.filterByConnectedChain(r),
                    n = [...Ee.transactions, ...i];
                Ee.loading = !1, e === "coinbase" ? Ee.coinbaseTransactions = ti.groupTransactionsByYearAndMonth(Ee.coinbaseTransactions, s.data) : (Ee.transactions = n, Ee.transactionsByYear = ti.groupTransactionsByYearAndMonth(Ee.transactionsByYear, i)), Ee.empty = n.length === 0, Ee.next = s.next ? s.next : void 0
            } catch {
                const r = p.state.activeChain;
                Se.sendEvent({
                    type: "track",
                    ...
                    properties: {
                        ...
                        cursor: Ee.next,
                        isSmartAccount: W.state.preferredAccountTypes ? .[r] === ni.ACCOUNT_TYPES.SMART_ACCOUNT
                    }
                }), Rt.showError("Failed to fetch transactions"), Ee.loading = !1, Ee.empty = !0, Ee.next = void 0
            }
        },
        ...
        resetTransactions() {
            Ee.transactions = [], Ee.transactionsByYear = {}, Ee.lastNetworkInView = void 0, Ee.loading = !1, Ee.empty = !1, Ee.next = void 0
        }
    },
    ti = bt(dh, "API_ERROR"),
    Ie = Ae({
...
const hh = {
        ...
        async connectWalletConnect() {
            if (X.isTelegram() || X.isSafari() && X.isIos()) {
                ...
                if (!X.isPairingExpired(Ie ? .wcPairingExpiry)) {
                    const t = Ie.wcUri;
                    Ie.wcUri = t;
                    return
                }
                Ss = Y._getClient() ? .connectWalletConnect ? .().catch(() => {}), Y.state.status = "connecting", await Ss, Ss = void 0, Ie.wcPairingExpiry = void 0, Y.state.status = "connected"
            } else await Y._getClient() ? .connectWalletConnect ? .()
        },
        async connectExternal(t, e, s = !0) {
            await Y._getClient() ? .connectExternal ? .(t), s && p.setActiveNamespace(e)
        },
        ...
        async setPreferredAccountType(t, e) {
            Fe.setLoading(!0, p.state.activeChain);
            const s = j.getAuthConnector();
            s && (W.setPreferredAccountType(t, e), await s.provider.setPreferredAccount(t), F.setPreferredAccountTypes(W.state.preferredAccountTypes ? ? {
                [e]: t
            }), await Y.reconnectExternal(s), Fe.setLoading(!1, p.state.activeChain), Se.sendEvent({
                type: "track",
        ...
        resetWcConnection() {
            Ie.wcUri = void 0, Ie.wcPairingExpiry = void 0, Ie.wcLinking = void 0, Ie.recentWallet = void 0, Ie.status = "disconnected", ti.resetTransactions(), F.deleteWalletConnectDeepLink()
        },
        resetUri() {
            Ie.wcUri = void 0, Ie.wcPairingExpiry = void 0, Ss = void 0
        },
        finalizeWcConnection() {
            ...
            t && F.setWalletConnectDeepLink(t), e && F.setAppKitRecent(e), Se.sendEvent({
                type: "track",
                event: "CONNECT_SUCCESS",
                properties: {
                    method: t ? "mobile" : "qrcode",
                    name: re.state.data ? .wallet ? .name || "Unknown"
                }
            })
        },
        setWcBasic(t) {
        ...
        async disconnect(t) {
            try {
                ...
                throw new Ar("Failed to disconnect", "INTERNAL_SDK_ERROR", e)
            }
        },
        setConnections(t, e) {
            Ie.connections.set(e, t)
        },
        switchAccount({
            connection: t,
            address: e,
            ...
            if (j.state.activeConnectorIds[s] === t.connectorId) {
                ...
                const n = j.getConnector(t.connectorId);
    ...
    Ea = {
        ...
        async getEIP155Balances(t, e) {
            try {
                const s = Tn.getChainIdHexFromCAIP2ChainId(e.caipNetworkId);
                if (!(await Y.getCapabilities(t)) ? .[s] ? .assetDiscovery ? .supported) return null;
                const i = await Y.walletGetAssets({
                    account: t,
                    chainFilter: [s]
                });
                return Tn.isWalletGetAssetsResponse(i) ? (i[s] || []).map(o => Tn.createBalance(o, e.caipNetworkId)) : null
            } catch {
                return null
            }
        },
        ...
        mapBalancesToSwapTokens(t) {
            return t ? .map(e => ({ ...e,
                address: e ? .address ? e.address : p.getActiveNetworkTokenAddress(),
    ...
    ph = {
        ...
        async sendToken() {
            try {
                switch (de.setLoading(!0), p.state.activeCaipNetwork ? .chainNamespace) {
                    case "eip155":
        ...
        async sendEvmToken() {
            ...
            if (!de.state.sendTokenAmount || !de.state.receiverAddress) throw new Error("An amount and receiver address are required");
            if (!de.state.token) throw new Error("A token is required");
            de.state.token ? .address ? (Se.sendEvent({
                type: "track",
                event: "SEND_INITIATED",
                properties: {
                    isSmartAccount: e === ni.ACCOUNT_TYPES.SMART_ACCOUNT,
        ...
        async fetchTokenBalance(t) {
            fe.loading = !0;
            const e = p.state.activeCaipNetwork ? .caipNetworkId,
                s = p.state.activeCaipNetwork ? .chainNamespace,
                r = p.state.activeCaipAddress,
                i = r ? X.getPlainAddress(r) : void 0;
            if (fe.lastRetry && !X.isAllowedRetry(fe.lastRetry, 30 * be.ONE_SEC_MS)) return fe.loading = !1, [];
            try {
                if (i && e && s) {
                    const n = await Ea.getMyTokensWithBalance();
                    return fe.tokenBalances = n, fe.lastRetry = void 0, n
                }
            } catch (n) {
                fe.lastRetry = Date.now(), t ? .(n), Rt.showError("Token Balance Unavailable")
            } finally {
                fe.loading = !1
            }
            return []
        ...
        fetchNetworkBalance() {
            if (fe.tokenBalances.length === 0) return;
            const t = Ea.mapBalancesToSwapTokens(fe.tokenBalances);
            if (!t) return;
            const e = t.find(s => s.address === p.getActiveNetworkTokenAddress());
            e && (fe.networkBalanceInUSD = e ? Rd.multiply(e.quantity.numeric, e.price).toString() : "0")
        },
        async sendNativeToken(t) {
            ...
            await Y.sendTransaction({
                ...
                event: "SEND_SUCCESS",
                properties: {
                    isSmartAccount: W.state.preferredAccountTypes ? .eip155 === ni.ACCOUNT_TYPES.SMART_ACCOUNT,
                    token: de.state.token ? .symbol || "",
                    amount: t.sendTokenAmount,
                    network: p.state.activeCaipNetwork ? .caipNetworkId || ""
                }
            }), Y._getClient() ? .updateBalance("eip155"), de.resetSend()
        },
        ...
        async sendSolanaToken() {
            ...
            }), Y._getClient() ? .updateBalance("solana"), de.resetSend()
        },
        resetSend() {
    ...
    fh = {
        ...
        initialize(t, e, s) {
            const {
                chainId: r,
                namespace: i
            } = F.getActiveNetworkProps(), n = e ? .find(u => u.id.toString() === r ? .toString()), a = t.find(u => u ? .namespace === i) || t ? .[0], c = t.map(u => u.namespace).filter(u => u !== void 0), l = S.state.enableEmbedded ? new Set([...c]) : new Set([...e ? .map(u => u.chainNamespace) ? ? []]);
            (t ? .length === 0 || !a) && (M.noAdapters = !0), M.noAdapters || (M.activeChain = a ? .namespace, M.activeCaipNetwork = n, p.setChainNetworkData(a ? .namespace, {
                caipNetwork: n
            }), M.activeChain && bs.set({
                activeChain: a ? .namespace
            })), l.forEach(u => {
                const d = e ? .filter(h => h.chainNamespace === u);
        ...
        addAdapter(t, {
            ...
            M.chains.set(t.namespace, {
                ...
                connectionControllerClient: s,
                networkControllerClient: e
            }), p.setRequestedCaipNetworks(r ? .filter(i => i.chainNamespace === t.namespace) ? ? [], t.namespace)
        },
        addNetwork(t) {
            const e = M.chains.get(t.chainNamespace);
            if (e) {
                const s = [...e.caipNetworks || []];
                e.caipNetworks ? .find(r => r.id === t.id) || s.push(t), M.chains.set(t.chainNamespace, { ...e,
                    caipNetworks: s
                }), p.setRequestedCaipNetworks(s, t.chainNamespace), j.filterByNamespace(t.chainNamespace, !0)
            }
        },
        removeNetwork(t, e) {
            ...
            if (s) {
                ...
                r && s ? .caipNetworks ? .[0] && p.setActiveCaipNetwork(s.caipNetworks[0]), M.chains.set(t, { ...s,
                    caipNetworks: i
                }), p.setRequestedCaipNetworks(i || [], t), i.length === 0 && j.filterByNamespace(t, !1)
            }
        },
        setAdapterNetworkState(t, e) {
            const s = M.chains.get(t);
            s && (s.networkState = { ...s.networkState || Mi,
                ...e
            }, M.chains.set(t, s))
        },
        setChainAccountData(t, e, s = !0) {
            ...
            if (r) {
                const i = { ...r.accountState || On,
                    ...e
                };
                M.chains.set(t, { ...r,
                    accountState: i
                }), (M.chains.size === 1 || M.activeChain === t) && (e.caipAddress && (M.activeCaipAddress = e.caipAddress), W.replaceState(i))
            }
        },
        ...
        setAccountProp(t, e, s, r = !0) {
            p.setChainAccountData(s, {
                [t]: e
            }, r), t === "status" && e === "disconnected" && s && j.removeConnectorId(s)
        },
        setActiveNamespace(t) {
            M.activeChain = t;
            const e = t ? M.chains.get(t) : void 0,
                s = e ? .networkState ? .caipNetwork;
            s ? .id && t && (M.activeCaipAddress = e ? .accountState ? .caipAddress, M.activeCaipNetwork = s, p.setChainNetworkData(t, {
                caipNetwork: s
            }), F.setActiveCaipNetworkId(s ? .caipNetworkId), bs.set({
                activeChain: t,
        ...
        setActiveCaipNetwork(t) {
            ...
            const e = M.chains.get(t.chainNamespace);
            M.activeChain = t.chainNamespace, M.activeCaipNetwork = t, p.setChainNetworkData(t.chainNamespace, {
                caipNetwork: t
            }), e ? .accountState ? .address ? M.activeCaipAddress = `${t.chainNamespace}:${t.id}:${e?.accountState?.address}` : M.activeCaipAddress = void 0, p.setAccountProp("caipAddress", M.activeCaipAddress, t.chainNamespace), e && W.replaceState(e.accountState), de.resetSend(), bs.set({
                activeChain: M.activeChain,
                selectedNetworkId: M.activeCaipNetwork ? .caipNetworkId
            }), F.setActiveCaipNetworkId(t.caipNetworkId), !p.checkIfSupportedNetwork(t.chainNamespace) && S.state.enableNetworkSwitch && !S.state.allowUnsupportedChain && !Y.state.wcBasic && p.showUnsupportedChainUI()
        },
        addCaipNetwork(t) {
            if (!t) return;
            const e = M.chains.get(t.chainNamespace);
        ...
        async switchActiveNamespace(t) {
            if (!t) return;
            const e = t !== p.state.activeChain,
                s = p.getNetworkData(t) ? .caipNetwork,
                r = p.getCaipNetworkByNamespace(t, s ? .id);
            e && r && await p.switchActiveNetwork(r)
        },
        async switchActiveNetwork(t) {
            const s = !p.state.chains.get(p.state.activeChain) ? .caipNetworks ? .some(i => i.id === M.activeCaipNetwork ? .id),
                r = p.getNetworkControllerClient(t.chainNamespace);
            if (r) {
                try {
                    await r.switchCaipNetwork(t), s && Fe.close()
                } catch {
                    re.goBack()
                }
                Se.sendEvent({
        ...
        checkIfSupportedChainId(t) {
            return M.activeChain ? p.getRequestedCaipNetworks(M.activeChain) ? .some(s => s.id === t) : !0
        },
        ...
        checkIfSmartAccountEnabled() {
            const t = $l.caipNetworkIdToNumber(M.activeCaipNetwork ? .caipNetworkId),
                e = M.activeChain;
        ...
        checkIfNamesSupported() {
            ...
            return !!(t ? .chainNamespace && be.NAMES_SUPPORTED_CHAIN_NAMESPACES.includes(t.chainNamespace))
        },
        resetNetwork(t) {
            p.setAdapterNetworkState(t, {
        ...
        resetAccount(t) {
            ...
            M.activeCaipAddress = void 0, p.setChainAccountData(e, {
                smartAccountDeployed: !1,
                currentTab: 0,
                caipAddress: void 0,
                address: void 0,
        ...
        getFirstCaipNetworkSupportsAuthConnector() {
            ...
            if (M.chains.forEach(s => {
                ...
                const s = t[0];
                return e = s ? M.chains.get(s) ? .caipNetworks ? .[0] : void 0, e
            }
        },
        getAccountData(t) {
            return t ? p.state.chains.get(t) ? .accountState : W.state
        },
        getNetworkData(t) {
            const e = t || M.activeChain;
    ...
    J = {
        ...
        async get(t) {
            const {
                st: e,
                sv: s
            } = J.getSdkProperties(), r = S.state.projectId, i = { ...t.params || {},
                st: e,
                sv: s,
                projectId: r
            };
        ...
        async isNetworkSupported(t) {
            if (!t) return !1;
            try {
                rt.supportedChains.http.length || await J.getSupportedNetworks()
            } catch {
                return !1
            }
            return rt.supportedChains.http.includes(t)
        },
        ...
        async fetchIdentity({
            ...
            if (!await J.isNetworkSupported(e)) return {
                avatar: "",
                name: ""
            };
        ...
        async fetchTransactions({
            ...
            return await J.isNetworkSupported(p.state.activeCaipNetwork ? .caipNetworkId) ? J.get({
        ...
        async fetchTokenPrice({
            ...
            return await J.isNetworkSupported(p.state.activeCaipNetwork ? .caipNetworkId) ? rt.api.post({
        ...
        async fetchGasPrice({
            ...
            if (!await J.isNetworkSupported(p.state.activeCaipNetwork ? .caipNetworkId)) throw new Error("Network not supported for Gas Price");
            return J.get({
        ...
        async generateSwapCalldata({
            ...
            if (!await J.isNetworkSupported(p.state.activeCaipNetwork ? .caipNetworkId)) throw new Error("Network not supported for Swaps");
            return rt.api.post({
        ...
        async getBalance(t, e, s) {
            ...
            if (!await J.isNetworkSupported(p.state.activeCaipNetwork ? .caipNetworkId)) return Rt.showError("Token Balance Unavailable"), {
                balances: []
            };
            const o = `${e}:${t}`,
        ...
        async generateOnRampURL({
            ...
            return await J.isNetworkSupported(p.state.activeCaipNetwork ? .caipNetworkId) ? (await rt.api.post({
        ...
        async getOnrampOptions() {
            if (!await J.isNetworkSupported(p.state.activeCaipNetwork ? .caipNetworkId)) return {
                paymentCurrencies: [],
                purchaseCurrencies: []
            };
            try {
    ...
    mh = {
        ...
        setPreferredAccountType(t, e) {
            p.setAccountProp("preferredAccountTypes", { ...vt.preferredAccountTypes,
                [e]: t
            }, e)
        },
        setPreferredAccountTypes(t) {
            vt.preferredAccountTypes = t
        },
        setSocialProvider(t, e) {
            t && p.setAccountProp("socialProvider", t, e)
        },
        setSocialWindow(t, e) {
            p.setAccountProp("socialWindow", t ? qs(t) : void 0, e)
        },
        setFarcasterUrl(t, e) {
        ...
        async fetchTokenBalance(t) {
            ...
            const e = p.state.activeCaipNetwork ? .caipNetworkId,
                ...
                r = p.state.activeCaipAddress,
                i = r ? X.getPlainAddress(r) : void 0;
            if (vt.lastRetry && !X.isAllowedRetry(vt.lastRetry, 30 * be.ONE_SEC_MS)) return vt.balanceLoading = !1, [];
            try {
                if (i && e && s) {
                    const o = (await J.getBalance(i, e)).balances.filter(a => a.quantity.decimals !== "0");
                    return W.setTokenBalance(o, s), vt.lastRetry = void 0, vt.balanceLoading = !1, o
                }
            } catch (n) {
                vt.lastRetry = Date.now(), t ? .(n), Rt.showError("Token Balance Unavailable")
            } finally {
                vt.balanceLoading = !1
            }
            return []
    ...
    wh = {
        onSwitchNetwork({
            ...
            const n = W.getCaipAddress(p.state.activeChain),
                ...
                l = j.getConnectorId(p.state.activeChain) === z.CONNECTOR_ID.AUTH,
                u = z.AUTH_CONNECTOR_SUPPORTED_CHAINS.find(d => d === t.chainNamespace);
            e || l && u ? re.push("SwitchNetwork", { ...r,
                network: t
            }) : n && o && !a ? re.push("SwitchActiveChain", {
                switchToChain: t.chainNamespace,
                navigateTo: "Connect",
                navigateWithReplace: !0,
                network: t
            }) : re.push("SwitchNetwork", { ...r,
                network: t
            })
        }
    },
    ...
    yh = {
        ...
        async open(t) {
            const e = W.state.status === "connected",
                ...
                i = s && s !== r,
                n = p.getAccountData(t ? .namespace) ? .caipAddress;
            if (Y.state.wcBasic ? V.prefetch({
                ...
                }), j.setFilterByNamespace(t ? .namespace), Fe.setLoading(!0, s), s && i) {
                const o = p.getNetworkData(s) ? .caipNetwork || p.getRequestedCaipNetworks(s)[0];
                o && wh.onSwitchNetwork({
                    network: o,
                    ignoreSwitchConfirmation: !0
                })
            } else {
                const o = p.state.noAdapters;
                S.state.manualWCControl || o && !n ? X.isMobile() ? re.reset("AllWallets") : re.reset("ConnectingWalletConnectBasic") : t ? .view ? re.reset(t.view, t.data) : n ? re.reset("Account") : re.reset("Connect")
            }
            it.open = !0, bs.set({
                open: !0
            }), Se.sendEvent({
        ...
        close() {
            ...
            it.open && Se.sendEvent({
                type: "track",
                event: "MODAL_CLOSE",
                properties: {
                    connected: e
                }
            }), it.open = !1, re.reset("Connect"), Fe.clearLoading(), t ? e ? re.replace("Account") : re.push("Connect") : bs.set({
                open: !1
            }), Y.resetUri()
        },
        setLoading(t, e) {
            e && it.loadingNamespaceMap.set(e, t), it.loading = t, bs.set({
                loading: t
            })
        },
        clearLoading() {
            it.loadingNamespaceMap.clear(), it.loading = !1
        },
        shake() {
            it.shake || (it.shake = !0, setTimeout(() => {
                it.shake = !1
            }, 500))
        }
    },
    ...
    vh = {
        ...
        setSelectedProvider(t) {
            if (t && t.name === "meld") {
                const e = p.state.activeChain === z.CHAIN.SOLANA ? "SOL" : "USDC",
                    s = W.state.address ? ? "",
                    r = new URL(t.url);
                r.searchParams.append("publicKey", Hd), r.searchParams.append("destinationCurrencyCode", e), r.searchParams.append("walletAddress", s), r.searchParams.append("externalCustomerId", S.state.projectId), oe.selectedProvider = { ...t,
                    url: r.toString()
                }
            } else oe.selectedProvider = t
        },
        setOnrampProviders(t) {
            if (Array.isArray(t) && t.every(e => typeof e == "string")) {
                const e = t,
                    s = xl.filter(r => e.includes(r.name));
                oe.providers = s
            } else oe.providers = []
        },
        ...
        setPurchaseAmount(t) {
            uo.state.purchaseAmount = t
        },
        setPaymentAmount(t) {
            uo.state.paymentAmount = t
        },
        async getAvailableCurrencies() {
            const t = await J.getOnrampOptions();
            oe.purchaseCurrencies = t.purchaseCurrencies, oe.paymentCurrencies = t.paymentCurrencies, oe.paymentCurrency = t.paymentCurrencies[0] || lo, oe.purchaseCurrency = t.purchaseCurrencies[0] || oi, await V.fetchCurrencyImages(t.paymentCurrencies.map(e => e.id)), await V.fetchTokenImages(t.purchaseCurrencies.map(e => e.symbol))
        },
        async getQuote() {
            oe.quotesLoading = !0;
            try {
                const t = await J.getOnrampQuote({
                    ...
                    amount: oe.paymentAmount ? .toString() || "0",
                    network: oe.purchaseCurrency ? .symbol
                });
                return oe.quotesLoading = !1, oe.purchaseAmount = Number(t ? .purchaseAmount.amount), t
            } catch (t) {
                return oe.error = t.message, oe.quotesLoading = !1, null
            } finally {
                oe.quotesLoading = !1
            }
        },
        resetState() {
            oe.selectedProvider = null, oe.error = null, oe.purchaseCurrency = oi, oe.paymentCurrency = lo, oe.purchaseCurrencies = [oi], oe.paymentCurrencies = [], oe.paymentAmount = void 0, oe.purchaseAmount = void 0, oe.quotesLoading = !1
        }
    },
    uo = bt(vh),
    Ca = 2147483648,
    Eh = {
        convertEVMChainIdToCoinType(t) {
            if (t >= Ca) throw new Error("Invalid chainId");
            return (Ca | t) >>> 0
        }
    },
    Et = Ae({
    ...
    Ch = {
        ...
        async getSuggestions(t) {
            try {
                Et.loading = !0, Et.suggestions = [];
                const e = await J.getEnsNameSuggestions(t);
                return Et.suggestions = e.suggestions.map(s => ({ ...s,
                    name: s.name
                })) || [], Et.suggestions
            } catch (e) {
                const s = ai.parseEnsApiError(e, "Error fetching name suggestions");
                throw new Error(s)
            } finally {
                Et.loading = !1
            }
        ...
        async getNamesForAddress(t) {
            try {
                ...
                const s = ai.parseEnsApiError(e, "Error fetching names for address");
                throw new Error(s)
            }
        },
        async registerName(t) {
            ...
            try {
                ...
                const a = Eh.convertEVMChainIdToCoinType(Number(o));
                ...
                const n = ai.parseEnsApiError(i, `Error registering name ${t}`);
...
var Ih = Object.defineProperty,
    Nh = (t, e, s) => e in t ? Ih(t, e, {
        enumerable: !0,
        configurable: !0,
        writable: !0,
        value: s
    }) : t[e] = s,
    Ia = (t, e, s) => Nh(t, typeof e != "symbol" ? e + "" : e, s);
let Ah = class extends Ur {
    constructor(e) {
        super(), this.opts = e, Ia(this, "protocol", "wc"), Ia(this, "version", 2)
    }
};
var _h = Object.defineProperty,
    Sh = (t, e, s) => e in t ? _h(t, e, {
        enumerable: !0,
        configurable: !0,
        writable: !0,
        value: s
    ...
    Ph = (t, e, s) => Sh(t, e + "", s);
let kh = class extends Ur {
        constructor(e, s) {
            super(), this.core = e, this.logger = s, Ph(this, "records", new Map)
        }
    },
    Th = class {
        constructor(e, s) {
...
var Bh = Object.defineProperty,
    jh = (t, e, s) => e in t ? Bh(t, e, {
        enumerable: !0,
        configurable: !0,
        writable: !0,
        value: s
    }) : t[e] = s,
    Na = (t, e, s) => jh(t, typeof e != "symbol" ? e + "" : e, s);
let qh = class {
        constructor(e) {
...
let $n = {
    getDocsUrl: ({
        ...
        docsPath: e = "",
        docsSlug: s
    }) => e ? `${t??"https://viem.sh"}${e}${s?`#${s}`:""}` : void 0,
    version: `viem@${Ll}`
};
class Fs extends Error {
    constructor(e, s = {}) {
        const r = s.cause instanceof Fs ? s.cause.details : s.cause ? .message ? s.cause.message : s.details,
            i = s.cause instanceof Fs && s.cause.docsPath || s.docsPath,
            n = $n.getDocsUrl ? .({ ...s,
                docsPath: i
            }),
            o = [e || "An error occurred.", "", ...s.metaMessages ? [...s.metaMessages, ""] : [], ...n ? [`Docs: ${n}`] : [], ...r ? [`Details: ${r}`] : [], ...$n.version ? [`Version: ${$n.version}`] : []].join(`
`);
        super(o, s.cause ? {
            cause: s.cause
            ...
            writable: !0,
            value: "BaseError"
        }), this.details = r, this.docsPath = i, this.metaMessages = s.metaMessages, this.name = s.name ? ? this.name, this.shortMessage = e, this.version = Ll
    }
    walk(e) {
        return Ml(this, e)
    }
...
function Ml(t, e) {
    return e ? .(t) ? t : t && typeof t == "object" && "cause" in t && t.cause !== void 0 ? Ml(t.cause, e) : e ? null : t
}
class Bl extends Fs {
    constructor({
        size: e,
...
function ho(t, e = {}) {
    ...
    const i = (t.length - 2) / 2,
        n = (1 n << BigInt(i) * 8 n - 1 n) - 1 n;
    return r <= n ? r : r - BigInt(`0x${"f".padStart(i*2,"f")}`) - 1 n
}

function Kh(t, e = {}) {
    return Number(ho(t, e))
}
const Gh = Array.from({
    length: 256
...
function po(t, e = {}) {
    return typeof t == "number" || typeof t == "bigint" ? ql(t, e) : typeof t == "string" ? Xh(t, e) : typeof t == "boolean" ? Jh(t, e) : jl(t, e)
}

function Jh(t, e = {}) {
    const s = `0x${Number(t)}`;
    return typeof e.size == "number" ? (Mr(s, {
        size: e.size
    }), Lr(s, {
        size: e.size
    })) : s
...
function jl(t, e = {}) {
    let s = "";
    for (let i = 0; i < t.length; i++) s += Gh[t[i]];
    const r = `0x${s}`;
    return typeof e.size == "number" ? (Mr(r, {
        size: e.size
    }), Lr(r, {
        dir: "right",
        size: e.size
...
function ql(t, e = {}) {
    ...
    let n;
    r ? s ? n = (1 n << BigInt(r) * 8 n - 1 n) - 1 n : n = 2 n ** (BigInt(r) * 8 n) - 1 n : typeof t == "number" && (n = BigInt(Number.MAX_SAFE_INTEGER));
    const o = typeof n == "bigint" && s ? -n - 1 n : 0;
    if (n && i > n || i < o) {
...
const Yh = new TextEncoder;

function Xh(t, e = {}) {
    const s = Yh.encode(t);
    return jl(s, e)
}
const Zh = new TextEncoder;

function Qh(t, e = {}) {
    return typeof t == "number" || typeof t == "bigint" ? tp(t, e) : typeof t == "boolean" ? ep(t, e) : mi(t) ? Fl(t, e) : Wl(t, e)
}

function ep(t, e = {}) {
    const s = new Uint8Array(1);
    return s[0] = Number(t), typeof e.size == "number" ? (Mr(s, {
        size: e.size
    }), Lr(s, {
        size: e.size
    })) : s
...
function _a(t) {
    if (t >= Xt.zero && t <= Xt.nine) return t - Xt.zero;
...
function Fl(t, e = {}) {
    ...
    for (let o = 0, a = 0; o < i; o++) {
        const c = _a(r.charCodeAt(a++)),
            l = _a(r.charCodeAt(a++));
        if (c === void 0 || l === void 0) throw new Fs(`Invalid byte sequence ("${r[a-2]}${r[a-1]}" in "${r}").`);
        n[o] = c * 16 + l
    }
    return n
}
...
function mn(t, ...e) {
    if (!sp(t)) throw new Error("Uint8Array expected");
...
const op = (t, e, s) => t << s | e >>> 32 - s,
    ap = (t, e, s) => e << s | t >>> 32 - s,
    cp = (t, e, s) => e << s - 32 | t >>> 64 - s,
    lp = (t, e, s) => t << s - 32 | e >>> 64 - s,
    Zs = typeof globalThis == "object" && "crypto" in globalThis ? globalThis.crypto : void 0;
...
function Ta(t) {
    for (let e = 0; e < t.length; e++) t[e] = dp(t[e])
}
...
function zl(t) {
    return typeof t == "string" && (t = hp(t)), mn(t), t
}
...
function fp(t) {
    const e = r => t().update(zl(r)).digest(),
        s = t();
...
const Hl = [],
    ...
    yp = BigInt(256),
    bp = BigInt(113);
for (let t = 0, e = Hr, s = 1, r = 0; t < 24; t++) {
    [s, r] = [r, (2 * s + 3 * r) % 5], Hl.push(2 * (5 * r + s)), Vl.push((t + 1) * (t + 2) / 2 % 64);
    let i = gp;
    for (let n = 0; n < 7; n++) e = (e << Hr ^ (e >> wp) * bp) % yp, e & mp && (i ^= Hr << (Hr << BigInt(n)) - Hr);
    Kl.push(i)
}
const [vp, Ep] = np(Kl, !0), Oa = (t, e, s) => s > 32 ? cp(t, e, s) : op(t, e, s), $a = (t, e, s) => s > 32 ? lp(t, e, s) : ap(t, e, s);
    ...
    for (let r = 24 - e; r < 24; r++) {
        ...
        for (let o = 0; o < 10; o += 2) {
            const a = (o + 8) % 10,
                ...
                d = Oa(l, u, 1) ^ s[a],
                h = $a(l, u, 1) ^ s[a + 1];
            for (let f = 0; f < 50; f += 10) t[o + f] ^= d, t[o + f + 1] ^= h
        }
        let i = t[2],
            n = t[3];
        for (let o = 0; o < 24; o++) {
...
class Ko extends pp {
    constructor(e, s, r, i = !1, n = 24) {
        if (super(), this.blockLen = e, this.suffix = s, this.outputLen = r, this.enableXOF = i, this.rounds = n, this.pos = 0, this.posOut = 0, this.finished = !1, this.destroyed = !1, an(r), 0 >= this.blockLen || this.blockLen >= 200) throw new Error("Sha3 supports only keccak-f1600 function");
        this.state = new Uint8Array(200), this.state32 = up(this.state)
    }
    keccak() {
        ka || Ta(this.state32), Cp(this.state32, this.rounds), ka || Ta(this.state32), this.posOut = 0, this.pos = 0
    }
    update(e) {
        Sa(this);
        const {
    ...
    digestInto(e) {
        if (rp(e, this), this.finished) throw new Error("digest() was already called");
    ...
    _cloneInto(e) {
        ...
        return e || (e = new Ko(s, r, i, o, n)), e.state32.set(this.state32), e.pos = this.pos, e.posOut = this.posOut, e.finished = this.finished, e.rounds = n, e.suffix = r, e.outputLen = i, e.enableXOF = o, e.destroyed = this.destroyed, e
    }
}
const Ip = (t, e, s) => fp(() => new Ko(e, t, s)),
    Np = Ip(1, 136, 256 / 8);
...
function Gl(t, e) {
    ...
    return s === "bytes" ? r : po(r)
}
class Ap extends Map {
    constructor(e) {
...
const xn = new Ap(8192);

function _p(t, e) {
    if (xn.has(`${t}.${e}`)) return xn.get(`${t}.${e}`);
    const s = t.substring(2).toLowerCase(),
        r = Gl(Wl(s), "bytes"),
        i = s.split("");
    for (let o = 0; o < 40; o += 2) r[o >> 1] >> 4 >= 8 && i[o] && (i[o] = i[o].toUpperCase()), (r[o >> 1] & 15) >= 8 && i[o + 1] && (i[o + 1] = i[o + 1].toUpperCase());
    const n = `0x${i.join("")}`;
    return xn.set(`${t}.${e}`, n), n
}

function Sp(t) {
    const e = Gl(`0x${t.substring(4)}`).substring(26);
    return _p(`0x${e}`)
}
async function Pp({
    hash: t,
    ...
    const s = mi(t) ? t : po(t),
        {
            ...
            import ("./secp256k1-C0Lsfddy.js");
            return {
                secp256k1: o
            }
        }, __vite__mapDeps([0, 1, 2]));
    return `0x${(()=>{if(typeof e=="object"&&"r"in e&&"s"in e){const{r:l,s:u,v:d,yParity:h}=e,f=Number(h??d),m=xa(f);return new r.Signature(ho(l),ho(u)).addRecoveryBit(m)}const o=mi(e)?e:po(e),a=Kh(`
    0x $ {
        o.slice(130)
    }
    `),c=xa(a);return r.Signature.fromCompact(o.substring(2,130)).addRecoveryBit(c)})().recoverPublicKey(s.substring(2)).toHex(!1)}`
}
...
function ci(t, e) {
    ...
    const s = Jl(e);
    let r = 0;
    for (const i of t) s.set(i, r), r += i.length;
    return s
}
...
const Ra = Yl("utf8", "u", t => "u" + new TextDecoder("utf8").decode(t), t => new TextEncoder().encode(t.substring(1))),
    Rn = Yl("ascii", "a", t => {
        let e = "a";
...
var $p = Object.defineProperty,
    ...
    La = (t, e) => {
        for (var s in e || (e = {})) Up.call(e, s) && Da(t, s, e[s]);
        if (Ua)
            for (var s of Ua(e)) Dp.call(e, s) && Da(t, s, e[s]);
        return t
    },
    Lp = (t, e) => xp(t, Rp(e));
const Mp = "ReactNative",
    mt = {
...
function As() {
    return !ns.getDocument() && !!ns.getNavigator() && navigator.product === Mp
}

function jp() {
    return As() && typeof global < "u" && typeof(global == null ? void 0 : global.Platform) < "u" && (global == null ? void 0 : global.Platform.OS) === "android"
}

function qp() {
    return As() && typeof global < "u" && typeof(global == null ? void 0 : global.Platform) < "u" && (global == null ? void 0 : global.Platform.OS) === "ios"
}

function Br() {
    return !cn() && !!ns.getNavigator() && !!ns.getDocument()
}

function Si() {
    return As() ? mt.reactNative : cn() ? mt.node : Br() ? mt.browser : mt.unknown
}
...
function zp() {
    if (Si() === mt.reactNative && typeof global < "u" && typeof(global == null ? void 0 : global.Platform) < "u") {
        const {
            OS: s,
            Version: r
        } = global.Platform;
...
function Hp() {
    var t;
    const e = Si();
    return e === mt.browser ? [e, ((t = ns.getLocation()) == null ? void 0 : t.host) || "unknown"].join(":") : e
}
...
async function Jp({
    ...
    try {
        ...
        const o = Yp(n, t, e),
            a = Si();
        if (a === mt.browser) {
            if (!((r = ns.getDocument()) != null && r.hasFocus())) {
                console.warn("Document does not have focus, skipping deeplink.");
                return
            }
            Xp(o)
        } else a === mt.reactNative && typeof(global == null ? void 0 : global.Linking) < "u" && await global.Linking.openURL(o)
    } catch (i) {
        console.error(i)
    }
}
...
function Xp(t) {
    let e = "_self";
    ef() ? e = "_top" : (Qp() || t.startsWith("https://") || t.startsWith("http://")) && (e = "_blank"), window.open(t, e, "noreferrer noopener")
}
async function Zp(t, e) {
    let s = "";
    try {
        if (Br() && (s = localStorage.getItem(e), s)) return s;
        s = await t.getItem(e)
    } catch (r) {
        console.error(r)
    }
...
function Go() {
    return typeof process < "u" && Tp.IS_VITEST === "true"
}
...
function Pi(t, ...e) {
    if (!rf(t)) throw new Error("Uint8Array expected");
    if (e.length > 0 && !e.includes(t.length)) throw new Error("Uint8Array expected of length " + e + ", got length=" + t.length)
}
...
const af = (t, e, s) => t << s | e >>> 32 - s,
    cf = (t, e, s) => e << s | t >>> 32 - s,
    lf = (t, e, s) => e << s - 32 | t >>> 64 - s,
    uf = (t, e, s) => t << s - 32 | e >>> 64 - s,
    Qs = typeof globalThis == "object" && "crypto" in globalThis ? globalThis.crypto : void 0;
...
const Fa = new Uint8Array(new Uint32Array([287454020]).buffer)[0] === 68;
...
function Wa(t) {
    for (let e = 0; e < t.length; e++) t[e] = hf(t[e])
}
...
function Sr(t) {
    return typeof t == "string" && (t = pf(t)), Pi(t), t
}
...
function nu(t) {
    const e = r => t().update(Sr(r)).digest(),
        s = t();
    return e.outputLen = s.outputLen, e.blockLen = s.blockLen, e.create = () => t(), e
}

function jr(t = 32) {
    if (Qs && typeof Qs.getRandomValues == "function") return Qs.getRandomValues(new Uint8Array(t));
    if (Qs && typeof Qs.randomBytes == "function") return Qs.randomBytes(t);
    throw new Error("crypto.getRandomValues must be defined")
}
const ou = [],
    au = [],
    ...
    yf = BigInt(256),
    bf = BigInt(113);
for (let t = 0, e = Vr, s = 1, r = 0; t < 24; t++) {
    [s, r] = [r, (2 * s + 3 * r) % 5], ou.push(2 * (5 * r + s)), au.push((t + 1) * (t + 2) / 2 % 64);
    let i = gf;
    for (let n = 0; n < 7; n++) e = (e << Vr ^ (e >> wf) * bf) % yf, e & mf && (i ^= Vr << (Vr << BigInt(n)) - Vr);
    cu.push(i)
}
const [vf, Ef] = of (cu, !0), za = (t, e, s) => s > 32 ? lf(t, e, s) : af(t, e, s), Ha = (t, e, s) => s > 32 ? uf(t, e, s) : cf(t, e, s);
...
let If = class lu extends Yo {
    constructor(e, s, r, i = !1, n = 24) {
        if (super(), this.blockLen = e, this.suffix = s, this.outputLen = r, this.enableXOF = i, this.rounds = n, this.pos = 0, this.posOut = 0, this.finished = !1, this.destroyed = !1, wi(r), 0 >= this.blockLen || this.blockLen >= 200) throw new Error("Sha3 supports only keccak-f1600 function");
        this.state = new Uint8Array(200), this.state32 = df(this.state)
    }
    keccak() {
        Fa || Wa(this.state32), Cf(this.state32, this.rounds), Fa || Wa(this.state32), this.posOut = 0, this.pos = 0
    }
    update(e) {
        _r(this);
        const {
    ...
    xof(e) {
        return wi(e), this.xofInto(new Uint8Array(e))
    }
    digestInto(e) {
        if (iu(e, this), this.finished) throw new Error("digest() was already called");
        return this.writeInto(e), this.destroy(), e
    }
    digest() {
        return this.digestInto(new Uint8Array(this.outputLen))
    ...
    _cloneInto(e) {
        ...
        return e || (e = new lu(s, r, i, o, n)), e.state32.set(this.state32), e.pos = this.pos, e.posOut = this.posOut, e.finished = this.finished, e.rounds = n, e.suffix = r, e.outputLen = i, e.enableXOF = o, e.destroyed = this.destroyed, e
    }
};
const Nf = (t, e, s) => nu(() => new If(e, t, s)),
    Af = Nf(1, 136, 256 / 8),
    _f = "https://rpc.walletconnect.org/v1";

function uu(t) {
    const e = `Ethereum Signed Message:
${t.length}`,
        s = new TextEncoder().encode(e + t);
    return "0x" + Buffer.from(Af(s)).toString("hex")
}
async function Sf(t, e, s, r, i, n) {
    switch (s.t) {
        case "eip191":
            return await Pf(t, e, s.s);
        case "eip1271":
            return await kf(t, e, s.s, r, i, n);
        default:
            throw new Error(`verifySignature failed: Attempted to verify CacaoSignature with unknown type: ${s.t}`)
    }
}
async function Pf(t, e, s) {
    return (await kp({
        hash: uu(e),
        signature: s
    })).toLowerCase() === t.toLowerCase()
}
async function kf(t, e, s, r, i, n) {
    const o = Cr(r);
    ...
    try {
        const a = "0x1626ba7e",
            ...
            d = uu(e).substring(2),
            h = a + d + c + l + u,
            f = await fetch(`${n||_f}/?chainId=${r}&projectId=${i}`, {
                method: "POST",
                body: JSON.stringify({
                    id: Tf(),
                    jsonrpc: "2.0",
...
var $f = Object.defineProperty,
    ...
    Lf = (t, e) => {
        for (var s in e || (e = {})) Uf.call(e, s) && Ka(t, s, e[s]);
        if (Va)
            for (var s of Va(e)) Df.call(e, s) && Ka(t, s, e[s]);
        return t
    },
    Mf = (t, e) => xf(t, Rf(e));
const Bf = "did:pkh:",
...
async function Ga(t) {
    const {
        ...
        s: r,
        p: i
    } = e, n = du(i, i.iss), o = ln(i.iss);
    return await Sf(o, n, r, mo(i.iss), s)
}
const du = (t, e) => {
...
- ${w}`).join("")}` : void 0,
    ...
    return [s, r, "", i, "", n, o, a, c, l, u, d, h, f].filter(w => w != null).join(`
`)
};
...
function hu(t) {
    return Ws(t), `urn:recap:${qf(t).replace(/=/g,"")}`
}

function yi(t) {
    const e = Ff(t.replace("urn:recap:", ""));
    return Ws(e), e
}
...
function gt(t, ...e) {
    if (!pu(t)) throw new Error("Uint8Array expected");
    if (e.length > 0 && !e.includes(t.length)) throw new Error("Uint8Array expected of length " + e + ", got length=" + t.length)
}
...
const vs = t => new Uint32Array(t.buffer, t.byteOffset, Math.floor(t.byteLength / 4)),
    Xf = t => new DataView(t.buffer, t.byteOffset, t.byteLength),
...
function Qa(t, e, s = !0) {
    ...
    if (s && !rg(e)) throw new Error("invalid output, must be aligned");
    return e
}
...
const fu = t => Uint8Array.from(t.split("").map(e => e.charCodeAt(0))),
    ig = fu("expand 16-byte k"),
    ng = fu("expand 32-byte k"),
    og = vs(ig),
    ag = vs(ng);
...
function lg(t, e, s, r, i, n, o, a) {
    const c = i.length,
        ...
        f = d ? vs(n) : tc;
    for (let m = 0; m < c; o++) {
        if (t(e, s, r, u, o, a), o >= gu) throw new Error("arx: counter overflow");
        const w = Math.min(qi, c - m);
        if (d && w === qi) {
            const g = m / 4;
            if (m % 4 !== 0) throw new Error("arx: invalid block position");
            for (let y = 0, b; y < cg; y++) b = g + y, f[b] = h[b] ^ u[y];
            m += qi;
            continue
        }
        for (let g = 0, y; g < w; g++) y = m + g, n[y] = i[y] ^ l[g];
        m += w
    }
}
...
function ug(t, e) {
    ...
    return Dn(i), Dn(o), Za(n), Za(s), (a, c, l, u, d = 0) => {
        gt(a), gt(c), gt(l);
        const h = l.length;
        if (u === void 0 && (u = new Uint8Array(h)), gt(u), Dn(d), d < 0 || d >= gu) throw new Error("arx: counter overflow");
        if (u.length < h) throw new Error(`arx: output (${u.length}) is shorter than data (${h})`);
        const f = [];
        let m = a.length,
            w, g;
        if (m === 32) f.push(w = yo(a)), g = ag;
        else if (m === 16 && s) w = new Uint8Array(32), w.set(a), w.set(a, 16), g = og, f.push(w);
        ...
        if (r) {
            ...
            r(g, y, vs(c.subarray(0, 16)), y), c = c.subarray(16)
        }
        const b = 16 - i;
        if (b !== c.length) throw new Error(`arx: nonce must be ${b} or 16 bytes`);
        if (b !== 12) {
            const O = new Uint8Array(12);
            O.set(c, n ? 0 : 12 - c.length), c = O, f.push(c)
        }
        const I = vs(c);
        return lg(t, g, y, I, l, u, d, o), Pr(...f), u
    }
}
const ze = (t, e) => t[e++] & 255 | (t[e++] & 255) << 8;
class dg {
    constructor(e) {
        this.blockLen = 16, this.outputLen = 16, this.buffer = new Uint8Array(16), this.r = new Uint16Array(10), this.h = new Uint16Array(10), this.pad = new Uint16Array(8), this.pos = 0, this.finished = !1, e = wo(e), gt(e, 32);
        const s = ze(e, 0),
            r = ze(e, 2),
            i = ze(e, 4),
            n = ze(e, 6),
        ...
        for (let u = 0; u < 8; u++) this.pad[u] = ze(e, 16 + 2 * u)
    }
    process(e, s, r = !1) {
        const i = r ? 0 : 2048,
            {
        ...
        let v = n[0] + (y & 8191),
            ...
            q = n[9] + (D >>> 5 | i),
            T = 0,
            G = T + v * a + $ * (5 * g) + E * (5 * w) + L * (5 * m) + H * (5 * f);
        T = G >>> 13, G &= 8191, G += C * (5 * h) + k * (5 * d) + A * (5 * u) + B * (5 * l) + q * (5 * c), T += G >>> 13, G &= 8191;
        let Q = T + v * c + $ * a + E * (5 * g) + L * (5 * w) + H * (5 * m);
        T = Q >>> 13, Q &= 8191, Q += C * (5 * f) + k * (5 * h) + A * (5 * d) + B * (5 * u) + q * (5 * l), T += Q >>> 13, Q &= 8191;
        let se = T + v * l + $ * c + E * a + L * (5 * g) + H * (5 * w);
        T = se >>> 13, se &= 8191, se += C * (5 * m) + k * (5 * f) + A * (5 * h) + B * (5 * d) + q * (5 * u), T += se >>> 13, se &= 8191;
        let ve = T + v * u + $ * l + E * c + L * a + H * (5 * g);
        T = ve >>> 13, ve &= 8191, ve += C * (5 * w) + k * (5 * m) + A * (5 * f) + B * (5 * h) + q * (5 * d), T += ve >>> 13, ve &= 8191;
        let he = T + v * d + $ * u + E * l + L * c + H * a;
        T = he >>> 13, he &= 8191, he += C * (5 * g) + k * (5 * w) + A * (5 * m) + B * (5 * f) + q * (5 * h), T += he >>> 13, he &= 8191;
        let ke = T + v * h + $ * d + E * u + L * l + H * c;
        T = ke >>> 13, ke &= 8191, ke += C * a + k * (5 * g) + A * (5 * w) + B * (5 * m) + q * (5 * f), T += ke >>> 13, ke &= 8191;
        let De = T + v * f + $ * h + E * d + L * u + H * l;
        T = De >>> 13, De &= 8191, De += C * c + k * a + A * (5 * g) + B * (5 * w) + q * (5 * m), T += De >>> 13, De &= 8191;
        let Je = T + v * m + $ * f + E * h + L * d + H * u;
        T = Je >>> 13, Je &= 8191, Je += C * l + k * c + A * a + B * (5 * g) + q * (5 * w), T += Je >>> 13, Je &= 8191;
        let $e = T + v * w + $ * m + E * f + L * h + H * d;
        T = $e >>> 13, $e &= 8191, $e += C * u + k * l + A * c + B * a + q * (5 * g), T += $e >>> 13, $e &= 8191;
        let xe = T + v * g + $ * w + E * m + L * f + H * h;
        T = xe >>> 13, xe &= 8191, xe += C * d + k * u + A * l + B * c + q * a, T += xe >>> 13, xe &= 8191, T = (T << 2) + T | 0, T = T + G | 0, G = T & 8191, T = T >>> 13, Q += T, n[0] = G, n[1] = Q, n[2] = se, n[3] = ve, n[4] = he, n[5] = ke, n[6] = De, n[7] = Je, n[8] = $e, n[9] = xe
    }
    finalize() {
        const {
            h: e,
    ...
    destroy() {
        Pr(this.h, this.r, this.buffer, this.pad)
    }
    digestInto(e) {
        Xa(this), Yf(e, this), this.finished = !0;
        const {
            buffer: s,
            h: r
        } = this;
...
const pg = hg(t => new dg(t));

function fg(t, e, s, r, i, n = 20) {
    let o = t[0],
        a = t[1],
        c = t[2],
        l = t[3],
        ...
        G = O,
        Q = x;
    for (let ve = 0; ve < n; ve += 2) P = P + $ | 0, q = ce(q ^ P, 16), C = C + q | 0, $ = ce($ ^ C, 12), P = P + $ | 0, q = ce(q ^ P, 8), C = C + q | 0, $ = ce($ ^ C, 7), _ = _ + E | 0, T = ce(T ^ _, 16), k = k + T | 0, E = ce(E ^ k, 12), _ = _ + E | 0, T = ce(T ^ _, 8), k = k + T | 0, E = ce(E ^ k, 7), D = D + L | 0, G = ce(G ^ D, 16), A = A + G | 0, L = ce(L ^ A, 12), D = D + L | 0, G = ce(G ^ D, 8), A = A + G | 0, L = ce(L ^ A, 7), v = v + H | 0, Q = ce(Q ^ v, 16), B = B + Q | 0, H = ce(H ^ B, 12), v = v + H | 0, Q = ce(Q ^ v, 8), B = B + Q | 0, H = ce(H ^ B, 7), P = P + E | 0, Q = ce(Q ^ P, 16), A = A + Q | 0, E = ce(E ^ A, 12), P = P + E | 0, Q = ce(Q ^ P, 8), A = A + Q | 0, E = ce(E ^ A, 7), _ = _ + L | 0, q = ce(q ^ _, 16), B = B + q | 0, L = ce(L ^ B, 12), _ = _ + L | 0, q = ce(q ^ _, 8), B = B + q | 0, L = ce(L ^ B, 7), D = D + H | 0, T = ce(T ^ D, 16), C = C + T | 0, H = ce(H ^ C, 12), D = D + H | 0, T = ce(T ^ D, 8), C = C + T | 0, H = ce(H ^ C, 7), v = v + $ | 0, G = ce(G ^ v, 16), k = k + G | 0, $ = ce($ ^ k, 12), v = v + $ | 0, G = ce(G ^ v, 8), k = k + G | 0, $ = ce($ ^ k, 7);
    let se = 0;
    r[se++] = o + P | 0, r[se++] = a + _ | 0, r[se++] = c + D | 0, r[se++] = l + v | 0, r[se++] = u + $ | 0, r[se++] = d + E | 0, r[se++] = h + L | 0, r[se++] = f + H | 0, r[se++] = m + C | 0, r[se++] = w + k | 0, r[se++] = g + A | 0, r[se++] = y + B | 0, r[se++] = b + q | 0, r[se++] = I + T | 0, r[se++] = O + G | 0, r[se++] = x + Q | 0
}
const gg = ug(fg, {
        counterRight: !1,
        counterLength: 4,
    ...
    mg = new Uint8Array(16),
    sc = (t, e) => {
        t.update(e);
        const s = e.length % 16;
        s && t.update(mg.subarray(s))
    },
    wg = new Uint8Array(32);

function rc(t, e, s, r, i) {
    const n = t(e, s, wg),
        o = pg.create(n);
    i && sc(o, i), sc(o, r);
    const a = new Uint8Array(16),
        c = Xf(a);
    ec(c, 0, BigInt(i ? i.length : 0), !0), ec(c, 8, BigInt(r.length), !0), o.update(a);
    const l = o.digest();
    return Pr(n, a), l
}
const yg = t => (e, s, r) => ({
        encrypt(i, n) {
            const o = i.length;
            n = Qa(o + 16, n, !1), n.set(i);
            const a = n.subarray(0, -16);
            t(e, s, a, a, 1);
            const c = rc(t, e, s, a, r);
            return n.set(c, o), Pr(c), n
        },
        decrypt(i, n) {
            n = Qa(i.length - 16, n, !1);
            const o = i.subarray(0, -16),
                a = i.subarray(-16),
                c = rc(t, e, s, o, r);
            if (!tg(a, c)) throw new Error("invalid tag");
            return n.set(i.subarray(0, -16)), t(e, s, n, n, 1), Pr(c), n
        }
    }),
    mu = sg({
        blockSize: 64,
...
let wu = class extends Yo {
    ...
    digestInto(e) {
        _r(this), Pi(e, this.outputLen), this.finished = !0, this.iHash.digestInto(e), this.oHash.update(e), this.oHash.digestInto(e), this.destroy()
    }
    digest() {
...
const wn = (t, e, s) => new wu(t, e).update(s).digest();
wn.create = (t, e) => new wu(t, e);

function bg(t, e, s) {
    return Jo(t), s === void 0 && (s = new Uint8Array(t.outputLen)), wn(t, Sr(s), Sr(e))
}
const Ln = new Uint8Array([0]),
    ic = new Uint8Array;

function vg(t, e, s, r = 32) {
    if (Jo(t), wi(r), r > 255 * t.outputLen) throw new Error("Length should be <= 255*HashLen");
    ...
    for (let l = 0; l < i; l++) Ln[0] = l + 1, a.update(l === 0 ? ic : c).update(s).update(Ln).digestInto(c), n.set(c, t.outputLen * l), o._cloneInto(a);
    return o.destroy(), a.destroy(), c.fill(0), Ln.fill(0), n.slice(0, r)
}
const Eg = (t, e, s, r, i) => vg(t, bg(t, e, s), r, i);
...
let Ag = class extends Yo {
    constructor(e, s, r, i) {
        super(), this.blockLen = e, this.outputLen = s, this.padOffset = r, this.isLE = i, this.finished = !1, this.length = 0, this.pos = 0, this.destroyed = !1, this.buffer = new Uint8Array(e), this.view = Un(this.buffer)
    }
    update(e) {
        _r(this);
        const {
    ...
    digestInto(e) {
        _r(this), iu(e, this), this.finished = !0;
        const {
            buffer: s,
            view: r,
            blockLen: i,
        ...
        Cg(r, i - 8, BigInt(this.length * 8), n), this.process(r, 0);
        const a = Un(e),
            c = this.outputLen;
...
const _g = new Uint32Array([1116352408, 1899447441, 3049323471, 3921009573, 961987163, 1508970993, 2453635748, 2870763221, 3624381080, 310598401, 607225278, 1426881987, 1925078388, 2162078206, 2614888103, 3248222580, 3835390401, 4022224774, 264347078, 604807628, 770255983, 1249150122, 1555081692, 1996064986, 2554220882, 2821834349, 2952996808, 3210313671, 3336571891, 3584528711, 113926993, 338241895, 666307205, 773529912, 1294757372, 1396182291, 1695183700, 1986661051, 2177026350, 2456956037, 2730485921, 2820302411, 3259730800, 3345764771, 3516065817, 3600352804, 4094571909, 275423344, 430227734, 506948616, 659060556, 883997877, 958139571, 1322822218, 1537002063, 1747873779, 1955562222, 2024104815, 2227730452, 2361852424, 2428436474, 2756734187, 3204031479, 3329325298]),
...
class Sg extends Ag {
    ...
    process(e, s) {
        for (let d = 0; d < 16; d++, s += 4) ds[d] = e.getUint32(s, !1);
        for (let d = 16; d < 64; d++) {
            const h = ds[d - 15],
                f = ds[d - 2],
                m = Mt(h, 7) ^ Mt(h, 18) ^ h >>> 3,
                w = Mt(f, 17) ^ Mt(f, 19) ^ f >>> 10;
            ds[d] = w + ds[d - 7] + m + ds[d - 16] | 0
        }
        let {
            A: r,
            B: i,
        ...
        for (let d = 0; d < 64; d++) {
            const h = Mt(a, 6) ^ Mt(a, 11) ^ Mt(a, 25),
                f = u + h + Ig(a, c, l) + _g[d] + ds[d] | 0,
                m = (Mt(r, 2) ^ Mt(r, 13) ^ Mt(r, 22)) + Ng(r, i, n) | 0;
            u = l, l = c, c = a, a = o + f | 0, o = n, n = i, i = r, r = f + m | 0
        }
...
function Ti(t) {
    if (!zs(t)) throw new Error("Uint8Array expected")
}
...
function Or(t) {
    ...
    for (let i = 0, n = 0; i < s; i++, n += 2) {
        const o = nc(t.charCodeAt(n)),
            a = nc(t.charCodeAt(n + 1));
...
function bi(t) {
    return Ti(t), Zo(Tr(Uint8Array.from(t).reverse()))
}

function $r(t, e) {
    return Or(t.toString(16).padStart(e * 2, "0"))
}

function vn(t, e) {
    return $r(t, e).reverse()
}
...
function ft(t, e, s) {
    ...
    if (typeof e == "string") try {
        ...
        } else if (zs(e)) r = Uint8Array.from(e);
...
const Mn = t => typeof t == "bigint" && yn <= t;
...
function rs(t, e, s, r) {
    if (!En(e, s, r)) throw new Error("expected valid " + t + ": " + s + " <= n < " + r + ", got " + e)
}

function yu(t) {
    let e;
    for (e = 0; t > yn; t >>= bn, e += 1);
    return e
}

function xg(t, e) {
    return t >> BigInt(e) & bn
}

function Rg(t, e, s) {
    return t | (s ? bn : yn) << BigInt(e)
}
const Qo = t => (Pg << BigInt(t - 1)) - bn,
    Bn = t => new Uint8Array(t),
    oc = t => Uint8Array.from(t);
...
function bu(t, e, s) {
    ...
    const o = () => {
        ...
        a = (...u) => s(i, r, ...u),
        c = (u = Bn()) => {
            i = a(oc([0]), u), r = a(), u.length !== 0 && (i = a(oc([1]), u), r = a())
        },
        l = () => {
...
const Ug = {
    ...
    stringOrUint8Array: t => typeof t == "string" || zs(t),
...
function vu(t, e, s) {
    ...
    if (s <= We) throw new Error("invalid modulus");
    if (s === Pe) return We;
    let r = Pe;
    for (; e > We;) e & Pe && (r = r * t % s), t = t * t % s, e >>= Pe;
    return r
}
...
function Bg(t) {
    const e = (t - Pe) / Rs;
    let s, r, i;
    for (s = t - Pe, r = 0; s % Rs === We; s /= Rs, r++);
    for (i = Rs; i < t && vu(i, e, t) !== t - Pe; i++)
    ...
    return function(o, a) {
        ...
        for (; !o.eql(d, o.ONE);) {
            ...
            let h = 1;
            for (let m = o.sqr(d); h < c && !o.eql(m, o.ONE); h++) m = o.sqr(m);
            const f = o.pow(l, Pe << BigInt(c - h - 1));
            l = o.sqr(f), u = o.mul(u, f), d = o.mul(d, l), c = h
        }
        return u
    }
}
...
const qg = ["create", "isValid", "is0", "neg", "inv", "sqrt", "sqr", "eql", "add", "sub", "mul", "pow", "div", "addN", "subN", "mulN", "sqrN"];
...
function Fg(t) {
    const e = {
        ...
        s = qg.reduce((r, i) => (r[i] = "function", r), e);
    return qr(t, s)
}

function Wg(t, e, s) {
    if (s < We) throw new Error("invalid exponent, negatives unsupported");
    if (s === We) return t.ONE;
    if (s === Pe) return e;
    let r = t.ONE,
        i = e;
    for (; s > We;) s & Pe && (r = t.mul(r, i)), i = t.sqr(i), s >>= Pe;
    return r
}
...
function Cu(t, e, s = !1, r = {}) {
    ...
    const a = Object.freeze({
        ...
        mul: (c, l) => ct(c * l, t),
        pow: (c, l) => Wg(a, c, l),
        div: (c, l) => ct(c * Co(l, t), t),
        sqrN: c => c * c,
        addN: (c, l) => c + l,
        subN: (c, l) => c - l,
        mulN: (c, l) => c * l,
        inv: c => Co(c, t),
        sqrt: r.sqrt || (c => (o || (o = jg(t)), o(a, c))),
        invertBatch: c => zg(a, c),
        cmov: (c, l, u) => u ? l : c,
        toBytes: c => s ? vn(c, n) : $r(c, n),
        fromBytes: c => {
...
function Gg(t, e) {
    return {
        ...
        unsafeLadder(s, r, i = t.ZERO) {
            let n = s;
            for (; r > lc;) r & Fi && (i = i.add(n)), n = n.double(), r >>= Fi;
            return i
        },
        ...
        wNAF(s, r, i) {
            ...
            for (let h = 0; h < n; h++) {
                ...
                const w = f,
                    ...
                    y = h % 2 !== 0,
                    b = m < 0;
                m === 0 ? c = c.add(jn(y, r[w])) : a = a.add(jn(b, r[g]))
            }
            return {
                p: a,
                f: c
        ...
        wNAFUnsafe(s, r, i, n = t.ZERO) {
            const {
                windows: o,
                windowSize: a
            } = qn(s, e), c = BigInt(2 ** s - 1), l = 2 ** s, u = BigInt(s);
            for (let d = 0; d < o; d++) {
                const h = d * a;
                if (i === lc) break;
                let f = Number(i & c);
                if (i >>= u, f > a && (f -= l, i += Fi), f === 0) continue;
                let m = r[h + Math.abs(f) - 1];
                f < 0 && (m = m.negate()), n = n.add(m)
            }
            return n
        },
        ...
        setWindowSize(s, r) {
            Au(r, e), _u.set(s, r), Fn.delete(s)
        }
    }
}

function Jg(t, e, s, r) {
    if (Vg(s, t), Kg(r, e), s.length !== r.length) throw new Error("arrays of points and scalars must have equal length");
    const i = t.ZERO,
        n = yu(BigInt(s.length)),
    ...
    for (let d = l; d >= 0; d -= o) {
        ...
        for (let f = 0; f < r.length; f++) {
            const m = r[f],
                w = Number(m >> BigInt(d) & BigInt(a));
            c[w] = c[w].add(s[f])
        }
        let h = i;
        for (let f = c.length - 1, m = i; f > 0; f--) m = m.add(c[f]), h = h.add(m);
        if (u = u.add(h), d !== 0)
            for (let f = 0; f < o; f++) u = u.double()
    }
    return u
}
...
function Su(t) {
    ...
    }), Object.freeze({ ...Eu(t.n, t.nBitLength),
        ...t,
        p: t.Fp.ORDER
    })
}
...
function Xg(t) {
    const e = Yg(t),
        ...
        c = e.powPminus2 || (b => vu(b, s - BigInt(2), s));

    function l(b, I, O) {
        const x = r(b * (I - O));
        return I = r(I - x), O = r(O + x), [I, O]
    }
    const u = (e.a - BigInt(2)) / BigInt(4);

    function d(b, I) {
        rs("u", b, er, s), rs("scalar", I, er, s);
        const O = I,
            x = b;
        let P = zn,
            _ = er,
            ...
            $ = er,
            E;
        for (let H = BigInt(i - 1); H >= er; H--) {
            const C = O >> H & zn;
            $ ^= C, E = l($, P, D), P = E[0], D = E[1], E = l($, _, v), _ = E[0], v = E[1], $ = C;
            const k = P + _,
                A = r(k * k),
                B = P - _,
                q = r(B * B),
                ...
                he = se + ve,
                ke = se - ve;
            D = r(he * he), v = r(x * r(ke * ke)), P = r(A * q), _ = r(T * (A + r(u * T)))
        }
        E = l($, P, D), P = E[0], D = E[1], E = l($, _, v), _ = E[0], v = E[1];
        const L = c(_);
        return r(P * L)
    }
    ...
    function m(b) {
        ...
        if (O !== n && O !== o) {
            let x = "" + n + " or " + o;
            throw new Error("invalid scalar, expected " + x + " bytes, got " + O)
        }
        return bi(a(I))
    }
    ...
    function w(b, I) {
        const O = f(I),
            x = m(b),
            P = d(O, x);
        if (P === er) throw new Error("invalid private or public key received");
        return h(P)
    }
    const g = h(e.Gu);
...
const No = Xg({
    ...
    powPminus2: t => {
        ...
        return ct($t(s, Qg, e) * r, e)
    },
    adjustScalarBytes: sm,
    randomBytes: jr
});
...
const ts = {
        ...
        _tlv: {
            encode: (t, e) => {
                ...
                const n = r > 127 ? br(i.length / 2 | 128) : "";
                return br(t) + n + i + e
            },
            decode(t, e) {
                const {
        ...
        hexFromSig(t) {
            const {
                _tlv: e,
                _int: s
            } = ts, r = e.encode(2, s.encode(t.r)), i = e.encode(2, s.encode(t.s)), n = r + i;
...
function am(t) {
    const e = rm(t),
        ...
        r = Cu(e.n, e.nBitLength),
        i = e.toBytes || ((w, g, y) => {
            const b = g.toAffine();
            return vi(Uint8Array.from([4]), s.toBytes(b.x), s.toBytes(b.y))
        }),
        n = e.fromBytes || (w => {
    ...
    function c(w) {
        ...
        if (g && typeof w != "bigint") {
            if (zs(w) && (w = Tr(w)), typeof w != "string" || !g.includes(w.length)) throw new Error("invalid private key");
            w = w.padStart(y * 2, "0")
        }
        let O;
        try {
            O = typeof w == "bigint" ? w : js(ft("private key", w, y))
        } catch {
            throw new Error("invalid private key, expected hex or " + y + " bytes, got " + typeof w)
        }
        return b && (O = ct(O, I)), rs("private key", O, Be, I), O
    }

    function l(w) {
        if (!(w instanceof h)) throw new Error("ProjectivePoint expected")
    }
    const u = vo((w, g) => {
            const {
                px: y,
        ...
        d = vo(w => {
            if (w.is0()) {
                if (e.allowInfinityPoint && !s.is0(w.py)) return;
            ...
            if (!s.isValid(g) || !s.isValid(y)) throw new Error("bad point: x or y not FE");
            const b = s.sqr(y),
                I = o(g);
            if (!s.eql(b, I)) throw new Error("bad point: equation left != right");
            if (!w.isTorsionFree()) throw new Error("bad point: not in prime-order subgroup");
            return !0
        });
    class h {
        constructor(g, y, b) {
            if (this.px = g, this.py = y, this.pz = b, g == null || !s.isValid(g)) throw new Error("x required");
        ...
        static fromAffine(g) {
            ...
            if (!g || !s.isValid(y) || !s.isValid(b)) throw new Error("invalid affine point");
            if (g instanceof h) throw new Error("projective point not allowed");
            const I = O => s.eql(O, s.ZERO);
            return I(y) && I(b) ? h.ZERO : new h(y, b, s.ONE)
        }
        get x() {
        ...
        static normalizeZ(g) {
            ...
            return g.map((b, I) => b.toAffine(y[I])).map(h.fromAffine)
        }
        static fromHex(g) {
            const y = h.fromAffine(n(ft("pointHex", g)));
        ...
        equals(g) {
            ...
            const {
                ...
                py: x,
                pz: P
            } = g, _ = s.eql(s.mul(y, P), s.mul(O, I)), D = s.eql(s.mul(b, P), s.mul(x, I));
            return _ && D
        }
        negate() {
        ...
        double() {
            ...
            let P = s.ZERO,
                ...
                E = s.mul(x, x),
                L = s.mul(I, O);
            return L = s.add(L, L), D = s.mul(I, x), D = s.add(D, D), P = s.mul(g, D), _ = s.mul(b, E), _ = s.add(P, _), P = s.sub($, _), _ = s.add($, _), _ = s.mul(P, _), P = s.mul(L, P), D = s.mul(b, D), E = s.mul(g, E), L = s.sub(v, E), L = s.mul(g, L), L = s.add(L, D), D = s.add(v, v), v = s.add(D, v), v = s.add(v, E), v = s.mul(v, L), _ = s.add(_, v), E = s.mul(O, x), E = s.add(E, E), v = s.mul(E, L), P = s.sub(P, v), D = s.mul(E, $), D = s.add(D, D), D = s.add(D, D), new h(P, _, D)
        }
        add(g) {
            l(g);
            const {
            ...
            let L = s.mul(y, O),
                ...
                k = s.add(y, b),
                A = s.add(O, x);
            k = s.mul(k, A), A = s.add(L, H), k = s.sub(k, A), A = s.add(y, I);
            let B = s.add(O, P);
            return A = s.mul(A, B), B = s.add(L, C), A = s.sub(A, B), B = s.add(b, I), _ = s.add(x, P), B = s.mul(B, _), _ = s.add(H, C), B = s.sub(B, _), v = s.mul($, A), _ = s.mul(E, C), v = s.add(_, v), _ = s.sub(H, v), v = s.add(H, v), D = s.mul(_, v), H = s.add(L, L), H = s.add(H, L), C = s.mul($, C), A = s.mul(E, A), H = s.add(H, C), C = s.sub(L, C), C = s.mul($, C), A = s.add(A, C), L = s.mul(H, A), D = s.add(D, L), L = s.mul(B, A), _ = s.mul(k, _), _ = s.sub(_, L), L = s.mul(k, H), v = s.mul(B, v), v = s.add(v, L), new h(_, D, v)
        }
        subtract(g) {
        ...
        wNAF(g) {
            return m.wNAFCached(this, g, h.normalizeZ)
        }
        multiplyUnsafe(g) {
            const {
                endo: y,
            ...
            const I = h.ZERO;
            if (g === ss) return I;
            if (this.is0() || g === Be) return this;
            if (!y || m.hasPrecomputes(this)) return m.wNAFCachedUnsafe(this, g, h.normalizeZ);
            let {
                k1neg: O,
                k1: x,
                k2neg: P,
                k2: _
            } = y.splitScalar(g), D = I, v = I, $ = this;
            for (; x > ss || _ > ss;) x & Be && (D = D.add($)), _ & Be && (v = v.add($)), $ = $.double(), x >>= Be, _ >>= Be;
            return O && (D = D.negate()), P && (v = v.negate()), v = new h(s.mul(v.px, y.beta), v.py, v.pz), D.add(v)
        }
        multiply(g) {
            const {
                endo: y,
            ...
            if (y) {
                ...
                v = m.constTimeNegate(x, v), E = m.constTimeNegate(_, E), E = new h(s.mul(E.px, y.beta), E.py, E.pz), I = v.add(E), O = $.add(L)
            } else {
                const {
                    p: x,
                    f: P
        ...
        multiplyAndAddUnsafe(g, y, b) {
            const I = h.BASE,
                O = (P, _) => _ === ss || _ === Be || !P.equals(I) ? P.multiplyUnsafe(_) : P.multiply(_),
                x = O(this, y).add(O(g, b));
        ...
        clearCofactor() {
            ...
            return g === Be ? this : y ? y(h, this) : this.multiplyUnsafe(e.h)
        }
        toRawBytes(g = !0) {
            return kr("isCompressed", g), this.assertValidity(), i(h, this, g)
        }
        toHex(g = !0) {
            return kr("isCompressed", g), Tr(this.toRawBytes(g))
        }
    }
    h.BASE = new h(e.Gx, e.Gy, s.ONE), h.ZERO = new h(s.ZERO, s.ONE, s.ZERO);
    const f = e.nBitLength,
        m = Gg(h, e.endo ? Math.ceil(f / 2) : f);
    return {
        CURVE: e,
        ProjectivePoint: h,
...
function lm(t) {
    ...
    const {
        ...
        toBytes(C, k, A) {
            const B = k.toAffine(),
                q = s.toBytes(B.x),
                T = vi;
            return kr("isCompressed", A), A ? T(Uint8Array.from([k.hasEvenY() ? 2 : 3]), q) : T(Uint8Array.from([4]), q, s.toBytes(B.y))
        },
        fromBytes(C) {
            const k = C.length,
                A = C[0],
            ...
            if (k === i && (A === 2 || A === 3)) {
                const q = js(B);
                if (!En(q, Be, s.ORDER)) throw new Error("Point is not on curve");
                const T = u(q);
                let G;
                try {
                    G = s.sqrt(T)
                } catch (se) {
                    const ve = se instanceof Error ? ": " + se.message : "";
                ...
                const q = s.fromBytes(B.subarray(0, s.BYTES)),
                ...
                const q = i,
                    T = n;
                throw new Error("invalid Point, expected length of " + q + ", or uncompressed " + T + ", got " + k)
            }
        }
    }), h = C => Tr($r(C, e.nByteLength));
    ...
    const w = (C, k, A) => js(C.slice(k, A));
    class g {
        constructor(k, A, B) {
            this.r = k, this.s = A, this.recovery = B, this.assertValidity()
        }
        static fromCompact(k) {
            const A = e.nByteLength;
            return k = ft("compactSignature", k, A * 2), new g(w(k, 0, A), w(k, A, 2 * A))
        }
        static fromDER(k) {
            const {
                r: A,
        ...
        assertValidity() {
            rs("r", this.r, Be, r), rs("s", this.s, Be, r)
        }
        addRecoveryBit(k) {
        ...
        recoverPublicKey(k) {
            ...
            const Q = (q & 1) === 0 ? "02" : "03",
                ...
                he = o(-T * ve),
                ke = o(B * ve),
                De = c.BASE.multiplyAndAddUnsafe(se, he, ke);
    ...
    const y = {
        ...
        randomPrivateKey: () => {
            const C = Nu(e.n);
            return Hg(e.randomBytes(C), e.n)
        },
        precompute(C = 8, k = c.BASE) {
            return k._setWindowSize(C), k.multiply(BigInt(3)), k
        }
    };

    function b(C, k = !0) {
        return c.fromPrivateKey(C).toRawBytes(k)
    }
    ...
    function I(C) {
        const k = zs(C),
            A = typeof C == "string",
            B = (k || A) && C.length;
        return k ? B === i || B === n : A ? B === 2 * i || B === 2 * n : C instanceof c
    }

    function O(C, k, A = !0) {
        if (I(C)) throw new Error("first arg must be private key");
        if (!I(k)) throw new Error("second arg must be public key");
        return c.fromHex(k).multiply(l(C)).toRawBytes(A)
    }
    const x = e.bits2int || function(C) {
            if (C.length > 8192) throw new Error("input is too large");
            const k = js(C),
                A = C.length * 8 - e.nBitLength;
            return A > 0 ? k >> BigInt(A) : k
        },
        P = e.bits2int_modN || function(C) {
            return o(x(C))
        },
        _ = Qo(e.nBitLength);

    function D(C) {
        return rs("num < 2^" + e.nBitLength, C, ss, _), $r(C, e.nByteLength)
    }
    ...
    function v(C, k, A = $) {
        ...
        T == null && (T = !0), C = ft("msgHash", C), dc(A), G && (C = ft("prehashed msgHash", B(C)));
        const se = P(C),
            ve = l(k),
            he = [D(ve), D(se)];
        if (Q != null && Q !== !1) {
            const $e = Q === !0 ? q(s.BYTES) : Q;
            he.push(ft("extraEntropy", $e))
        }
        const ke = vi(...he),
            De = se;
        ...
        function Je($e) {
            ...
            if (!d(xe)) return;
            const _s = a(xe),
                Kt = c.BASE.multiply(xe).toAffine(),
                Lt = o(Kt.x);
            if (Lt === ss) return;
            const Gt = o(_s * o(De + Lt * ve));
            if (Gt === ss) return;
            let Ys = (Kt.x === Lt ? 0 : 2) | Number(Kt.y & Be),
                Di = Gt;
            return T && f(Gt) && (Di = m(Gt), Ys ^= 1), new g(Lt, Di, Ys)
        }
        return {
            seed: ke,
            k2sig: Je
    ...
    function L(C, k, A = $) {
        ...
        return bu(T.hash.outputLen, T.nByteLength, T.hmac)(B, q)
    }
    c.BASE._setWindowSize(8);

    function H(C, k, A, B = E) {
        const q = C;
        k = ft("msgHash", k), A = ft("publicKey", A);
        const {
            lowS: T,
            prehash: G,
            format: Q
        } = B;
        if (dc(B), "strict" in B) throw new Error("options.strict was renamed to lowS");
        if (Q !== void 0 && Q !== "compact" && Q !== "der") throw new Error("format must be compact or der");
        const se = typeof q == "string" || zs(q),
            ve = !se && !Q && typeof q == "object" && q !== null && typeof q.r == "bigint" && typeof q.s == "bigint";
        if (!se && !ve) throw new Error("invalid signature, expected Uint8Array, hex string or Signature instance");
        let he, ke;
        try {
            if (ve && (he = new g(q.r, q.s)), se) {
                try {
                    Q !== "compact" && (he = g.fromDER(q))
                } catch (Gt) {
                    if (!(Gt instanceof ts.Err)) throw Gt
                }!he && Q !== "der" && (he = g.fromCompact(q))
            }
            ke = c.fromHex(A)
        } catch {
            return !1
        }
        if (!he || T && he.hasHighS()) return !1;
        G && (k = e.hash(k));
        const {
            r: De,
            s: Je
        } = he, $e = P(k), xe = a(Je), _s = o($e * xe), Kt = o(De * xe), Lt = c.BASE.multiplyAndAddUnsafe(ke, _s, Kt) ? .toAffine();
        return Lt ? o(Lt.x) === De : !1
    }
    return {
        CURVE: e,
        getPublicKey: b,
...
const Pu = Cu(BigInt("0xffffffff00000001000000000000000000000000ffffffffffffffffffffffff")),
    hm = Pu.create(BigInt("-3")),
    pm = BigInt("0x5ac635d8aa3a93e7b3ebbd55769886bc651d06b0cc53b0f63bce3c3e27d2604b"),
    fm = dm({
        a: hm,
        b: pm,
        Fp: Pu,
...
function mm() {
    const t = No.utils.randomPrivateKey(),
        e = No.getPublicKey(t);
    return {
        privateKey: lt(t, et),
        publicKey: lt(e, et)
...
function wm(t, e) {
    const s = No.getSharedSecret(_t(t, et), _t(e, et)),
        r = Eg(ki, s, void 0, void 0, ea);
    return lt(r, et)
}
...
function ym(t) {
    const e = Ou(typeof t.type < "u" ? t.type : Tu);
    if (Hs(e) === is && typeof t.senderPublicKey > "u") throw new Error("Missing sender public key for type 1 envelope");
    const s = typeof t.senderPublicKey < "u" ? _t(t.senderPublicKey, et) : void 0,
        r = typeof t.iv < "u" ? _t(t.iv, et) : jr(li),
        i = _t(t.symKey, et),
        n = mu(i, r).encrypt(_t(t.message, Oi)),
        o = Ru({
            type: e,
            sealed: n,
            iv: r,
    ...
    return t.encoding === gs ? $u(o) : o
}

function bm(t) {
    const e = _t(t.symKey, et),
        {
            sealed: s,
            iv: r
        } = Ei({
...
function Ru(t) {
    if (Hs(t.type) === $i) return lt(ci([t.type, t.sealed]), Ut);
    if (Hs(t.type) === is) {
        if (typeof t.senderPublicKey > "u") throw new Error("Missing sender public key for type 1 envelope");
        return lt(ci([t.type, t.senderPublicKey, t.iv, t.sealed]), Ut)
    }
    return lt(ci([t.type, t.iv, t.sealed]), Ut)
}

function Ei(t) {
    const e = (t.encoding || Ut) === gs ? xu(t.encoded) : t.encoded,
        s = _t(e, Ut),
        r = s.slice(gm, pc),
        i = pc;
    if (Hs(r) === is) {
...
function Cm(t, e) {
    ...
    return Uu({
        type: Hs(s.type),
        senderPublicKey: typeof s.senderPublicKey < "u" ? lt(s.senderPublicKey, et) : void 0,
...
function Nm(t, e) {
    const [s, r, i] = t.split("."), n = Buffer.from(xu(i), "base64");
    ...
    const o = n.slice(0, 32),
        ...
        l = ki(c),
        u = Im(e);
    if (!fm.verify(ci([o, a]), l, u)) throw new Error("Invalid signature");
    return oo(t).payload
}
const Am = "irn";
...
var km = Object.defineProperty,
    ...
    Rm = (t, e) => {
        for (var s in e || (e = {})) $m.call(e, s) && bc(t, s, e[s]);
        if (yc)
            for (var s of yc(e)) xm.call(e, s) && bc(t, s, e[s]);
        return t
    },
    Um = (t, e) => Tm(t, Om(e));
...
function Lm(t, e) {
    ...
    return Object.values(t).forEach(r => {
        Fr(r.accounts).includes(e) && s.push(...r.methods)
    }), s
}
...
function Mm(t, e) {
    const s = [];
    return Object.values(t).forEach(r => {
        Fr(r.accounts).includes(e) && s.push(...r.events)
    }), s
}
...
function vc(t) {
    ...
    for (const [n, o] of Object.entries(t)) {
        const a = Cn(n) ? [n] : o.chains,
            c = o.methods || [],
            l = o.events || [],
            u = vr(n);
        i[u] = Um(Rm({}, i[u]), {
            chains: Ht(a, (e = i[u]) == null ? void 0 : e.chains),
            methods: Ht(c, (s = i[u]) == null ? void 0 : s.methods),
            events: Ht(l, (r = i[u]) == null ? void 0 : r.events)
        })
    }
    return i
}
...
function Bm(t) {
    ...
    return t ? .forEach(s => {
        ...
        e[i] || (e[i] = {
            ...
            events: [],
            methods: []
        }), e[i].accounts.push(s), (r = e[i].chains) == null || r.push(`${i}:${n}`)
    }), e
}
...
function Ec(t, e) {
    ...
    const s = Bm(e);
    for (const [r, i] of Object.entries(s)) i.methods ? i.methods = Ht(i.methods, t) : i.methods = t, i.events = ["chainChanged", "accountsChanged"];
    return s
}
...
function jm(t, e) {
    ...
    for (const h of d) u[h] = {
        chains: Ht((s = c[h]) == null ? void 0 : s.chains, (r = l[h]) == null ? void 0 : r.chains),
        methods: Ht((i = c[h]) == null ? void 0 : i.methods, (n = l[h]) == null ? void 0 : n.methods),
        events: Ht((o = c[h]) == null ? void 0 : o.events, (a = l[h]) == null ? void 0 : a.events)
    };
    return u
}
const qm = {
...
function Wm(t, e) {
    ...
    } = e, r = Object.keys(t.namespaces), i = Object.keys(s);
    let n = !0;
    return Ms(i, r) ? (r.forEach(o => {
        const {
            accounts: a,
            methods: c,
            events: l
        } = t.namespaces[o], u = Fr(a), d = s[o];
        (!Ms(Zl(o, d), u) || !Ms(d.methods, c) || !Ms(d.events, l)) && (n = !1)
    }), n) : !1
}

function dn(t) {
    return Oe(t, !1) && t.includes(":") ? t.split(":").length === 2 : !1
}

function zm(t) {
    if (Oe(t, !1) && t.includes(":")) {
        const e = t.split(":");
        if (e.length === 3) {
            const s = e[0] + ":" + e[1];
            return !!e[2] && dn(s)
...
function Gm(t, e) {
    let s = null;
    return Oe(t ? .publicKey, !1) || (s = R("MISSING_OR_INVALID", `${e} controller public key should be a string`)), s
}

function Cc(t) {
    let e = !0;
    return Es(t) ? t.length && (e = t.every(s => Oe(s, !1))) : e = !1, e
}

function Jm(t, e, s) {
    let r = null;
    return Es(e) && e.length ? e.forEach(i => {
        r || dn(i) || (r = me("UNSUPPORTED_CHAINS", `${s}, chain ${i} should be a string and conform to "namespace:chainId" format`))
    }) : dn(t) || (r = me("UNSUPPORTED_CHAINS", `${s}, chains must be defined as "namespace:chainId" e.g. "eip155:1": {...} in the namespace key OR as an array of CAIP-2 chainIds e.g. eip155: { chains: ["eip155:1", "eip155:5"] }`)), r
}
...
function Xm(t, e) {
    let s = null;
    return Es(t) ? t.forEach(r => {
        s || zm(r) || (s = me("UNSUPPORTED_ACCOUNTS", `${e}, account ${r} should be a string and conform to "namespace:chainId:address" format`))
...
function Zm(t, e) {
    ...
    return Object.values(t).forEach(r => {
        if (s) return;
        const i = Xm(r ? .accounts, `${e} namespace`);
        i && (s = i)
    }), s
}
...
function Qm(t, e) {
    let s = null;
    return Cc(t ? .methods) ? Cc(t ? .events) || (s = me("UNSUPPORTED_EVENTS", `${e}, events should be an array of strings or empty array for no events`)) : s = me("UNSUPPORTED_METHODS", `${e}, methods should be an array of strings or empty array for no methods`), s
}
...
function Lu(t) {
    return Oe(t.protocol, !0)
}

function tw(t, e) {
    let s = !1;
    return t ? t && Es(t) && t.length && t.forEach(r => {
        s = Lu(r)
    }) : s = !0, s
}
...
function rw(t) {
    return !(!t || typeof t != "object" || !t.code || !ta(t.code, !1) || !t.message || !Oe(t.message, !1))
}

function iw(t) {
    return !(Ke(t) || !Oe(t.method, !1))
}

function nw(t) {
    return !(Ke(t) || Ke(t.result) && Ke(t.error) || !ta(t.id, !1) || !Oe(t.jsonrpc, !1))
}

function ow(t) {
    return !(Ke(t) || !Oe(t.name, !1))
}

function Ic(t, e) {
    return !(!dn(e) || !Dm(t).includes(e))
}

function aw(t, e, s) {
    return Oe(s, !1) ? Lm(t, e).includes(s) : !1
}

function cw(t, e, s) {
    return Oe(s, !1) ? Mm(t, e).includes(s) : !1
}
...
function Nc(t, e, s) {
    ...
    return u.length && (r = R("NON_CONFORMING_NAMESPACES", `${s} namespaces keys don't satisfy requiredNamespaces.
      Required: ${u.toString()}
      Received: ${Object.keys(e).toString()}`)), Ms(o, a) || (r = R("NON_CONFORMING_NAMESPACES", `${s} namespaces chains don't satisfy required namespaces.
      Required: ${o.toString()}
      Approved: ${a.toString()}`)), Object.keys(e).forEach(d => {
        if (!d.includes(":") || r) return;
        const h = Fr(e[d].accounts);
        h.includes(d) || (r = R("NON_CONFORMING_NAMESPACES", `${s} namespaces accounts don't satisfy namespace accounts for ${d}
        Required: ${d}
        Approved: ${h.toString()}`))
    }), o.forEach(d => {
        r || (Ms(i[d].methods, n[d].methods) ? Ms(i[d].events, n[d].events) || (r = R("NON_CONFORMING_NAMESPACES", `${s} namespaces events don't satisfy namespace events for ${d}`)) : r = R("NON_CONFORMING_NAMESPACES", `${s} namespaces methods don't satisfy namespace methods for ${d}`))
    }), r
}
...
function uw(t) {
    const e = {};
    return Object.keys(t).forEach(s => {
        s.includes(":") ? e[s] = t[s] : Fr(t[s].accounts) ? .forEach(i => {
            e[i] = {
...
function hw() {
    return Br() && navigator ? .onLine
}
async function pw() {
    return As() && typeof global < "u" && global != null && global.NetInfo ? (await (global == null ? void 0 : global.NetInfo.fetch())) ? .isConnected : !0
}
...
function mw(t) {
    !As() && Br() && (window.addEventListener("online", () => t(!0)), window.addEventListener("offline", () => t(!1)))
}

function ww(t) {
    As() && typeof global < "u" && global != null && global.NetInfo && global ? .NetInfo.addEventListener(e => t(e ? .isConnected))
}

function yw() {
    var t;
    return Br() && ns.getDocument() ? ((t = ns.getDocument()) == null ? void 0 : t.visibilityState) === "visible" : !0
}
const Vn = {};
class Kr {
    static get(e) {
...
const Mu = "wc",
    ...
    ju = "irn",
    kw = "error",
    qu = "wss://relay.walletconnect.org",
    Tw = "relayer",
    je = {
    ...
    xw = "0.3",
    Rw = "WALLETCONNECT_CLIENT_ID",
    kc = "WALLETCONNECT_LINK_MODE_APPS",
    ht = {
    ...
    Fw = "0.3",
    Ww = "verify-api",
    zw = "https://verify.walletconnect.com",
    Fu = "https://verify.walletconnect.org",
    ui = Fu,
    Hw = `${ui}/v3`,
    Vw = [zw, Fu],
    Kw = "echo",
    Gw = "https://echo.walletconnect.com",
    qt = {
    ...
    Yw = "event-client",
    Xw = 86400,
    Zw = "https://pulse.walletconnect.org/batch";
...
function Qw(t, e) {
    ...
    function d(m) {
        ...
        for (var w = 0, g = 0, y = 0, b = m.length; y !== b && m[y] === 0;) y++, w++;
        for (var I = (b - y) * u + 1 >>> 0, O = new Uint8Array(I); y !== b;) {
            for (var x = m[y], P = 0, _ = I - 1;
                (x !== 0 || P < g) && _ !== -1; _--, P++) x += 256 * O[_] >>> 0, O[_] = x % a >>> 0, x = x / a >>> 0;
            if (x !== 0) throw new Error("Non-zero carry");
            g = P, y++
        }
        for (var D = I - g; D !== I && O[D] === 0;) D++;
        for (var v = c.repeat(w); D < I; ++D) v += t.charAt(O[D]);
        return v
    }
    ...
    function h(m) {
        ...
        var w = 0;
        if (m[w] !== " ") {
            for (var g = 0, y = 0; m[w] === c;) g++, w++;
            for (var b = (m.length - w) * l + 1 >>> 0, I = new Uint8Array(b); m[w];) {
                var O = s[m.charCodeAt(w)];
                if (O === 255) return;
                for (var x = 0, P = b - 1;
                    (O !== 0 || x < y) && P !== -1; P--, x++) O += a * I[P] >>> 0, I[P] = O % 256 >>> 0, O = O / 256 >>> 0;
                if (O !== 0) throw new Error("Non-zero carry");
                y = x, w++
            }
            if (m[w] !== " ") {
                for (var _ = b - y; _ !== b && I[_] === 0;) _++;
                for (var D = new Uint8Array(g + (b - _)), v = g; _ !== b;) D[v++] = I[_++];
                return D
            }
        }
    }
...
const zu = (t, e) => new oy({ ...t.decoders || {
        [t.prefix]: t
    },
    ...e.decoders || {
        [e.prefix]: e
...
class ay {
    constructor(e, s, r, i) {
        this.name = e, this.prefix = s, this.baseEncode = r, this.baseDecode = i, this.encoder = new iy(e, s, r), this.decoder = new ny(e, s, i)
    }
    encode(e) {
...
const In = ({
    ...
    ly = (t, e, s) => {
        ...
        for (let c = 0; c < t.length; ++c)
            for (a = a << 8 | t[c], o += 8; o > s;) o -= s, n += e[i & a >> o];
        if (o && (n += e[i & a << s - o]), r)
            for (; n.length * s & 7;) n += "=";
        return n
    },
...
const Hu = Array.from("🚀🪐☄🛰🌌🌑🌒🌓🌔🌕🌖🌗🌘🌍🌏🌎🐉☀💻🖥💾💿😂❤😍🤣😊🙏💕😭😘👍😅👏😁🔥🥰💔💖💙😢🤔😆🙄💪😉☺👌🤗💜😔😎😇🌹🤦🎉💞✌✨🤷😱😌🌸🙌😋💗💚😏💛🙂💓🤩😄😀🖤😃💯🙈👇🎶😒🤭❣😜💋👀😪😑💥🙋😞😩😡🤪👊🥳😥🤤👉💃😳✋😚😝😴🌟😬🙃🍀🌷😻😓⭐✅🥺🌈😈🤘💦✔😣🏃💐☹🎊💘😠☝😕🌺🎂🌻😐🖕💝🙊😹🗣💫💀👑🎵🤞😛🔴😤🌼😫⚽🤙☕🏆🤫👈😮🙆🍻🍃🐶💁😲🌿🧡🎁⚡🌞🎈❌✊👋😰🤨😶🤝🚶💰🍓💢🤟🙁🚨💨🤬✈🎀🍺🤓😙💟🌱😖👶🥴▶➡❓💎💸⬇😨🌚🦋😷🕺⚠🙅😟😵👎🤲🤠🤧📌🔵💅🧐🐾🍒😗🤑🌊🤯🐷☎💧😯💆👆🎤🙇🍑❄🌴💣🐸💌📍🥀🤢👅💡💩👐📸👻🤐🤮🎼🥵🚩🍎🍊👼💍📣🥂"),
    Fy = Hu.reduce((t, e, s) => (t[s] = e, t), []),
    Wy = Hu.reduce((t, e, s) => (t[e.codePointAt(0)] = s, t), []);

function zy(t) {
    return t.reduce((e, s) => (e += Fy[s], e), "")
}

function Hy(t) {
    const e = [];
    for (const s of t) {
        const r = Wy[s.codePointAt(0)];
...
function Vu(t, e, s) {
    e = e || [], s = s || 0;
    for (var r = s; t >= Yy;) e[s++] = t & 255 | Tc, t /= 128;
    for (; t & Jy;) e[s++] = t & 255 | Tc, t >>>= 7;
    return e[s] = t | 0, Vu.bytes = s - r + 1, e
}
var Xy = Po,
    Zy = 128,
    Oc = 127;
...
function Po(t, r) {
    ...
    do {
        ...
        o = t[n++], s += i < 28 ? (o & Oc) << i : (o & Oc) * Math.pow(2, i), i += 7
    } while (o >= Zy);
...
var Qy = Math.pow(2, 7),
    ...
    ab = Math.pow(2, 63),
    cb = function(t) {
        return t < Qy ? 1 : t < eb ? 2 : t < tb ? 3 : t < sb ? 4 : t < rb ? 5 : t < ib ? 6 : t < nb ? 7 : t < ob ? 8 : t < ab ? 9 : 10
    },
    lb = {
        encode: Gy,
        decode: Xy,
    ...
    Ku = lb;
const $c = (t, e, s = 0) => (Ku.encode(t, e, s), e),
    xc = t => Ku.encodingLength(t),
    ko = (t, e) => {
        const s = e.byteLength,
            r = xc(t),
            i = r + xc(s),
            n = new Uint8Array(i + s);
        return $c(t, n, 0), $c(s, n, r), n.set(e, i), new ub(t, s, e, n)
    };
class ub {
    constructor(e, s, r, i) {
...
class db {
    ...
    digest(e) {
        if (e instanceof Uint8Array) {
            ...
            return s instanceof Uint8Array ? ko(this.code, s) : s.then(r => ko(this.code, r))
        } else throw Error("Unknown type, must be binary type")
    }
}
const Ju = t => async e => new Uint8Array(await crypto.subtle.digest(t, e)),
    hb = Gu({
        name: "sha2-256",
        code: 18,
        encode: Ju("SHA-256")
...
const Uc = Zu("utf8", "u", t => "u" + new TextDecoder("utf8").decode(t), t => new TextEncoder().encode(t.substring(1))),
    Kn = Zu("ascii", "a", t => {
        let e = "a";
        for (let s = 0; s < t.length; s++) e += String.fromCharCode(t[s]);
        return e
...
function Eb(t, e = "utf8") {
    const s = vb[e];
    if (!s) throw new Error(`Unsupported encoding "${e}"`);
    return (e === "utf8" || e === "utf-8") && globalThis.Buffer != null && globalThis.Buffer.from != null ? globalThis.Buffer.from(t, "utf8") : s.decoder.decode(`${s.prefix}${t}`)
}
var Cb = Object.defineProperty,
    Ib = (t, e, s) => e in t ? Cb(t, e, {
        enumerable: !0,
        configurable: !0,
        writable: !0,
        value: s
    }) : t[e] = s,
    Bt = (t, e, s) => Ib(t, typeof e != "symbol" ? e + "" : e, s);
class Nb {
    constructor(e, s) {
        this.core = e, this.logger = s, Bt(this, "keychain", new Map), Bt(this, "name", Nw), Bt(this, "version", Aw), Bt(this, "initialized", !1), Bt(this, "storagePrefix", Vt), Bt(this, "init", async () => {
            if (!this.initialized) {
                const r = await this.getKeyChain();
                typeof r < "u" && (this.keychain = r), this.initialized = !0
            }
        }), Bt(this, "has", r => (this.isInitialized(), this.keychain.has(r))), Bt(this, "set", async (r, i) => {
            ...
            if (typeof i > "u") {
                const {
                    message: n
                } = R("NO_MATCHING_KEY", `${this.name}: ${r}`);
                throw new Error(n)
            }
            return i
        }), Bt(this, "del", async r => {
            this.isInitialized(), this.keychain.delete(r), await this.persist()
        }), this.core = e, this.logger = tt(s, this.name)
    }
    get context() {
    ...
    isInitialized() {
        if (!this.initialized) {
            const {
                message: e
            } = R("NOT_INITIALIZED", this.name);
            throw new Error(e)
        }
    }
}
var Ab = Object.defineProperty,
    _b = (t, e, s) => e in t ? Ab(t, e, {
        enumerable: !0,
        configurable: !0,
        writable: !0,
        value: s
    }) : t[e] = s,
    He = (t, e, s) => _b(t, typeof e != "symbol" ? e + "" : e, s);
class Sb {
    constructor(e, s, r) {
        this.core = e, this.logger = s, He(this, "name", Cw), He(this, "keychain"), He(this, "randomSessionIdentifier", Ao()), He(this, "initialized", !1), He(this, "init", async () => {
            this.initialized || (await this.keychain.init(), this.initialized = !0)
        }), He(this, "hasKeys", i => (this.isInitialized(), this.keychain.has(i))), He(this, "getClientId", async () => {
            this.isInitialized();
            const i = await this.getClientSeed(),
                n = ha(i);
            return Od(n.publicKey)
            ...
            const a = Uu(o),
                c = xd(n);
            if (gc(a)) return vm(c, o ? .encoding);
            if (fc(a)) {
                const h = a.senderPublicKey,
                    f = a.receiverPublicKey;
                i = await this.generateSharedKey(h, f)
            }
        ...
        }), He(this, "getPayloadType", (i, n = Ut) => {
            const o = Ei({
                encoded: i,
                encoding: n
            });
            return Hs(o.type)
        }), He(this, "getPayloadSenderPublicKey", (i, n = Ut) => {
            const o = Ei({
                encoded: i,
                encoding: n
            });
            return o.senderPublicKey ? lt(o.senderPublicKey, et) : void 0
        }), this.core = e, this.logger = tt(s, this.name), this.keychain = r || new Nb(this.core, this.logger)
    }
    get context() {
        return yt(this.logger)
    }
    ...
    async getClientSeed() {
        ...
        try {
            ...
            e = Ao(), await this.keychain.set(Sc, e)
        }
        return Eb(e, "base16")
    }
    getSymKey(e) {
...
var Pb = Object.defineProperty,
    ...
    xb = (t, e) => {
        for (var s in e || (e = {})) Ob.call(e, s) && To(t, s, e[s]);
        if (Dc)
            for (var s of Dc(e)) $b.call(e, s) && To(t, s, e[s]);
        return t
    },
    Rb = (t, e) => kb(t, Tb(e)),
    dt = (t, e, s) => To(t, typeof e != "symbol" ? e + "" : e, s);
class Ub extends Th {
    constructor(e, s) {
        super(e, s), this.logger = e, this.core = s, dt(this, "messages", new Map), dt(this, "messagesWithoutClientAck", new Map), dt(this, "name", _w), dt(this, "version", Sw), dt(this, "initialized", !1), dt(this, "storagePrefix", Vt), dt(this, "init", async () => {
            if (!this.initialized) {
        ...
        }), dt(this, "set", async (r, i, n) => {
            this.isInitialized();
            const o = zt(i);
            let a = this.messages.get(r);
            if (typeof a > "u" && (a = {}), typeof a[o] < "u") return o;
            if (a[o] = i, this.messages.set(r, a), n === Qi.inbound) {
                const c = this.messagesWithoutClientAck.get(r) || {};
                this.messagesWithoutClientAck.set(r, Rb(xb({}, c), {
                    [o]: i
                }))
            }
        ...
        }), this.logger = tt(e, this.name), this.core = s
    }
    get context() {
        return yt(this.logger)
    }
...
var Db = Object.defineProperty,
    ...
    zi = (t, e) => {
        for (var s in e || (e = {})) Bb.call(e, s) && Oo(t, s, e[s]);
        if (Lc)
            for (var s of Lc(e)) jb.call(e, s) && Oo(t, s, e[s]);
        return t
    },
    Gn = (t, e) => Lb(t, Mb(e)),
    Ot = (t, e, s) => Oo(t, typeof e != "symbol" ? e + "" : e, s);
class qb extends Oh {
    constructor(e, s) {
        super(e, s), this.relayer = e, this.logger = s, Ot(this, "events", new Ks.EventEmitter), Ot(this, "name", Pw), Ot(this, "queue", new Map), Ot(this, "publishTimeout", U.toMiliseconds(U.ONE_MINUTE)), Ot(this, "initialPublishTimeout", U.toMiliseconds(U.ONE_SECOND * 15)), Ot(this, "needsTransportRestart", !1), Ot(this, "publish", async (r, i, n) => {
            var o;
            ...
            const a = n ? .ttl || Pc,
                ...
                f = `Failed to publish payload, please try again. id:${d} tag:${u}`;
            try {
                const m = new Promise(async w => {
                    const g = ({
                        id: b
                    }) => {
                        h.opts.id === b && (this.removeRequestFromQueue(b), this.relayer.events.removeListener(je.publish, g), w(h))
                    };
                    ...
                    const y = ys(new Promise((b, I) => {
                        this.rpcPublish({
                            ...
                            this.logger.warn(O, O ? .message), I(O)
                        })
                    }), this.initialPublishTimeout, `Failed initial publish, retrying.... id:${d} tag:${u}`);
                    try {
                        await y, this.events.removeListener(je.publish, g)
                    } catch (b) {
                        this.queue.set(d, Gn(zi({}, h), {
                            attempt: 1
                ...
                if (this.logger.debug("Failed to Publish Payload"), this.logger.error(m), (o = n ? .internal) != null && o.throwOnFailedPublish) throw m
            } finally {
                this.queue.delete(d)
            }
        }), Ot(this, "on", (r, i) => {
            ...
            this.events.off(r, i)
        }), Ot(this, "removeListener", (r, i) => {
            this.events.removeListener(r, i)
        }), this.relayer = e, this.logger = tt(s, this.name), this.registerEventListeners()
    }
    get context() {
        return yt(this.logger)
    }
    async rpcPublish(e) {
        ...
        Ke((s = m.params) == null ? void 0 : s.prompt) && ((r = m.params) == null || delete r.prompt), Ke((i = m.params) == null ? void 0 : i.tag) && ((n = m.params) == null || delete n.tag), this.logger.debug("Outgoing Relay Payload"), this.logger.trace({
            type: "message",
            direction: "outgoing",
            request: m
        });
        const w = await this.relayer.request(m);
        return this.relayer.events.emit(je.publish, e), this.logger.debug("Successfully Published Payload"), w
    }
    ...
    checkQueue() {
        this.queue.forEach(async (e, s) => {
            ...
            this.logger.warn({}, `Publisher: queue->publishing: ${e.opts.id}, tag: ${e.opts.tag}, attempt: ${r}`), await this.rpcPublish(Gn(zi({}, e), {
                topic: i,
                message: n,
                ttl: o.ttl,
                prompt: o.prompt,
    ...
    registerEventListeners() {
        this.relayer.core.heartbeat.on(Dr.pulse, () => {
...
var Fb = Object.defineProperty,
    Wb = (t, e, s) => e in t ? Fb(t, e, {
        enumerable: !0,
        configurable: !0,
        writable: !0,
        value: s
    }) : t[e] = s,
    tr = (t, e, s) => Wb(t, typeof e != "symbol" ? e + "" : e, s);
class zb {
    constructor() {
        tr(this, "map", new Map), tr(this, "set", (e, s) => {
            const r = this.get(e);
            this.exists(e, s) || this.map.set(e, [...r, s])
        }), tr(this, "get", e => this.map.get(e) || []), tr(this, "exists", (e, s) => this.get(e).includes(s)), tr(this, "delete", (e, s) => {
            if (typeof s > "u") {
                this.map.delete(e);
                return
            }
...
var Hb = Object.defineProperty,
    ...
    Yr = (t, e) => {
        for (var s in e || (e = {})) Gb.call(e, s) && $o(t, s, e[s]);
        if (Mc)
            for (var s of Mc(e)) Jb.call(e, s) && $o(t, s, e[s]);
        return t
    },
    Jn = (t, e) => Vb(t, Kb(e)),
    we = (t, e, s) => $o(t, typeof e != "symbol" ? e + "" : e, s);
class Yb extends Rh {
    constructor(e, s) {
        super(e, s), this.relayer = e, this.logger = s, we(this, "subscriptions", new Map), we(this, "topicMap", new zb), we(this, "events", new Ks.EventEmitter), we(this, "name", Uw), we(this, "version", Dw), we(this, "pending", new Map), we(this, "cached", []), we(this, "initialized", !1), we(this, "storagePrefix", Vt), we(this, "subscribeTimeout", U.toMiliseconds(U.ONE_MINUTE)), we(this, "initialSubscribeTimeout", U.toMiliseconds(U.ONE_SECOND * 15)), we(this, "clientId"), we(this, "batchSubscribeTopicsLimit", 500), we(this, "init", async () => {
            this.initialized || (this.logger.trace("Initialized"), this.registerEventListeners(), await this.restore()), this.initialized = !0
        }), we(this, "subscribe", async (r, i) => {
        ...
        }), we(this, "unsubscribe", async (r, i) => {
            this.isInitialized(), typeof i ? .id < "u" ? await this.unsubscribeById(r, i.id, i) : await this.unsubscribeByTopic(r, i)
        }), we(this, "isSubscribed", r => new Promise(i => {
            i(this.topicMap.topics.includes(r))
        })), we(this, "isKnownTopic", r => new Promise(i => {
            ...
            this.events.off(r, i)
        }), we(this, "removeListener", (r, i) => {
            this.events.removeListener(r, i)
        }), we(this, "start", async () => {
            await this.onConnect()
        }), we(this, "stop", async () => {
            await this.onDisconnect()
        }), we(this, "restart", async () => {
            await this.restore(), await this.onRestart()
        }), we(this, "checkPending", async () => {
            if (this.pending.size === 0 && (!this.initialized || !this.relayer.connected)) return;
            const r = [];
            this.pending.forEach(i => {
                r.push(i)
            }), await this.batchSubscribe(r)
        }), we(this, "registerEventListeners", () => {
            this.relayer.core.heartbeat.on(Dr.pulse, async () => {
                await this.checkPending()
            }), this.events.on(ht.created, async r => {
                const i = ht.created;
            ...
            }), this.events.on(ht.deleted, async r => {
                const i = ht.deleted;
                this.logger.info(`Emitting ${i}`), this.logger.debug({
                    type: "event",
                    event: i,
        ...
        }), this.relayer = e, this.logger = tt(s, this.name), this.clientId = ""
    }
    get context() {
        return yt(this.logger)
    }
    ...
    async unsubscribeById(e, s, r) {
        ...
        try {
            ...
            await this.onUnsubscribe(e, s, n), this.logger.debug("Successfully Unsubscribed Topic"), this.logger.trace({
                type: "method",
                method: "unsubscribe",
                params: {
                    topic: e,
    ...
    async rpcSubscribe(e, s, r) {
        var i;
        (!r || r ? .transportType === Ne.relay) && await this.restartToComplete({
            topic: e,
            id: e,
            relay: s
        });
        const n = {
            method: si(s.protocol).subscribe,
            params: {
                topic: e
            }
        };
        ...
        try {
            ...
            if (r ? .transportType === Ne.link_mode) return setTimeout(() => {
            ...
            const c = new Promise(async u => {
                    const d = h => {
                        h.topic === e && (this.events.removeListener(ht.created, d), u(h.id))
                    };
                    this.events.on(ht.created, d);
                    try {
                        const h = await ys(new Promise((f, m) => {
                            this.relayer.request(n).catch(w => {
                                this.logger.warn(w, w ? .message), m(w)
                            }).then(f)
                        }), this.initialSubscribeTimeout, `Subscribing to ${e} failed, please try again`);
                        this.events.removeListener(ht.created, d), u(h)
                    } catch {}
                }),
            ...
            if (this.logger.debug("Outgoing Relay Subscribe Payload stalled"), this.relayer.events.emit(je.connection_stalled), o) throw a
        }
        return null
    }
    async rpcBatchSubscribe(e) {
        ...
        const s = e[0].relay,
            r = {
                method: si(s.protocol).batchSubscribe,
                params: {
    ...
    async rpcBatchFetchMessages(e) {
        ...
        const s = e[0].relay,
            r = {
                method: si(s.protocol).batchFetchMessages,
                params: {
    ...
    rpcUnsubscribe(e, s, r) {
        const i = {
            method: si(r.protocol).unsubscribe,
            params: {
                topic: e,
                id: s
            }
    ...
    onSubscribe(e, s) {
        this.setSubscription(e, Jn(Yr({}, s), {
            id: e
    ...
    addSubscription(e, s) {
        this.subscriptions.set(e, Yr({}, s)), this.topicMap.set(s.topic, e), this.events.emit(ht.created, s)
    }
    getSubscription(e) {
    ...
    deleteSubscription(e, s) {
        ...
        this.subscriptions.delete(e), this.topicMap.delete(r.topic, e), this.events.emit(ht.deleted, Jn(Yr({}, r), {
            reason: s
        }))
    }
    async persist() {
    ...
    async restore() {
        try {
            ...
            if (this.subscriptions.size) {
                const {
                    message: s
                } = R("RESTORE_WILL_OVERRIDE", this.name);
    ...
    async batchSubscribe(e) {
        e.length && (await this.rpcBatchSubscribe(e), this.onBatchSubscribe(await Promise.all(e.map(async s => Jn(Yr({}, s), {
    ...
    async batchFetchMessages(e) {
        ...
        s && s.messages && (await sf(U.toMiliseconds(U.ONE_SECOND)), await this.relayer.handleBatchMessageEvents(s.messages))
    }
    async onConnect() {
    ...
    async getSubscriptionId(e) {
        return zt(e + await this.getClientId())
    }
}
var Xb = Object.defineProperty,
    ...
    jc = (t, e) => {
        for (var s in e || (e = {})) Zb.call(e, s) && xo(t, s, e[s]);
        if (Bc)
            for (var s of Bc(e)) Qb.call(e, s) && xo(t, s, e[s]);
        return t
    },
    le = (t, e, s) => xo(t, typeof e != "symbol" ? e + "" : e, s);
class ev extends $h {
    constructor(e) {
        super(e), le(this, "protocol", "wc"), le(this, "version", 2), le(this, "core"), le(this, "logger"), le(this, "events", new Ks.EventEmitter), le(this, "provider"), le(this, "messages"), le(this, "subscriber"), le(this, "publisher"), le(this, "name", Tw), le(this, "transportExplicitlyClosed", !1), le(this, "initialized", !1), le(this, "connectionAttemptInProgress", !1), le(this, "relayUrl"), le(this, "projectId"), le(this, "packageName"), le(this, "bundleId"), le(this, "hasExperiencedNetworkDisruption", !1), le(this, "pingTimeout"), le(this, "heartBeatTimeout", U.toMiliseconds(U.THIRTY_SECONDS + U.FIVE_SECONDS)), le(this, "reconnectTimeout"), le(this, "connectPromise"), le(this, "reconnectInProgress", !1), le(this, "requestsInFlight", []), le(this, "connectTimeout", U.toMiliseconds(U.ONE_SECOND * 15)), le(this, "request", async s => {
            var r, i;
            this.logger.debug("Publishing Request Payload");
            const n = s.id || yr().toString();
            ...
            cn() && (clearTimeout(this.pingTimeout), this.pingTimeout = setTimeout(() => {
                var s, r, i, n;
                try {
            ...
            this.logger.warn({}, "Relayer connected 🛜"), this.startPingTimeout(), this.events.emit(je.connect)
        }), le(this, "onDisconnectHandler", () => {
            this.logger.warn({}, "Relayer disconnected 🛑"), this.requestsInFlight = [], this.onProviderDisconnect()
        }), le(this, "onProviderErrorHandler", s => {
            this.logger.fatal(`Fatal socket error: ${s.message}`), this.events.emit(je.error, s), this.logger.fatal("Fatal socket error received, closing transport"), this.transportClose()
        }), le(this, "registerProviderListeners", () => {
            this.provider.on(Ct.payload, this.onPayloadHandler), this.provider.on(Ct.connect, this.onConnectHandler), this.provider.on(Ct.disconnect, this.onDisconnectHandler), this.provider.on(Ct.error, this.onProviderErrorHandler)
        }), this.core = e.core, this.logger = typeof e.logger < "u" && typeof e.logger != "string" ? tt(e.logger, this.name) : Wo(Ai({
            level: e.logger || kw
        })), this.messages = new Ub(this.logger, e.core), this.subscriber = new Yb(this, this.logger), this.publisher = new qb(this, this.logger), this.relayUrl = e ? .relayUrl || qu, this.projectId = e.projectId, jp() ? this.packageName = Ma() : qp() && (this.bundleId = Ma()), this.provider = {}
    }
    async init() {
    ...
    async publish(e, s, r) {
        this.isInitialized(), await this.publisher.publish(e, s, r), await this.recordMessageEvent({
            topic: e,
            message: s,
            publishedAt: Date.now(),
            transportType: Ne.relay
        }, Qi.outbound)
    }
    async subscribe(e, s) {
        var r, i, n;
        ...
        let a = ((n = this.subscriber.topicMap.get(e)) == null ? void 0 : n[0]) || "",
            c;
        const l = u => {
            u.topic === e && (this.subscriber.off(ht.created, l), c())
        };
        return await Promise.all([new Promise(u => {
            c = u, this.subscriber.on(ht.created, l)
        }), new Promise(async (u, d) => {
            a = await this.subscriber.subscribe(e, jc({
                internal: {
    ...
    async confirmOnlineStateOrThrow() {
        if (!await _c()) throw new Error("No internet connection detected. Please restart your network and try again.")
    }
    ...
    async onLinkMessageEvent(e, s) {
        ...
        this.events.emit(je.message, e), await this.recordMessageEvent(e, Qi.inbound)
    }
    async connect(e) {
        ...
        for (; s < 6;) {
            try {
                ...
                this.logger.debug({}, `Connecting to ${this.relayUrl}, attempt: ${s}...`), await this.createProvider(), await new Promise(async (r, i) => {
                    ...
                    this.provider.once(Ct.disconnect, n), await ys(new Promise((o, a) => {
                        this.provider.connect().then(o).catch(a)
                    }), this.connectTimeout, `Socket stalled when trying to connect to ${this.relayUrl}`).catch(o => {
                        i(o)
                    }).finally(() => {
                        this.provider.off(Ct.disconnect, n), clearTimeout(this.reconnectTimeout)
                    }), await new Promise(async (o, a) => {
                        const c = () => {
                            a(new Error("Connection interrupted while trying to subscribe"))
                        };
                        this.provider.once(Ct.disconnect, c), await this.subscriber.start().then(o).catch(a).finally(() => {
                            this.provider.off(Ct.disconnect, c)
                        })
    ...
    async createProvider() {
        ...
        this.provider = new St(new Td(Vp({
            sdkVersion: So,
    ...
    async onProviderPayload(e) {
        if (this.logger.debug("Incoming Relay Payload"), this.logger.trace({
            ...
            if (!e.method.endsWith(Ow)) return;
            const s = e.params,
                {
                    topic: r,
                    message: i,
            ...
            this.logger.debug("Emitting Relayer Payload"), this.logger.trace(jc({
                type: "event",
                event: s.id
            }, a)), this.events.emit(s.id, a), await this.acknowledgePayload(e), await this.onMessageEvent(a)
        } else Ho(e) && this.events.emit(je.message_ack, e)
    }
    async onMessageEvent(e) {
        await this.shouldIgnoreMessageEvent(e) || (await this.recordMessageEvent(e, Qi.inbound), this.events.emit(je.message, e))
    }
    ...
    unregisterProviderListeners() {
        this.provider.off(Ct.payload, this.onPayloadHandler), this.provider.off(Ct.connect, this.onConnectHandler), this.provider.off(Ct.disconnect, this.onDisconnectHandler), this.provider.off(Ct.error, this.onProviderErrorHandler), clearTimeout(this.pingTimeout)
    }
    async registerEventListeners() {
        let e = await _c();
        gw(async s => {
            e !== s && (e = s, s ? await this.transportOpen().catch(r => this.logger.error(r, r ? .message)) : (this.hasExperiencedNetworkDisruption = !0, await this.transportDisconnect(), this.transportExplicitlyClosed = !1))
        }), this.core.heartbeat.on(Dr.pulse, async () => {
            if (!this.transportExplicitlyClosed && !this.connected && yw()) try {
    ...
    async onProviderDisconnect() {
        clearTimeout(this.pingTimeout), this.events.emit(je.disconnect), this.connectionAttemptInProgress = !1, !this.reconnectInProgress && (this.reconnectInProgress = !0, await this.subscriber.stop(), this.subscriber.hasAnyTopics && (this.transportExplicitlyClosed || (this.reconnectTimeout = setTimeout(async () => {
...
function di(t, e, s, r) {
    ...
    let i = Wc(t),
        n = Wc(e);
    if (i === zc && (i = Yn), n === zc && (n = Yn), i !== n) return !1;
    switch (i) {
        case rv:
    ...
    try {
        switch (i) {
            ...
            case lv:
                {
                    ...
                    for (let u = 0; u < c.length; u++) {
                        const d = c[u],
                            h = l.findIndex(f => ri(d, f, void 0, t, e, s, r));
                        if (h === -1) return !1;
                        l.splice(h, 1)
                    }
                    return !0
            ...
            case hv:
                return t.byteLength !== e.byteLength ? !1 : di(new Uint8Array(t), new Uint8Array(e), s, r);
            case fv:
                return t.byteLength !== e.byteLength || t.byteOffset !== e.byteOffset ? !1 : di(new Uint8Array(t), new Uint8Array(e), s, r);
            case pv:
                return t.name === e.name && t.message === e.message;
            case Yn:
                {
                    if (!(di(t.constructor, e.constructor, s, r) || qc(t) && qc(e))) return !1;
                    const c = [...Object.keys(t), ...Fc(t)],
                        l = [...Object.keys(e), ...Fc(e)];
...
var kv = Object.defineProperty,
    ...
    Vc = (t, e) => {
        for (var s in e || (e = {})) Tv.call(e, s) && Ro(t, s, e[s]);
        if (Hc)
            for (var s of Hc(e)) Ov.call(e, s) && Ro(t, s, e[s]);
        return t
    },
    nt = (t, e, s) => Ro(t, typeof e != "symbol" ? e + "" : e, s);
class Gs extends xh {
    constructor(e, s, r, i = Vt, n = void 0) {
        super(e, s, r, i), this.core = e, this.logger = s, this.name = r, nt(this, "map", new Map), nt(this, "version", xw), nt(this, "cached", []), nt(this, "initialized", !1), nt(this, "getKey"), nt(this, "storagePrefix", Vt), nt(this, "recentlyDeleted", []), nt(this, "recentlyDeletedLimit", 200), nt(this, "init", async () => {
            this.initialized || (this.logger.trace("Initialized"), await this.restore(), this.cached.forEach(o => {
                this.getKey && o !== null && !Ke(o) ? this.map.set(this.getKey(o), o) : Vm(o) ? this.map.set(o.id, o) : Km(o) && this.map.set(o.topic, o)
            }), this.cached = [], this.initialized = !0)
        }), nt(this, "set", async (o, a) => {
        ...
        }), nt(this, "get", o => (this.isInitialized(), this.logger.debug("Getting value"), this.logger.trace({
            type: "method",
            method: "get",
            key: o
        }), this.getData(o))), nt(this, "getAll", o => (this.isInitialized(), o ? this.values.filter(a => Object.keys(o).every(c => Pv(a[c], o[c]))) : this.values)), nt(this, "update", async (o, a) => {
            ...
            const c = Vc(Vc({}, this.getData(o)), a);
            this.map.set(o, c), await this.persist()
        }), nt(this, "delete", async (o, a) => {
        ...
        }), this.logger = tt(s, this.name), this.storagePrefix = i, this.getKey = n
    }
    get context() {
        return yt(this.logger)
    }
    ...
    getData(e) {
        ...
        if (!s) {
            if (this.recentlyDeleted.includes(e)) {
                const {
                    message: i
                } = R("MISSING_OR_INVALID", `Record was recently deleted - ${this.name}: ${e}`);
...
var $v = Object.defineProperty,
    xv = (t, e, s) => e in t ? $v(t, e, {
        enumerable: !0,
        configurable: !0,
        writable: !0,
        value: s
    }) : t[e] = s,
    ie = (t, e, s) => xv(t, typeof e != "symbol" ? e + "" : e, s);
class Rv {
    constructor(e, s) {
        this.core = e, this.logger = s, ie(this, "name", Lw), ie(this, "version", Mw), ie(this, "events", new Vo), ie(this, "pairings"), ie(this, "initialized", !1), ie(this, "storagePrefix", Vt), ie(this, "ignoredPayloadTypes", [is]), ie(this, "registeredMethods", []), ie(this, "init", async () => {
            ...
            return this.events.emit(Us.create, c), this.core.expirer.set(n, o), await this.pairings.set(n, c), await this.core.relayer.subscribe(n, {
            ...
            i.props.properties.topic = n, i.addTrace(qt.pairing_uri_validation_success), i.addTrace(qt.pairing_uri_not_expired);
            let u;
            if (this.pairings.keys.includes(n)) {
                if (u = this.pairings.get(n), i.addTrace(qt.existing_pairing), u.active) throw i.setError(es.active_pairing_already_exists), new Error(`Pairing already exists: ${n}. Please try again with a new connection URI.`);
                i.addTrace(qt.pairing_not_expired)
            }
            const d = c || Ue(U.FIVE_MINUTES),
                h = {
                    topic: n,
                    relay: a,
                    expiry: d,
            ...
            this.core.expirer.set(n, d), await this.pairings.set(n, h), i.addTrace(qt.store_new_pairing), r.activatePairing && await this.activate({
                topic: n
            }), this.events.emit(Us.create, h), i.addTrace(qt.emit_inactive_pairing), this.core.crypto.keychain.has(n) || await this.core.crypto.setSymKey(o, n), i.addTrace(qt.subscribing_pairing_topic);
            try {
                await this.core.relayer.confirmOnlineStateOrThrow()
            } catch {
                i.setError(es.no_internet_connection)
            }
            try {
                ...
                throw i.setError(es.subscribe_pairing_topic_failure), f
            }
            return i.addTrace(qt.subscribe_pairing_topic_success), h
        }), ie(this, "activate", async ({
            topic: r
        }) => {
            this.isInitialized();
            const i = Ue(U.FIVE_MINUTES);
            this.core.expirer.set(r, i), await this.pairings.update(r, {
                active: !0,
                expiry: i
            })
            ...
            if (this.pairings.keys.includes(i)) {
                ...
                this.events.once(pe("pairing_ping", n), ({
                    error: l
                }) => {
                    l ? c(l) : a()
                }), await o()
            }
        }), ie(this, "updateExpiry", async ({
            topic: r,
            expiry: i
        }) => {
            ...
            const {
                ...
                expiry: o,
                methods: a
            } = r, c = this.core.crypto.keychain.get(i);
            return wc({
                protocol: this.core.protocol,
                version: this.core.version,
                topic: i,
            ...
            const o = Ol(r, n),
                a = await this.core.crypto.encode(i, o),
                c = (await this.core.history.get(i, r)).request.method,
                l = Gr[c] ? Gr[c].res : Gr.unregistered_method.res;
            await this.core.relayer.publish(i, a, l), await this.core.history.resolve(o)
            ...
            const {
                topic: i,
                payload: n
            } = r, o = (await this.core.history.get(i, n.id)).request.method;
            ...
            try {
                this.isValidPing({
                    topic: r
                }), await this.sendResult(n, r, !0), this.events.emit(Us.ping, {
                    id: n,
                    topic: r
                })
            } catch (o) {
            ...
            setTimeout(() => {
                Qt(i) ? this.events.emit(pe("pairing_ping", n), {}) : Ft(i) && this.events.emit(pe("pairing_ping", n), {
                    error: i.error
                })
            }, 500)
            ...
            try {
                this.isValidDisconnect({
                    topic: r
                }), await this.deletePairing(r), this.events.emit(Us.delete, {
                    id: n,
                    topic: r
                })
            } catch (o) {
            ...
            if (!at(r)) {
                const {
                    message: a
                } = R("MISSING_OR_INVALID", `pair() params: ${r}`);
                throw i.setError(es.malformed_pairing_uri), new Error(a)
            }
            if (!Hm(r.uri)) {
                const {
                    message: a
                } = R("MISSING_OR_INVALID", `pair() uri: ${r.uri}`);
                throw i.setError(es.malformed_pairing_uri), new Error(a)
            }
            const o = mc(r ? .uri);
            if (!((n = o ? .relay) != null && n.protocol)) {
                const {
                    message: a
                } = R("MISSING_OR_INVALID", "pair() uri#relay-protocol");
                throw i.setError(es.malformed_pairing_uri), new Error(a)
            }
            if (!(o != null && o.symKey)) {
                const {
                    message: a
                } = R("MISSING_OR_INVALID", "pair() uri#symKey");
                throw i.setError(es.malformed_pairing_uri), new Error(a)
            }
            if (o != null && o.expiryTimestamp && U.toMiliseconds(o ? .expiryTimestamp) < Date.now()) {
                i.setError(es.pairing_expired);
                const {
                    message: a
                } = R("EXPIRED", "pair() URI has expired. Please try again with a new connection URI.");
                throw new Error(a)
            }
            ...
            if (!at(r)) {
                const {
                    message: n
                } = R("MISSING_OR_INVALID", `ping() params: ${r}`);
                throw new Error(n)
            }
            const {
                topic: i
            ...
            if (!at(r)) {
                const {
                    message: n
                } = R("MISSING_OR_INVALID", `disconnect() params: ${r}`);
                throw new Error(n)
            }
            const {
                topic: i
            ...
            if (!Oe(r, !1)) {
                const {
                    message: i
                } = R("MISSING_OR_INVALID", `pairing topic should be a string: ${r}`);
                throw new Error(i)
            }
            if (!this.pairings.keys.includes(r)) {
                const {
                    message: i
                } = R("NO_MATCHING_KEY", `pairing topic doesn't exist: ${r}`);
                throw new Error(i)
            }
            if (fs(this.pairings.get(r).expiry)) {
                ...
                const {
                    message: i
                } = R("EXPIRED", `pairing topic: ${r}`);
                throw new Error(i)
            }
        }), this.core = e, this.logger = tt(s, this.name), this.pairings = new Gs(this.core, this.logger, this.name, this.storagePrefix)
    }
    get context() {
        return yt(this.logger)
    }
    ...
    registerRelayerEvents() {
        this.core.relayer.on(je.message, async e => {
            ...
            if (this.pairings.keys.includes(s) && i !== Ne.link_mode && !this.ignoredPayloadTypes.includes(this.core.crypto.getPayloadType(r))) try {
                ...
                zo(n) ? (this.core.history.set(s, n), await this.onRelayEventRequest({
                    topic: s,
                    payload: n
                })) : Ho(n) && (await this.core.history.resolve(n), await this.onRelayEventResponse({
                    topic: s,
                    payload: n
                }), this.core.history.delete(s, n.id)), await this.core.relayer.messages.ack(s, r)
            } catch (n) {
                this.logger.error(n)
            }
        })
    ...
    registerExpirerEvents() {
        this.core.expirer.on(At.expired, async e => {
            ...
            s && this.pairings.keys.includes(s) && (await this.deletePairing(s, !0), this.events.emit(Us.expire, {
                topic: s
            }))
        })
    }
...
var Uv = Object.defineProperty,
    Dv = (t, e, s) => e in t ? Uv(t, e, {
        enumerable: !0,
        configurable: !0,
        writable: !0,
        value: s
    }) : t[e] = s,
    Ve = (t, e, s) => Dv(t, typeof e != "symbol" ? e + "" : e, s);
class Lv extends kh {
    constructor(e, s) {
        super(e, s), this.core = e, this.logger = s, Ve(this, "records", new Map), Ve(this, "events", new Ks.EventEmitter), Ve(this, "name", Bw), Ve(this, "version", jw), Ve(this, "cached", []), Ve(this, "initialized", !1), Ve(this, "storagePrefix", Vt), Ve(this, "init", async () => {
            ...
            const o = {
                ...
                chainId: n,
                expiry: Ue(U.THIRTY_DAYS)
            };
            this.records.set(o.id, o), this.persist(), this.events.emit(kt.created, o)
            ...
            typeof i.response > "u" && (i.response = Ft(r) ? {
                error: r.error
            } : {
                result: r.result
            }, this.records.set(i.id, i), this.persist(), this.events.emit(kt.updated, i))
        }), Ve(this, "get", async (r, i) => (this.isInitialized(), this.logger.debug("Getting record"), this.logger.trace({
            type: "method",
            method: "get",
            topic: r,
            id: i
        }), await this.getRecord(i))), Ve(this, "delete", (r, i) => {
        ...
        }), Ve(this, "exists", async (r, i) => (this.isInitialized(), this.records.has(i) ? (await this.getRecord(i)).topic === r : !1)), Ve(this, "on", (r, i) => {
            this.events.on(r, i)
        }), Ve(this, "once", (r, i) => {
            this.events.once(r, i)
        }), Ve(this, "off", (r, i) => {
    ...
    get pending() {
        ...
        return this.values.forEach(s => {
            ...
            const r = {
                topic: s.topic,
                request: Ls(s.request.method, s.request.params, s.id),
                chainId: s.chainId
            };
            return e.push(r)
        }), e
    ...
    registerEventListeners() {
        ...
        }), this.core.heartbeat.on(Dr.pulse, () => {
            this.cleanup()
        })
    }
    cleanup() {
        try {
            ...
            this.records.forEach(s => {
                U.toMiliseconds(s.expiry || 0) - Date.now() <= 0 && (this.logger.info(`Deleting expired history log: ${s.id}`), this.records.delete(s.id), this.events.emit(kt.deleted, s, !1), e = !0)
            }), e && this.persist()
        } catch (e) {
            this.logger.warn(e)
        }
...
var Mv = Object.defineProperty,
    Bv = (t, e, s) => e in t ? Mv(t, e, {
        enumerable: !0,
        configurable: !0,
        writable: !0,
        value: s
    }) : t[e] = s,
    Ye = (t, e, s) => Bv(t, typeof e != "symbol" ? e + "" : e, s);
class jv extends Uh {
    constructor(e, s) {
        super(e, s), this.core = e, this.logger = s, Ye(this, "expirations", new Map), Ye(this, "events", new Ks.EventEmitter), Ye(this, "name", qw), Ye(this, "version", Fw), Ye(this, "cached", []), Ye(this, "initialized", !1), Ye(this, "storagePrefix", Vt), Ye(this, "init", async () => {
            ...
            this.expirations.set(n, o), this.checkExpiry(n, o), this.events.emit(At.created, {
                target: n,
                expiration: o
            })
        }), Ye(this, "get", r => {
            ...
            if (this.isInitialized(), this.has(r)) {
                ...
                this.expirations.delete(i), this.events.emit(At.deleted, {
                    target: i,
                    expiration: n
                })
            }
    ...
    formatTarget(e) {
        if (typeof e == "string") return Kp(e);
        if (typeof e == "number") return Gp(e);
        const {
            message: s
        } = R("UNKNOWN_TYPE", `Target type: ${typeof e}`);
        throw new Error(s)
    }
    ...
    expire(e, s) {
        this.expirations.delete(e), this.events.emit(At.expired, {
            target: e,
            expiration: s
        })
    }
    ...
    registerEventListeners() {
        this.core.heartbeat.on(Dr.pulse, () => this.checkExpirations()), this.events.on(At.created, e => {
            const s = At.created;
            this.logger.info(`Emitting ${s}`), this.logger.debug({
                type: "event",
                event: s,
...
var qv = Object.defineProperty,
    Fv = (t, e, s) => e in t ? qv(t, e, {
        enumerable: !0,
        configurable: !0,
        writable: !0,
        value: s
    }) : t[e] = s,
    Te = (t, e, s) => Fv(t, typeof e != "symbol" ? e + "" : e, s);
class Wv extends Dh {
    constructor(e, s, r) {
        super(e, s, r), this.core = e, this.logger = s, this.store = r, Te(this, "name", Ww), Te(this, "abortController"), Te(this, "isDevEnv"), Te(this, "verifyUrlV3", Hw), Te(this, "storagePrefix", Vt), Te(this, "version", Bu), Te(this, "publicKey"), Te(this, "fetchPromise"), Te(this, "init", async () => {
            var i;
            ...
            try {
                const l = ns.getDocument(),
                    u = this.startAbortTimer(U.ONE_SECOND * 5),
                    d = await new Promise((h, f) => {
                        const m = () => {
                            window.removeEventListener("message", g), l.body.removeChild(w), f("attestation aborted")
                        };
                        this.abortController.signal.addEventListener("abort", m);
                        const w = l.createElement("iframe");
                        w.src = c, w.style.display = "none", w.addEventListener("error", m, {
                        ...
                        const g = y => {
                            if (y.data && typeof y.data == "string") try {
                                ...
                                if (b.type === "verify_attestation") {
                                    if (oo(b.attestation).payload.id !== o) return;
                                    clearInterval(u), l.body.removeChild(w), this.abortController.signal.removeEventListener("abort", m), window.removeEventListener("message", g), h(b.attestation === null ? "" : b.attestation)
                                }
                            } catch (b) {
                                this.logger.warn(b)
                            }
                        };
                        l.body.appendChild(w), window.addEventListener("message", g, {
                            signal: this.abortController.signal
                        })
                    });
            ...
            let n = i || ui;
            return Vw.includes(n) || (this.logger.info(`verify url: ${n}, not included in trusted list, assigning default: ${ui}`), n = ui), n
        ...
        }), this.logger = tt(s, this.name), this.abortController = new AbortController, this.isDevEnv = Go(), this.init()
    }
    get storeKey() {
...
var zv = Object.defineProperty,
    Hv = (t, e, s) => e in t ? zv(t, e, {
        enumerable: !0,
        configurable: !0,
        writable: !0,
        value: s
    }) : t[e] = s,
    Kc = (t, e, s) => Hv(t, typeof e != "symbol" ? e + "" : e, s);
class Vv extends Lh {
    constructor(e, s) {
        super(e, s), this.projectId = e, this.logger = s, Kc(this, "context", Kw), Kc(this, "registerDeviceToken", async r => {
            const {
                clientId: i,
                token: n,
                notificationType: o,
                enableEncrypted: a = !1
            } = r, c = `${Gw}/${this.projectId}/clients`;
            await fetch(c, {
                method: "POST",
                headers: {
                    "Content-Type": "application/json"
...
var Kv = Object.defineProperty,
    ...
    Xr = (t, e) => {
        for (var s in e || (e = {})) Gv.call(e, s) && Uo(t, s, e[s]);
        if (Gc)
            for (var s of Gc(e)) Jv.call(e, s) && Uo(t, s, e[s]);
        return t
    },
    Le = (t, e, s) => Uo(t, typeof e != "symbol" ? e + "" : e, s);
class Yv extends Mh {
    constructor(e, s, r = !0) {
        super(e, s, r), this.core = e, this.logger = s, Le(this, "context", Yw), Le(this, "storagePrefix", Vt), Le(this, "storageVersion", Jw), Le(this, "events", new Map), Le(this, "shouldPersist", !1), Le(this, "init", async () => {
            if (!Go()) try {
                const i = {
                    eventId: ja(),
                    timestamp: Date.now(),
                    ...
                    props: {
                        ...
                        properties: {
                            ...
                            user_agent: eu(this.core.relayer.protocol, this.core.relayer.version, So)
                        }
                    }
                };
            ...
            } = i, l = ja(), u = this.core.projectId || "", d = Date.now(), h = Xr({
                eventId: l,
                timestamp: d,
                props: {
                    event: n,
            ...
            if (a) return Xr(Xr({}, a), this.setMethods(a.eventId))
            ...
            this.core.heartbeat.on(Dr.pulse, async () => {
                this.shouldPersist && await this.persist(), this.events.forEach(i => {
                    U.fromMiliseconds(Date.now()) - U.fromMiliseconds(i.timestamp) > Xw && (this.events.delete(i.eventId), this.shouldPersist = !0)
                })
            })
        }), Le(this, "setMethods", i => ({
            addTrace: n => this.addTrace(i, n),
            setError: n => this.setError(i, n)
        })), Le(this, "addTrace", (i, n) => {
            ...
            try {
                ...
                if (!i.length) return;
                i.forEach(n => {
                    this.events.set(n.eventId, Xr(Xr({}, n), this.setMethods(n.eventId)))
                })
            } catch (i) {
                this.logger.warn(i)
            }
            ...
            return await fetch(`${Zw}?projectId=${this.core.projectId}&st=events_sdk&sv=js-${So}${n}`, {
                method: "POST",
                body: JSON.stringify(i)
            })
        }), Le(this, "getAppDomain", () => Ql().url), this.logger = tt(s, this.context), this.telemetryEnabled = r, r ? this.restore().then(async () => {
...
var Xv = Object.defineProperty,
    ...
    Yc = (t, e) => {
        for (var s in e || (e = {})) Zv.call(e, s) && Do(t, s, e[s]);
        if (Jc)
            for (var s of Jc(e)) Qv.call(e, s) && Do(t, s, e[s]);
        return t
    },
    Ce = (t, e, s) => Do(t, typeof e != "symbol" ? e + "" : e, s);
let e0 = class Qu extends Ah {
    constructor(e) {
        var s;
        super(e), Ce(this, "protocol", Mu), Ce(this, "version", Bu), Ce(this, "name", _o), Ce(this, "relayUrl"), Ce(this, "projectId"), Ce(this, "customStoragePrefix"), Ce(this, "events", new Ks.EventEmitter), Ce(this, "logger"), Ce(this, "heartbeat"), Ce(this, "relayer"), Ce(this, "crypto"), Ce(this, "storage"), Ce(this, "history"), Ce(this, "expirer"), Ce(this, "pairing"), Ce(this, "verify"), Ce(this, "echoClient"), Ce(this, "linkModeSupportedApps"), Ce(this, "eventClient"), Ce(this, "initialized", !1), Ce(this, "logChunkController"), Ce(this, "on", (a, c) => this.events.on(a, c)), Ce(this, "once", (a, c) => this.events.once(a, c)), Ce(this, "off", (a, c) => this.events.off(a, c)), Ce(this, "removeListener", (a, c) => this.events.removeListener(a, c)), Ce(this, "dispatchEnvelope", ({
            topic: a,
            message: c,
            sessionExists: l
        }) => {
        ...
        this.projectId = e ? .projectId, this.relayUrl = e ? .relayUrl || qu, this.customStoragePrefix = e != null && e.customStoragePrefix ? `:${e.customStoragePrefix}` : "";
        const i = Ai({
                level: typeof e ? .logger == "string" && e.logger ? e.logger : vw.logger,
                name: _o
            }),
            {
                logger: n,
        ...
        }), this.logger = tt(n, this.name), this.heartbeat = new Pd, this.crypto = new Sb(this, this.logger, e ? .keychain), this.history = new Lv(this, this.logger), this.expirer = new jv(this, this.logger), this.storage = e != null && e.storage ? e.storage : new kd(Yc(Yc({}, Ew), e ? .storageOptions)), this.relayer = new ev({
            core: this,
            logger: this.logger,
            relayUrl: this.relayUrl,
            projectId: this.projectId
        }), this.pairing = new Rv(this, this.logger), this.verify = new Wv(this, this.logger, this.storage), this.echoClient = new Vv(this.projectId || "", this.logger), this.linkModeSupportedApps = [], this.eventClient = new Yv(this, this.logger, e ? .telemetryEnabled), this.setGlobalCore(this)
    }
    static async init(e) {
        const s = new Qu(e);
        await s.initialize();
        const r = await s.crypto.getClientId();
        return await s.storage.setItem(Rw, r), s
    }
    get context() {
        return yt(this.logger)
    }
    ...
    async addLinkModeSupportedApp(e) {
        this.linkModeSupportedApps.includes(e) || (this.linkModeSupportedApps.push(e), await this.storage.setItem(kc, this.linkModeSupportedApps))
    }
    async initialize() {
        this.logger.trace("Initialized");
        try {
            await this.crypto.init(), await this.history.init(), await this.expirer.init(), await this.relayer.init(), await this.heartbeat.init(), await this.pairing.init(), this.linkModeSupportedApps = await this.storage.getItem(kc) || [], this.initialized = !0, this.logger.info("Core Initialization Success")
        } catch (e) {
    ...
    isGlobalCoreDisabled() {
        try {
            return typeof process < "u" && bw.DISABLE_GLOBAL_CORE === "true"
        } catch {
            return !0
        }
    }
...
const t0 = e0,
    ...
    Xc = "WALLETCONNECT_DEEPLINK_CHOICE",
    s0 = "proposal",
    Zc = "Proposal expired",
    r0 = "session",
    sr = U.SEVEN_DAYS,
    ...
    n0 = "request",
    o0 = ["wc_sessionPropose", "wc_sessionRequest", "wc_authRequest", "wc_sessionAuthenticate"],
    a0 = "wc",
    c0 = "auth",
    l0 = "authKeys",
    u0 = "pairingTopics",
...
var h0 = Object.defineProperty,
    ...
    ye = (t, e) => {
        for (var s in e || (e = {})) g0.call(e, s) && Lo(t, s, e[s]);
        if (el)
            for (var s of el(e)) m0.call(e, s) && Lo(t, s, e[s]);
        return t
    },
    Qe = (t, e) => p0(t, f0(e)),
    N = (t, e, s) => Lo(t, typeof e != "symbol" ? e + "" : e, s);
class w0 extends Fh {
    constructor(e) {
        super(e), N(this, "name", i0), N(this, "events", new Vo), N(this, "initialized", !1), N(this, "requestQueue", {
            state: jt.idle,
            queue: []
        }), N(this, "sessionRequestQueue", {
            state: jt.idle,
            queue: []
        }), N(this, "requestQueueDelay", U.ONE_SECOND), N(this, "expectedPairingMethodMap", new Map), N(this, "recentlyDeletedMap", new Map), N(this, "recentlyDeletedLimit", 200), N(this, "relayMessageCache", []), N(this, "pendingSessions", new Map), N(this, "init", async () => {
            ...
            await this.isValidConnect(r), r.optionalNamespaces = jm(r.requiredNamespaces, r.optionalNamespaces), r.requiredNamespaces = {};
            const {
                pairingTopic: i,
            ...
            if (!u) {
                const {
                    message: P
                } = R("NO_MATCHING_KEY", `connect() pairing topic: ${u}`);
                throw new Error(P)
            }
            const f = await this.client.core.crypto.generateKeyPair(),
                m = Me.wc_sessionPropose.req.ttl || U.FIVE_MINUTES,
                w = Ue(m),
                g = Qe(ye(ye({
                    requiredNamespaces: n,
                    optionalNamespaces: o,
                ...
                x = ({
                    ...
                    P === g.id && (this.client.events.off("proposal_expire", x), this.pendingSessions.delete(g.id), this.events.emit(y, {
                        error: {
                            message: Zc,
                            code: 0
                        }
            ...
            return this.client.events.on("proposal_expire", x), this.events.once(y, ({
                error: P,
                session: _
            }) => {
                this.client.events.off("proposal_expire", x), P ? b(P) : _ && I(_)
            ...
            const o = this.client.core.eventClient.createEvent({
                properties: {
                    ...
                    trace: [Tt.session_approve_started]
                }
            });
            try {
                this.isInitialized(), await this.confirmOnlineStateOrThrow()
            } catch (v) {
                throw o.setError(Ps.no_internet_connection), v
            }
            try {
                await this.isValidProposalId(s ? .id)
            } catch (v) {
                throw this.client.logger.error(`approve() -> proposal.get(${s?.id}) failed`), o.setError(Ps.proposal_not_found), v
            }
            try {
                await this.isValidApprove(s)
            } catch (v) {
                throw this.client.logger.error("approve() -> isValidApprove() failed"), o.setError(Ps.session_approve_namespace_validation_failure), v
            }
            const {
                id: a,
                relayProtocol: c,
                ...
                scopedProperties: d,
                sessionConfig: h
            } = s, f = this.client.proposal.get(a);
            ...
            b || (b = (n = this.client.core.eventClient) == null ? void 0 : n.createEvent({
                type: Tt.session_approve_started,
                properties: {
                    topic: m,
                    trace: [Tt.session_approve_started, Tt.session_namespaces_validation_success]
                }
            }));
            const I = await this.client.core.crypto.generateKeyPair(),
                O = w.publicKey,
                x = await this.client.core.crypto.generateSharedKey(I, O),
                P = ye(ye(ye({
                    relay: {
                        protocol: c ? ? "irn"
                    },
                ...
                _ = Ne.relay;
            b.addTrace(Tt.subscribing_session_topic);
            try {
                await this.client.core.relayer.subscribe(x, {
                    transportType: _
                })
            } catch (v) {
                throw b.setError(Ps.subscribe_session_topic_failure), v
            }
            b.addTrace(Tt.subscribe_session_topic_success);
            const D = Qe(ye({}, P), {
                topic: x,
                requiredNamespaces: g,
                optionalNamespaces: y,
            ...
            await this.client.session.set(x, D), b.addTrace(Tt.store_session);
            try {
                b.addTrace(Tt.publishing_session_settle), await this.sendRequest({
                    topic: x,
                    method: "wc_sessionSettle",
                    params: P,
                    throwOnFailedPublish: !0
                }).catch(v => {
                    throw b ? .setError(Ps.session_settle_publish_failure), v
                }), b.addTrace(Tt.session_settle_publish_success), b.addTrace(Tt.publishing_session_approve), await this.sendResult({
                    id: a,
                    topic: m,
                    result: {
                        relay: {
                    ...
                    throw b ? .setError(Ps.session_approve_publish_failure), v
                }), b.addTrace(Tt.session_approve_publish_success)
            } catch (v) {
            ...
            return this.client.core.eventClient.deleteEvent({
                ...
                topic: m,
                metadata: w.metadata
            }), await this.client.proposal.delete(a, me("USER_DISCONNECTED")), await this.client.core.pairing.activate({
                topic: m
            }), await this.setExpiry(x, Ue(sr)), {
                topic: x,
            ...
            n && (await this.sendError({
                ...
                topic: n,
                error: i,
                rpcOpts: Me.wc_sessionPropose.reject
            }), await this.client.proposal.delete(r, me("USER_DISCONNECTED")))
            ...
            const {
                ...
                resolve: o,
                reject: a
            } = $s(), c = os(), l = yr().toString(), u = this.client.session.get(r).namespaces;
            return this.events.once(pe("session_update", c), ({
                error: d
            }) => {
                d ? a(d) : o()
                ...
                this.client.logger.error(d), this.client.session.update(r, {
                    namespaces: u
                }), a(d)
            }), {
                acknowledged: n
            ...
            return this.events.once(pe("session_extend", i), ({
                error: c
            }) => {
                c ? a(c) : o()
            }), await this.setExpiry(r, Ue(sr)), this.sendRequest({
                topic: r,
            ...
            const {
                ...
                request: i,
                topic: n,
                expiry: o = Me.wc_sessionRequest.req.ttl
            } = s, a = this.client.session.get(n);
            ...
            const c = os(),
                l = yr().toString(),
                {
                    ...
                    resolve: d,
                    reject: h
                } = $s(o, "Request expired. Please try again.");
            this.events.once(pe("session_request", c), ({
                error: y,
                result: b
            }) => {
                y ? h(y) : d(b)
            ...
            if (m) return await this.sendRequest({
                ...
                throwOnFailedPublish: !0,
                appLink: m
            }).catch(y => h(y)), this.client.events.emit("session_request_sent", {
                topic: n,
                request: i,
                chainId: r,
                id: c
            ...
            return await Promise.all([new Promise(async y => {
                ...
                if (!((b = a.sessionConfig) != null && b.disableDeepLink)) {
                    const I = await Zp(this.client.core.storage, Xc);
                    await Jp({
                        id: c,
                        topic: n,
                        wcDeepLink: I
            ...
            Qt(i) ? await this.sendResult({
                id: n,
                topic: r,
                result: i.result,
                throwOnFailedPublish: !0,
                appLink: a
            }) : Ft(i) && await this.sendError({
                id: n,
                topic: r,
                error: i.error,
                appLink: a
            ...
            if (this.client.session.keys.includes(r)) {
                ...
                this.events.once(pe("session_ping", i), ({
                    error: l
                }) => {
                    l ? c(l) : a()
            ...
            } else this.client.core.pairing.pairings.keys.includes(r) && (this.client.logger.warn("ping() on pairing topic is deprecated and will be removed in the next major release."), await this.client.core.pairing.ping({
                topic: r
            }))
        }), N(this, "emit", async s => {
            ...
            if (this.client.session.keys.includes(r)) await this.sendRequest({
                ...
                const {
                    message: i
                } = R("MISMATCHED_TOPIC", `Session or pairing topic not found: ${r}`);
                throw new Error(i)
            }
        }), N(this, "find", s => (this.isInitialized(), this.client.session.getAll().filter(r => Wm(r, s)))), N(this, "getPendingSessionRequests", () => this.client.pendingRequest.getAll()), N(this, "authenticate", async (s, r) => {
            var i;
            ...
            const O = await this.client.core.crypto.generateKeyPair(),
                x = Zi(O);
            if (await Promise.all([this.client.auth.authKeys.set(en, {
                    responseTopic: x,
                    publicKey: O
                    ...
                    transportType: o
                }), this.client.logger.info(`sending request to new pairing topic: ${b}`), w.length > 0) {
                const {
                    namespace: T
                } = Cr(a[0]);
                let G = Hf(T, "request", w);
                Xi(y) && (G = Kf(G, y.pop())), y.push(G)
            }
            const P = g && g > Me.wc_sessionAuthenticate.req.ttl ? g : Me.wc_sessionAuthenticate.req.ttl,
                _ = {
                    authPayload: {
                        type: h ? ? "caip122",
                        chains: a,
                ...
                v = {
                    ...
                    expiryTimestamp: Ue(Me.wc_sessionPropose.req.ttl),
                    id: os()
                },
                {
                    done: $,
                ...
                H = os(),
                C = pe("session_connect", v.id),
                k = pe("session_request", H),
                A = async ({
                    error: T,
                    session: G
                }) => {
                    this.events.off(k, B), T ? L(T) : G && E({
                        session: G
                    })
                },
                B = async T => {
                    ...
                    if (await this.deletePendingAuthRequest(H, {
                        ...
                        const xe = me("WC_METHOD_UNSUPPORTED", "wc_sessionAuthenticate");
                        return T.error.code === xe.code ? void 0 : (this.events.off(C, A), L(T.error.message))
                    }
                    await this.deleteProposal(v.id), this.events.off(C, A);
                    const {
                        cacaos: ve,
                        responder: he
                    } = T.result, ke = [], De = [];
                    for (const xe of ve) {
                        ...
                        }) || (this.client.logger.error(xe, "Signature verification failed"), L(me("SESSION_SETTLEMENT_FAILED", "Signature verification failed")));
                        const {
                            p: _s
                        } = xe, Kt = Xi(_s.resources), Lt = [mo(_s.iss)], Gt = ln(_s.iss);
                        if (Kt) {
                            const Ys = Ja(Kt),
                                Di = Ya(Kt);
                            ke.push(...Ys), Lt.push(...Di)
                        }
                        for (const Ys of Lt) De.push(`${Ys}:${Gt}`)
                    }
                    const Je = await this.client.core.crypto.generateSharedKey(O, he.publicKey);
                    let $e;
                    ke.length > 0 && ($e = {
                        topic: Je,
                        acknowledged: !0,
                        ...
                        pairingTopic: b,
                        namespaces: Ec([...new Set(ke)], [...new Set(De)]),
                        transportType: o
                    }, await this.client.core.relayer.subscribe(Je, {
                        transportType: o
                    }), await this.client.session.set(Je, $e), b && await this.client.core.pairing.updateMetadata({
                        topic: b,
                        metadata: he.metadata
                    }), $e = this.client.session.get(Je)), (G = this.client.metadata.redirect) != null && G.linkMode && (Q = he.metadata.redirect) != null && Q.linkMode && (se = he.metadata.redirect) != null && se.universal && r && (this.client.core.addLinkModeSupportedApp(he.metadata.redirect.universal), this.client.session.update(Je, {
                        transportType: Ne.link_mode
                    })), E({
                        auths: ve,
                        session: $e
            ...
            this.events.once(C, A), this.events.once(k, B);
            let q;
            try {
                if (n) {
                    const T = Ls("wc_sessionAuthenticate", _, H);
                    ...
                    method: "wc_sessionPropose",
                    params: v,
                    expiry: Me.wc_sessionPropose.req.ttl,
                    throwOnFailedPublish: !0,
                    clientRpcId: v.id
                })])
            } catch (T) {
                throw this.events.off(C, A), this.events.off(k, B), T
            }
            return await this.setProposal(v.id, v), await this.setAuthRequest(H, {
                request: Qe(ye({}, _), {
                    verifyContext: {}
                }),
                pairingTopic: b,
            ...
            const {
                id: r,
                auths: i
            } = s, n = this.client.core.eventClient.createEvent({
                properties: {
                    topic: r.toString(),
            ...
            try {
                ...
                throw n.setError(Jr.no_internet_connection), g
            }
            const o = this.getPendingAuthRequest(r);
            if (!o) throw n.setError(Jr.authenticated_session_pending_request_not_found), new Error(`Could not find pending auth request with id ${r}`);
            ...
            for (const g of i) {
                ...
                const {
                    p: y
                } = g, b = Xi(y.resources), I = [mo(y.iss)], O = ln(y.iss);
                if (b) {
                    const x = Ja(b),
                        P = Ya(b);
                    h.push(...x), I.push(...P)
                }
                for (const x of I) f.push(`${x}:${O}`)
            }
            ...
            if (h ? .length > 0) {
                w = {
                    ...
                    namespaces: Ec([...new Set(h)], [...new Set(f)]),
                    transportType: a
                ...
                try {
                    ...
                    throw n.setError(Jr.subscribe_authenticated_session_topic_failure), g
                }
                n.addTrace(ks.subscribe_authenticated_session_topic_success), await this.client.session.set(m, w), n.addTrace(ks.store_authenticated_session), await this.client.core.pairing.updateMetadata({
            ...
            try {
                ...
                throw n.setError(Jr.authenticated_session_approve_publish_failure), g
            }
            ...
            const {
                id: r,
                reason: i
            } = s, n = this.getPendingAuthRequest(r);
            ...
            await this.sendError({
                ...
                error: i,
                encodeOpts: l,
                rpcOpts: Me.wc_sessionAuthenticate.reject,
            ...
            if (s.pairingTopic) try {
                ...
                this.client.logger.info(`Cleaning up ${i.length} duplicate pairing(s)`), await Promise.all(i.map(n => this.client.core.pairing.disconnect({
                    topic: n.topic
            ...
            await this.client.core.relayer.unsubscribe(i), await this.client.session.delete(i, me("USER_DISCONNECTED")), this.addToRecentlyDeleted(i, "session"), this.client.core.crypto.keychain.has(c.publicKey) && await this.client.core.crypto.deleteKeyPair(c.publicKey), this.client.core.crypto.keychain.has(i) && await this.client.core.crypto.deleteSymKey(i), n || this.client.core.expirer.del(i), this.client.core.storage.removeItem(Xc).catch(l => this.client.logger.warn(l)), this.getPendingSessionRequests().forEach(l => {
                l.topic === i && this.deletePendingSessionRequest(l.id, me("USER_DISCONNECTED"))
            }), i === ((r = this.sessionRequestQueue.queue[0]) == null ? void 0 : r.topic) && (this.sessionRequestQueue.state = jt.idle), o && this.client.events.emit("session_delete", {
                id: a,
                topic: i
            })
            ...
            await Promise.all([this.client.pendingRequest.delete(s, r), i ? Promise.resolve() : this.client.core.expirer.del(s)]), this.addToRecentlyDeleted(s, "request"), this.sessionRequestQueue.queue = this.sessionRequestQueue.queue.filter(n => n.id !== s), i && (this.sessionRequestQueue.state = jt.idle, this.client.events.emit("session_request_expire", {
                id: s
            }))
            ...
            this.client.session.keys.includes(s) && (this.client.core.expirer.set(s, r), await this.client.session.update(s, {
                expiry: r
            }))
        }), N(this, "setProposal", async (s, r) => {
            this.client.core.expirer.set(s, Ue(Me.wc_sessionPropose.req.ttl)), await this.client.proposal.set(s, r)
        }), N(this, "setAuthRequest", async (s, r) => {
            const {
                request: i,
                pairingTopic: n,
                transportType: o = Ne.relay
            } = r;
            this.client.core.expirer.set(s, i.expiryTimestamp), await this.client.auth.requests.set(s, {
            ...
            const {
                ...
                params: n,
                verifyContext: o
            } = s, a = n.request.expiryTimestamp || Ue(Me.wc_sessionRequest.req.ttl);
            this.client.core.expirer.set(r, a), await this.client.pendingRequest.set(r, {
                id: r,
                topic: i,
                params: n,
                verifyContext: o
            ...
            try {
                const y = m ? gs : Ut;
                f = await this.client.core.crypto.encode(r, h, {
                    encoding: y
                })
            } catch (y) {
            ...
            const g = Me[i].req;
            if (g.attestation = w, o && (g.ttl = o), a && (g.id = a), this.client.core.history.set(r, h), m) {
                const y = Wi(u, r, f);
                await global.Linking.openURL(y, this.client.name)
            } else {
                const y = Me[i].req;
                o && (y.ttl = o), a && (y.id = a), y.tvf = Qe(ye({}, d), {
                    correlationId: h.id
                }), l ? (y.internal = Qe(ye({}, y.internal), {
                    throwOnFailedPublish: !0
            ...
            try {
                const m = d ? gs : Ut;
                u = await this.client.core.crypto.encode(i, l, Qe(ye({}, a || {}), {
                    encoding: m
                }))
            } catch (m) {
                throw await this.cleanup(), this.client.logger.error(`sendResult() -> core.crypto.encode() for topic ${i} failed`), m
            }
            let h, f;
            try {
                ...
                throw this.client.logger.error(`sendResult() -> history.get(${i}, ${r}) failed`), m
            }
            if (d) {
                const m = Wi(c, i, u);
                await global.Linking.openURL(m, this.client.name)
            } else {
                const m = h.request.method,
                    w = Me[m].res;
                w.tvf = Qe(ye({}, f), {
                    correlationId: r
                }), o ? (w.internal = Qe(ye({}, w.internal), {
                    throwOnFailedPublish: !0
                }), await this.client.core.relayer.publish(i, u, w)) : this.client.core.relayer.publish(i, u, w).catch(g => this.client.logger.error(g))
            }
            ...
            try {
                const f = d ? gs : Ut;
                u = await this.client.core.crypto.encode(i, l, Qe(ye({}, o || {}), {
                    encoding: f
                }))
            } catch (f) {
                throw await this.cleanup(), this.client.logger.error(`sendError() -> core.crypto.encode() for topic ${i} failed`), f
            }
            let h;
            try {
                h = await this.client.core.history.get(i, r)
            } catch (f) {
                throw this.client.logger.error(`sendError() -> history.get(${i}, ${r}) failed`), f
            }
            if (d) {
                const f = Wi(c, i, u);
                await global.Linking.openURL(f, this.client.name)
            } else {
                const f = h.request.method,
                    m = a || Me[f].res;
                this.client.core.relayer.publish(i, u, m)
            }
            await this.client.core.history.resolve(l)
            ...
            this.client.session.getAll().forEach(i => {
                let n = !1;
                fs(i.expiry) && (n = !0), this.client.core.crypto.keychain.has(i.topic) || (n = !0), n && s.push(i.topic)
            ...
            const {
                ...
                payload: i,
                transportType: n
            } = s, o = (await this.client.core.history.get(r, i.id)).request.method;
            switch (o) {
                case "wc_sessionPropose":
            ...
            const {
                ...
                message: i
            } = R("MISSING_OR_INVALID", `Decoded payload on topic ${r} is not identifiable as a JSON-RPC request or a response.`);
            throw new Error(i)
        }), N(this, "shouldIgnorePairingRequest", s => {
            const {
                topic: r,
                requestMethod: i
            } = s, n = this.expectedPairingMethodMap.get(r);
            ...
            try {
                ...
                this.client.events.listenerCount("session_proposal") === 0 && (console.warn("No listener for session_proposal event"), l ? .setError(es.proposal_listener_not_found)), this.isValidConnect(ye({}, i.params));
                const u = a.expiryTimestamp || Ue(Me.wc_sessionPropose.req.ttl),
                    d = ye({
                        id: c,
                        pairingTopic: r,
                        expiryTimestamp: u
                ...
                await this.sendError({
                    ...
                    topic: r,
                    error: l,
                    rpcOpts: Me.wc_sessionPropose.autoReject
            ...
            try {
                ...
                const {
                    ...
                    scopedProperties: d,
                    sessionConfig: h
                } = r.params, f = [...this.pendingSessions.values()].find(g => g.sessionTopic === s);
            ...
            Qt(r) ? (await this.client.session.update(s, {
                acknowledged: !0
            }), this.events.emit(pe("session_approve", i), {})) : Ft(r) && (await this.client.session.delete(s, me("USER_DISCONNECTED")), this.events.emit(pe("session_approve", i), {
                error: r.error
            }))
            ...
            try {
                ...
                if (a && this.isRequestOutOfSync(a, n)) {
                    this.client.logger.warn(`Discarding out of sync request - ${n}`), this.sendError({
                        id: n,
                        topic: s,
                        error: me("INVALID_UPDATE_REQUEST")
                    });
                    return
                }
                this.isValidUpdate(ye({
                    topic: s
                }, i));
                try {
                    Kr.set(o, n), await this.client.session.update(s, {
            ...
            const {
                id: i
            } = r, n = pe("session_update", i);
            if (this.events.listenerCount(n) === 0) throw new Error(`emitting ${n} without any listeners`);
            Qt(r) ? this.events.emit(pe("session_update", i), {}) : Ft(r) && this.events.emit(pe("session_update", i), {
                error: r.error
            })
            ...
            try {
                this.isValidExtend({
                    topic: s
                }), await this.setExpiry(s, Ue(sr)), await this.sendResult({
                    id: i,
                    topic: s,
                    result: !0,
                    throwOnFailedPublish: !0
            ...
            const {
                id: i
            } = r, n = pe("session_extend", i);
            if (this.events.listenerCount(n) === 0) throw new Error(`emitting ${n} without any listeners`);
            Qt(r) ? this.events.emit(pe("session_extend", i), {}) : Ft(r) && this.events.emit(pe("session_extend", i), {
                error: r.error
            })
            ...
            const {
                id: i
            } = r, n = pe("session_ping", i);
            setTimeout(() => {
                if (this.events.listenerCount(n) === 0) throw new Error(`emitting ${n} without any listeners 2176`);
                Qt(r) ? this.events.emit(pe("session_ping", i), {}) : Ft(r) && this.events.emit(pe("session_ping", i), {
                    error: r.error
                })
            }, 500)
            ...
            try {
                await this.isValidRequest(ye({
                    topic: o
                }, h));
                const f = this.client.session.get(o),
                    m = await this.getVerifyContext({
                        attestationId: c,
                        hash: zt(JSON.stringify(Ls("wc_sessionRequest", h, d))),
                        encryptedId: l,
                ...
                await this.setPendingSessionRequest(w), u === Ne.link_mode && (r = f.peer.metadata.redirect) != null && r.universal && this.client.core.addLinkModeSupportedApp((i = f.peer.metadata.redirect) == null ? void 0 : i.universal), (n = this.client.signConfig) != null && n.disableRequestQueue ? this.emitSessionRequest(w) : (this.addSessionRequestToSessionRequestQueue(w), this.processSessionRequestQueue())
            } catch (f) {
                await this.sendError({
                    id: d,
                    topic: o,
            ...
            const {
                id: i
            } = r, n = pe("session_request", i);
            if (this.events.listenerCount(n) === 0) throw new Error(`emitting ${n} without any listeners`);
            Qt(r) ? this.events.emit(pe("session_request", i), {
                result: r.result
            }) : Ft(r) && this.events.emit(pe("session_request", i), {
                error: r.error
            })
            ...
            try {
                const {
                    ...
                    authPayload: u,
                    expiryTimestamp: d
                } = n.params, h = await this.getVerifyContext({
                    attestationId: o,
                    hash: zt(JSON.stringify(n)),
                    encryptedId: a,
                    metadata: l.metadata,
                    transportType: c
                }), f = {
                ...
                await this.setAuthRequest(n.id, {
                    ...
                    pairingTopic: i,
                    transportType: c
                }), c === Ne.link_mode && (r = l.metadata.redirect) != null && r.universal && this.client.core.addLinkModeSupportedApp(l.metadata.redirect.universal), this.client.events.emit("session_authenticate", {
                    topic: i,
                    params: n.params,
                    id: n.id,
                    verifyContext: h
                ...
                const u = n.params.requester.publicKey,
                    ...
                    h = this.getAppLinkIfEnabled(n.params.requester.metadata, c),
                    f = {
                        type: is,
                        receiverPublicKey: u,
                        senderPublicKey: d
                ...
                await this.sendError({
                    ...
                    error: l,
                    encodeOpts: f,
                    rpcOpts: Me.wc_sessionAuthenticate.autoReject,
                    appLink: h
                })
            }
        ...
        }), N(this, "cleanupPendingSentRequestsForTopic", ({
            topic: s,
            error: r
        }) => {
            ...
            try {
                this.sessionRequestQueue.state = jt.active, this.emitSessionRequest(s)
            } catch (r) {
                this.client.logger.error(r)
            }
            ...
            r && this.onSessionProposeRequest({
                topic: s.topic,
                payload: Ls("wc_sessionPropose", Qe(ye({}, r), {
            ...
            if (!at(s)) {
                const {
                    message: l
                } = R("MISSING_OR_INVALID", `connect() params: ${JSON.stringify(s)}`);
                throw new Error(l)
            }
            const {
                pairingTopic: r,
            ...
            if (Ke(r) || await this.isValidPairingTopic(r), !tw(c)) {
                const {
                    message: l
                } = R("MISSING_OR_INVALID", `connect() relays: ${c}`);
                throw new Error(l)
            }
            if (!Ke(i) && Cs(i) !== 0) {
            ...
            if (!Ke(n) && Cs(n) !== 0 && this.validateNamespaces(n, "optionalNamespaces"), Ke(o) || this.validateSessionProps(o, "sessionProperties"), !Ke(a)) {
            ...
            const i = ew(s, "connect()", r);
            if (i) throw new Error(i.message)
        }), N(this, "isValidApprove", async s => {
            if (!at(s)) throw new Error(R("MISSING_OR_INVALID", `approve() params: ${s}`).message);
            const {
                id: r,
                namespaces: i,
                relayProtocol: n,
            ...
            const u = Nc(c.requiredNamespaces, i, "approve()");
            if (u) throw new Error(u.message);
            if (!Oe(n, !0)) {
                const {
                    message: d
                } = R("MISSING_OR_INVALID", `approve() relayProtocol: ${n}`);
                throw new Error(d)
            }
            ...
            if (!at(s)) {
                const {
                    message: n
                } = R("MISSING_OR_INVALID", `reject() params: ${s}`);
                throw new Error(n)
            }
            const {
                id: r,
            ...
            if (this.checkRecentlyDeleted(r), await this.isValidProposalId(r), !rw(i)) {
                const {
                    message: n
                } = R("MISSING_OR_INVALID", `reject() reason: ${JSON.stringify(i)}`);
                throw new Error(n)
            }
            ...
            if (!at(s)) {
                const {
                    message: l
                } = R("MISSING_OR_INVALID", `onSessionSettleRequest() params: ${s}`);
                throw new Error(l)
            }
            const {
                relay: r,
            ...
            if (!Lu(r)) {
                const {
                    message: l
                } = R("MISSING_OR_INVALID", "onSessionSettleRequest() relay protocol should be a string");
                throw new Error(l)
            }
            const a = Gm(i, "onSessionSettleRequest()");
            ...
            if (fs(o)) {
                const {
                    message: l
                } = R("EXPIRED", "onSessionSettleRequest()");
                throw new Error(l)
            }
            ...
            if (!at(s)) {
                const {
                    message: c
                } = R("MISSING_OR_INVALID", `update() params: ${s}`);
                throw new Error(c)
            }
            const {
                topic: r,
            ...
            const a = Nc(n.requiredNamespaces, i, "update()");
            if (a) throw new Error(a.message)
        }), N(this, "isValidExtend", async s => {
            if (!at(s)) {
                const {
                    message: i
                } = R("MISSING_OR_INVALID", `extend() params: ${s}`);
                throw new Error(i)
            }
            const {
                topic: r
            ...
            if (!at(s)) {
                const {
                    message: c
                } = R("MISSING_OR_INVALID", `request() params: ${s}`);
                throw new Error(c)
            }
            const {
                topic: r,
            ...
            if (!Ic(a, n)) {
                const {
                    message: c
                } = R("MISSING_OR_INVALID", `request() chainId: ${n}`);
                throw new Error(c)
            }
            if (!iw(i)) {
                const {
                    message: c
                } = R("MISSING_OR_INVALID", `request() ${JSON.stringify(i)}`);
                throw new Error(c)
            }
            if (!aw(a, n, i.method)) {
                const {
                    message: c
                } = R("MISSING_OR_INVALID", `request() method: ${i.method}`);
                throw new Error(c)
            }
            if (o && !dw(o, Zn)) {
                const {
                    message: c
                } = R("MISSING_OR_INVALID", `request() expiry: ${o}. Expiry must be a number (in seconds) between ${Zn.min} and ${Zn.max}`);
                throw new Error(c)
            }
            ...
            if (!at(s)) {
                const {
                    message: o
                } = R("MISSING_OR_INVALID", `respond() params: ${s}`);
                throw new Error(o)
            }
            const {
                topic: i,
            ...
            try {
                ...
                throw (r = s ? .response) != null && r.id && this.cleanupAfterResponse(s), o
            }
            if (!nw(n)) {
                const {
                    message: o
                } = R("MISSING_OR_INVALID", `respond() response: ${JSON.stringify(n)}`);
                throw new Error(o)
            }
            ...
            if (!at(s)) {
                const {
                    message: i
                } = R("MISSING_OR_INVALID", `ping() params: ${s}`);
                throw new Error(i)
            }
            const {
                topic: r
            ...
            if (!at(s)) {
                const {
                    message: a
                } = R("MISSING_OR_INVALID", `emit() params: ${s}`);
                throw new Error(a)
            }
            const {
                topic: r,
            ...
            if (!Ic(o, n)) {
                const {
                    message: a
                } = R("MISSING_OR_INVALID", `emit() chainId: ${n}`);
                throw new Error(a)
            }
            if (!ow(i)) {
                const {
                    message: a
                } = R("MISSING_OR_INVALID", `emit() event: ${JSON.stringify(i)}`);
                throw new Error(a)
            }
            if (!cw(o, n, i.name)) {
                const {
            ...
            if (!at(s)) {
                const {
                    message: i
                } = R("MISSING_OR_INVALID", `disconnect() params: ${s}`);
                throw new Error(i)
            }
            const {
                topic: r
            ...
            if (!Oe(i, !1)) throw new Error("uri is required parameter");
            if (!Oe(n, !1)) throw new Error("domain is required parameter");
            if (!Oe(o, !1)) throw new Error("nonce is required parameter");
            if ([...new Set(r.map(c => Cr(c).namespace))].length > 1) throw new Error("Multi-namespace requests are not supported. Please request single namespace only.");
            const {
                namespace: a
            } = Cr(r[0]);
            ...
            Object.values(s).forEach((i, n) => {
                if (i == null) {
                    const {
                        message: o
                    } = R("MISSING_OR_INVALID", `${r} must contain an existing value for each key. Received: ${i} for key ${Object.keys(s)[n]}`);
                    throw new Error(o)
                }
            })
            ...
            var s;
            if (Go() || As() && (s = this.client.metadata.redirect) != null && s.linkMode) {
            ...
            return Object.keys(Qc).includes(i.method)
            ...
            try {
                ...
                const n = r[i.key];
                if (Es(n)) return s === "solana_signAllTransactions" ? n.map(o => Of(o)) : n;
    ...
    async onRelayMessage(e) {
        const {
            ...
            publicKey: o
        } = this.client.auth.authKeys.keys.includes(en) ? this.client.auth.authKeys.get(en) : {
            publicKey: void 0
        };
        try {
            const a = await this.client.core.crypto.decode(s, r, {
                receiverPublicKey: o,
                encoding: n === Ne.link_mode ? gs : Ut
            });
            zo(a) ? (this.client.core.history.set(s, a), await this.onRelayEventRequest({
                topic: s,
                payload: a,
                attestation: i,
                transportType: n,
                encryptedId: zt(r)
            })) : Ho(a) ? (await this.client.core.history.resolve(a), await this.onRelayEventResponse({
                topic: s,
                payload: a,
                transportType: n
    ...
    registerExpirerEvents() {
        this.client.core.expirer.on(At.expired, async e => {
            ...
            if (r && this.client.pendingRequest.keys.includes(r)) return await this.deletePendingSessionRequest(r, R("EXPIRED"), !0);
            if (r && this.client.auth.requests.keys.includes(r)) return await this.deletePendingAuthRequest(r, R("EXPIRED"), !0);
    ...
    registerPairingEvents() {
        this.client.core.pairing.events.on(Us.create, e => this.onPairingCreated(e)), this.client.core.pairing.events.on(Us.delete, e => {
    ...
    isValidPairingTopic(e) {
        if (!Oe(e, !1)) {
            const {
                message: s
            } = R("MISSING_OR_INVALID", `pairing topic should be a string: ${e}`);
            throw new Error(s)
        }
        if (!this.client.core.pairing.pairings.keys.includes(e)) {
            const {
                message: s
            } = R("NO_MATCHING_KEY", `pairing topic doesn't exist: ${e}`);
            throw new Error(s)
        }
        if (fs(this.client.core.pairing.pairings.get(e).expiry)) {
            const {
                message: s
            } = R("EXPIRED", `pairing topic: ${e}`);
            throw new Error(s)
        }
    }
    async isValidSessionTopic(e) {
        if (!Oe(e, !1)) {
            const {
                message: s
            } = R("MISSING_OR_INVALID", `session topic should be a string: ${e}`);
            throw new Error(s)
        }
        if (this.checkRecentlyDeleted(e), !this.client.session.keys.includes(e)) {
            const {
                message: s
            } = R("NO_MATCHING_KEY", `session topic doesn't exist: ${e}`);
            throw new Error(s)
        }
        if (fs(this.client.session.get(e).expiry)) {
            ...
            const {
                message: s
            } = R("EXPIRED", `session topic: ${e}`);
            throw new Error(s)
        }
        if (!this.client.core.crypto.keychain.has(e)) {
            const {
                message: s
            } = R("MISSING_OR_INVALID", `session topic does not exist in keychain: ${e}`);
    ...
    async isValidSessionOrPairingTopic(e) {
        if (this.checkRecentlyDeleted(e), this.client.session.keys.includes(e)) await this.isValidSessionTopic(e);
            ...
            const {
                message: s
            } = R("NO_MATCHING_KEY", `session or pairing topic doesn't exist: ${e}`);
            throw new Error(s)
        } else {
            const {
                message: s
            } = R("MISSING_OR_INVALID", `session or pairing topic should be a string: ${e}`);
            throw new Error(s)
        }
    }
    async isValidProposalId(e) {
        if (!sw(e)) {
            const {
                message: s
            } = R("MISSING_OR_INVALID", `proposal id should be a number: ${e}`);
            throw new Error(s)
        }
        if (!this.client.proposal.keys.includes(e)) {
            const {
                message: s
            } = R("NO_MATCHING_KEY", `proposal id doesn't exist: ${e}`);
            throw new Error(s)
        }
...
class y0 extends Gs {
    constructor(e, s) {
        super(e, s, s0, sa), this.core = e, this.logger = s
    }
}
let b0 = class extends Gs {
    constructor(e, s) {
        super(e, s, r0, sa), this.core = e, this.logger = s
    }
};
class v0 extends Gs {
    constructor(e, s) {
        super(e, s, n0, sa, r => r.id), this.core = e, this.logger = s
    }
}
class E0 extends Gs {
    constructor(e, s) {
        super(e, s, l0, Nn, () => en), this.core = e, this.logger = s
    }
}
class C0 extends Gs {
    constructor(e, s) {
        super(e, s, u0, Nn), this.core = e, this.logger = s
    }
}
class I0 extends Gs {
    constructor(e, s) {
        super(e, s, d0, Nn, r => r.id), this.core = e, this.logger = s
    }
}
var N0 = Object.defineProperty,
    A0 = (t, e, s) => e in t ? N0(t, e, {
        enumerable: !0,
        configurable: !0,
        writable: !0,
        value: s
    }) : t[e] = s,
    Qn = (t, e, s) => A0(t, typeof e != "symbol" ? e + "" : e, s);
class _0 {
    constructor(e, s) {
        this.core = e, this.logger = s, Qn(this, "authKeys"), Qn(this, "pairingTopics"), Qn(this, "requests"), this.authKeys = new E0(this.core, this.logger), this.pairingTopics = new C0(this.core, this.logger), this.requests = new I0(this.core, this.logger)
    }
    async init() {
...
var S0 = Object.defineProperty,
    P0 = (t, e, s) => e in t ? S0(t, e, {
        enumerable: !0,
        configurable: !0,
        writable: !0,
        value: s
    }) : t[e] = s,
    ne = (t, e, s) => P0(t, typeof e != "symbol" ? e + "" : e, s);
let k0 = class rd extends qh {
    constructor(e) {
        super(e), ne(this, "protocol", ed), ne(this, "version", td), ne(this, "name", Xn.name), ne(this, "metadata"), ne(this, "core"), ne(this, "logger"), ne(this, "events", new Ks.EventEmitter), ne(this, "engine"), ne(this, "session"), ne(this, "proposal"), ne(this, "pendingRequest"), ne(this, "auth"), ne(this, "signConfig"), ne(this, "on", (r, i) => this.events.on(r, i)), ne(this, "once", (r, i) => this.events.once(r, i)), ne(this, "off", (r, i) => this.events.off(r, i)), ne(this, "removeListener", (r, i) => this.events.removeListener(r, i)), ne(this, "removeAllListeners", r => this.events.removeAllListeners(r)), ne(this, "connect", async r => {
            try {
        ...
        }), this.name = e ? .name || Xn.name, this.metadata = Wp(e ? .metadata), this.signConfig = e ? .signConfig;
        const s = typeof e ? .logger < "u" && typeof e ? .logger != "string" ? e.logger : Wo(Ai({
            level: e ? .logger || Xn.logger
        }));
        this.core = e ? .core || new t0(e), this.logger = tt(s, this.name), this.session = new b0(this.core, this.logger), this.proposal = new y0(this.core, this.logger), this.pendingRequest = new v0(this.core, this.logger), this.engine = new w0(this), this.auth = new _0(this.core, this.logger)
    }
    static async init(e) {
        const s = new rd(e);
...
const tl = "error",
    T0 = "wss://relay.walletconnect.org",
    O0 = "wc",
    $0 = "universal_provider",
    Hi = `${O0}@2:${$0}:`,
    id = "https://rpc.walletconnect.org/v1/",
    gr = "generic",
    x0 = `${id}bundler`,
    Pt = {
...
function U0(t) {
    if (ra(t)) return t;
    if (Array.isArray(t) || ia(t) || t instanceof ArrayBuffer || typeof SharedArrayBuffer < "u" && t instanceof SharedArrayBuffer) return t.slice(0);
    const e = Object.getPrototypeOf(t),
        s = e.constructor;
...
const D0 = "[object RegExp]",
    ...
    G0 = "[object Uint32Array]",
    J0 = "[object Int8Array]",
    Y0 = "[object Int16Array]",
    X0 = "[object Int32Array]",
    Z0 = "[object Float32Array]",
    Q0 = "[object Float64Array]";

function eE(t, e) {
    return Er(t, void 0, t, new Map, e)
}

function Er(t, e, s, r = new Map, i = void 0) {
    const n = i ? .(t, e, s, r);
    if (n != null) return n;
    if (ra(t)) return t;
    ...
    if (Array.isArray(t)) {
        ...
        r.set(t, o);
        for (let a = 0; a < t.length; a++) o[a] = Er(t[a], a, s, r, i);
    ...
    if (t instanceof Map) {
        const o = new Map;
        r.set(t, o);
        for (const [a, c] of t) o.set(a, Er(c, a, s, r, i));
        return o
    }
    if (t instanceof Set) {
        const o = new Set;
        r.set(t, o);
        for (const a of t) o.add(Er(a, void 0, s, r, i));
        return o
    }
    ...
    if (t instanceof DataView) {
        ...
        return r.set(t, o), Ds(o, t, s, r, i), o
    }
    ...
    if (t instanceof Error) {
        ...
        return r.set(t, o), o.message = t.message, o.name = t.name, o.stack = t.stack, o.cause = t.cause, Ds(o, t, s, r, i), o
    }
    if (typeof t == "object" && tE(t)) {
...
function Ds(t, e, s = t, r, i) {
    const n = [...Object.keys(e), ...nd(e)];
    for (let o = 0; o < n.length; o++) {
        const a = n[o],
            c = Object.getOwnPropertyDescriptor(t, a);
        (c == null || c.writable) && (t[a] = Er(e[a], a, s, r, i))
    }
}
...
function il(t) {
    return t !== null && typeof t == "object" && od(t) === "[object Arguments]"
}
...
function Mo(t, e, s, r) {
    if (ra(t) && (t = Object(t)), e == null || typeof e != "object") return t;
    if (r.has(e)) return U0(r.get(e));
    if (r.set(e, t), Array.isArray(e)) {
        e = e.slice();
        for (let n = 0; n < e.length; n++) e[n] = e[n] ? ? void 0
    }
    const i = [...Object.keys(e), ...nd(e)];
    for (let n = 0; n < i.length; n++) {
        ...
        if (il(a) && (a = { ...a
            ...
            }), typeof Buffer < "u" && Buffer.isBuffer(a) && (a = rl(a)), Array.isArray(a))
        ...
        l != null ? t[o] = l : Array.isArray(a) || sl(c) && sl(a) ? t[o] = Mo(c, a, s, r) : c == null && iE(a) ? t[o] = Mo({}, a, s, r) : c == null && rE(a) ? t[o] = rl(a) : (c === void 0 || a !== void 0) && (t[o] = a)
    }
    return t
}
...
var aE = Object.defineProperty,
    ...
    Vi = (t, e) => {
        for (var s in e || (e = {})) uE.call(e, s) && ol(t, s, e[s]);
        if (nl)
            for (var s of nl(e)) dE.call(e, s) && ol(t, s, e[s]);
        return t
    },
    hE = (t, e) => cE(t, lE(e));
...
function wt(t, e, s) {
    var r;
    const i = Cr(t);
    return ((r = e.rpcMap) == null ? void 0 : r[i.reference]) || `${id}?chainId=${i.namespace}:${i.reference}&projectId=${s}`
}
...
function al(t) {
    ...
    for (const [a, c] of Object.entries(t)) {
        const l = Cn(a) ? [a] : c.chains,
            u = c.methods || [],
            d = c.events || [],
            h = c.rpcMap || {},
            f = vr(a);
        o[f] = hE(Vi(Vi({}, o[f]), c), {
            chains: Ht(l, (e = o[f]) == null ? void 0 : e.chains),
            methods: Ht(u, (s = o[f]) == null ? void 0 : s.methods),
            events: Ht(d, (r = o[f]) == null ? void 0 : r.events)
        }), (Cs(h) || Cs(((i = o[f]) == null ? void 0 : i.rpcMap) || {})) && (o[f].rpcMap = Vi(Vi({}, h), (n = o[f]) == null ? void 0 : n.rpcMap))
    }
    return o
}
...
function ll(t) {
    ...
    for (const [s, r] of Object.entries(t)) {
        const i = r.methods || [],
            n = r.events || [],
            o = r.accounts || [],
            a = Cn(s) ? [s] : r.chains ? r.chains : dd(r.accounts);
        e[s] = {
            chains: a,
            methods: i,
            events: n,
...
var fE = Object.defineProperty,
    gE = (t, e, s) => e in t ? fE(t, e, {
        enumerable: !0,
        configurable: !0,
        writable: !0,
        value: s
    }) : t[e] = s,
    rr = (t, e, s) => gE(t, typeof e != "symbol" ? e + "" : e, s);
class mE {
    constructor(e) {
        rr(this, "name", "polkadot"), rr(this, "client"), rr(this, "httpProviders"), rr(this, "events"), rr(this, "namespace"), rr(this, "chainId"), this.namespace = e.namespace, this.events = ue("events"), this.client = ue("client"), this.chainId = this.getDefaultChain(), this.httpProviders = this.createHttpProviders()
    }
    updateNamespace(e) {
    ...
    setDefaultChain(e, s) {
        this.httpProviders[e] || this.setHttpProvider(e, s), this.chainId = e, this.events.emit(Pt.DEFAULT_CHAIN_CHANGED, `${this.name}:${e}`)
    }
    getAccounts() {
    ...
    createHttpProvider(e, s) {
        const r = s || wt(e, this.namespace, this.client.core.projectId);
        if (!r) throw new Error(`No RPC url provided for chainId: ${e}`);
        return new St(new Dt(r, ue("disableProviderPing")))
    }
}
var wE = Object.defineProperty,
    ...
    dl = (t, e) => {
        for (var s in e || (e = {})) vE.call(e, s) && Bo(t, s, e[s]);
        if (ul)
            for (var s of ul(e)) EE.call(e, s) && Bo(t, s, e[s]);
        return t
    },
    hl = (t, e) => yE(t, bE(e)),
    ir = (t, e, s) => Bo(t, typeof e != "symbol" ? e + "" : e, s);
class CE {
    constructor(e) {
        ir(this, "name", "eip155"), ir(this, "client"), ir(this, "chainId"), ir(this, "namespace"), ir(this, "httpProviders"), ir(this, "events"), this.namespace = e.namespace, this.events = ue("events"), this.client = ue("client"), this.httpProviders = this.createHttpProviders(), this.chainId = parseInt(this.getDefaultChain())
    }
    async request(e) {
    ...
    setDefaultChain(e, s) {
        this.httpProviders[e] || this.setHttpProvider(parseInt(e), s), this.chainId = parseInt(e), this.events.emit(Pt.DEFAULT_CHAIN_CHANGED, `${this.name}:${e}`)
    }
    requestAccounts() {
        return this.getAccounts()
    }
    ...
    createHttpProvider(e, s) {
        const r = s || wt(`${this.name}:${e}`, this.namespace, this.client.core.projectId);
        if (!r) throw new Error(`No RPC url provided for chainId: ${e}`);
        return new St(new Dt(r, ue("disableProviderPing")))
    }
    setHttpProvider(e, s) {
    ...
    async getCapabilities(e) {
        ...
        if (d != null && d[l]) return d ? .[l];
        const h = await this.client.request(e);
        try {
            await this.client.session.update(e.topic, {
                sessionProperties: hl(dl({}, u.sessionProperties || {}), {
                    capabilities: hl(dl({}, d || {}), {
                        [l]: h
                    })
                })
            })
    ...
    async getUserOperationReceipt(e, s) {
        ...
        const i = new URL(e),
            n = await fetch(i, {
                ...
                body: JSON.stringify(Ls("eth_getUserOperationReceipt", [(r = s.request.params) == null ? void 0 : r[0]]))
            });
        if (!n.ok) throw new Error(`Failed to fetch user operation receipt - ${n.status}`);
        return await n.json()
    }
    getBundlerUrl(e, s) {
        return `${x0}?projectId=${this.client.core.projectId}&chainId=${e}&bundler=${s}`
    }
}
var IE = Object.defineProperty,
    NE = (t, e, s) => e in t ? IE(t, e, {
        enumerable: !0,
        configurable: !0,
        writable: !0,
        value: s
    }) : t[e] = s,
    nr = (t, e, s) => NE(t, typeof e != "symbol" ? e + "" : e, s);
class AE {
    constructor(e) {
        nr(this, "name", "solana"), nr(this, "client"), nr(this, "httpProviders"), nr(this, "events"), nr(this, "namespace"), nr(this, "chainId"), this.namespace = e.namespace, this.events = ue("events"), this.client = ue("client"), this.chainId = this.getDefaultChain(), this.httpProviders = this.createHttpProviders()
    }
    updateNamespace(e) {
        this.namespace = Object.assign(this.namespace, e)
    }
...
var _E = Object.defineProperty,
    SE = (t, e, s) => e in t ? _E(t, e, {
        enumerable: !0,
        configurable: !0,
        writable: !0,
        value: s
    }) : t[e] = s,
    or = (t, e, s) => SE(t, typeof e != "symbol" ? e + "" : e, s);
class PE {
    constructor(e) {
        or(this, "name", "cosmos"), or(this, "client"), or(this, "httpProviders"), or(this, "events"), or(this, "namespace"), or(this, "chainId"), this.namespace = e.namespace, this.events = ue("events"), this.client = ue("client"), this.chainId = this.getDefaultChain(), this.httpProviders = this.createHttpProviders()
    }
    updateNamespace(e) {
        this.namespace = Object.assign(this.namespace, e)
    }
    ...
    setDefaultChain(e, s) {
        this.httpProviders[e] || this.setHttpProvider(e, s), this.chainId = e, this.events.emit(Pt.DEFAULT_CHAIN_CHANGED, `${this.name}:${this.chainId}`)
    }
    getAccounts() {
        const e = this.namespace.accounts;
        return e ? [...new Set(e.filter(s => s.split(":")[1] === this.chainId.toString()).map(s => s.split(":")[2]))] : []
...
var kE = Object.defineProperty,
    TE = (t, e, s) => e in t ? kE(t, e, {
        enumerable: !0,
        configurable: !0,
        writable: !0,
        value: s
    }) : t[e] = s,
    ar = (t, e, s) => TE(t, typeof e != "symbol" ? e + "" : e, s);
class OE {
    constructor(e) {
        ar(this, "name", "algorand"), ar(this, "client"), ar(this, "httpProviders"), ar(this, "events"), ar(this, "namespace"), ar(this, "chainId"), this.namespace = e.namespace, this.events = ue("events"), this.client = ue("client"), this.chainId = this.getDefaultChain(), this.httpProviders = this.createHttpProviders()
    }
    updateNamespace(e) {
        this.namespace = Object.assign(this.namespace, e)
    }
    ...
    setDefaultChain(e, s) {
        ...
        this.chainId = e, this.events.emit(Pt.DEFAULT_CHAIN_CHANGED, `${this.name}:${this.chainId}`)
    }
    getDefaultChain() {
        if (this.chainId) return this.chainId;
        if (this.namespace.defaultChain) return this.namespace.defaultChain;
    ...
    createHttpProvider(e, s) {
        const r = s || wt(e, this.namespace, this.client.core.projectId);
        return typeof r > "u" ? void 0 : new St(new Dt(r, ue("disableProviderPing")))
    }
}
var $E = Object.defineProperty,
    xE = (t, e, s) => e in t ? $E(t, e, {
        enumerable: !0,
        configurable: !0,
        writable: !0,
        value: s
    }) : t[e] = s,
    cr = (t, e, s) => xE(t, typeof e != "symbol" ? e + "" : e, s);
class RE {
    constructor(e) {
...
var UE = Object.defineProperty,
    DE = (t, e, s) => e in t ? UE(t, e, {
        enumerable: !0,
        configurable: !0,
        writable: !0,
        value: s
    }) : t[e] = s,
    lr = (t, e, s) => DE(t, typeof e != "symbol" ? e + "" : e, s);
class LE {
    constructor(e) {
        lr(this, "name", "elrond"), lr(this, "client"), lr(this, "httpProviders"), lr(this, "events"), lr(this, "namespace"), lr(this, "chainId"), this.namespace = e.namespace, this.events = ue("events"), this.client = ue("client"), this.chainId = this.getDefaultChain(), this.httpProviders = this.createHttpProviders()
    }
    updateNamespace(e) {
        this.namespace = Object.assign(this.namespace, e)
    }
...
var ME = Object.defineProperty,
    BE = (t, e, s) => e in t ? ME(t, e, {
        enumerable: !0,
        configurable: !0,
        writable: !0,
        value: s
    }) : t[e] = s,
    ur = (t, e, s) => BE(t, typeof e != "symbol" ? e + "" : e, s);
class jE {
    constructor(e) {
        ur(this, "name", "multiversx"), ur(this, "client"), ur(this, "httpProviders"), ur(this, "events"), ur(this, "namespace"), ur(this, "chainId"), this.namespace = e.namespace, this.events = ue("events"), this.client = ue("client"), this.chainId = this.getDefaultChain(), this.httpProviders = this.createHttpProviders()
    }
    updateNamespace(e) {
        this.namespace = Object.assign(this.namespace, e)
    }
...
var qE = Object.defineProperty,
    FE = (t, e, s) => e in t ? qE(t, e, {
        enumerable: !0,
        configurable: !0,
        writable: !0,
        value: s
    }) : t[e] = s,
    dr = (t, e, s) => FE(t, typeof e != "symbol" ? e + "" : e, s);
class WE {
    constructor(e) {
        dr(this, "name", "near"), dr(this, "client"), dr(this, "httpProviders"), dr(this, "events"), dr(this, "namespace"), dr(this, "chainId"), this.namespace = e.namespace, this.events = ue("events"), this.client = ue("client"), this.chainId = this.getDefaultChain(), this.httpProviders = this.createHttpProviders()
    }
    updateNamespace(e) {
        this.namespace = Object.assign(this.namespace, e)
    }
    ...
    setDefaultChain(e, s) {
        if (this.chainId = e, !this.httpProviders[e]) {
            const r = s || wt(`${this.name}:${e}`, this.namespace);
            if (!r) throw new Error(`No RPC url provided for chainId: ${e}`);
            this.setHttpProvider(e, r)
        }
    ...
    createHttpProvider(e, s) {
        const r = s || wt(e, this.namespace);
        return typeof r > "u" ? void 0 : new St(new Dt(r, ue("disableProviderPing")))
    }
}
var zE = Object.defineProperty,
    HE = (t, e, s) => e in t ? zE(t, e, {
        enumerable: !0,
        configurable: !0,
        writable: !0,
        value: s
    }) : t[e] = s,
    hr = (t, e, s) => HE(t, typeof e != "symbol" ? e + "" : e, s);
class VE {
    constructor(e) {
        hr(this, "name", "tezos"), hr(this, "client"), hr(this, "httpProviders"), hr(this, "events"), hr(this, "namespace"), hr(this, "chainId"), this.namespace = e.namespace, this.events = ue("events"), this.client = ue("client"), this.chainId = this.getDefaultChain(), this.httpProviders = this.createHttpProviders()
    }
    updateNamespace(e) {
        this.namespace = Object.assign(this.namespace, e)
    }
    ...
    createHttpProvider(e, s) {
        const r = s || wt(e, this.namespace);
        return typeof r > "u" ? void 0 : new St(new Dt(r))
    }
}
var KE = Object.defineProperty,
    GE = (t, e, s) => e in t ? KE(t, e, {
        enumerable: !0,
        configurable: !0,
        writable: !0,
        value: s
    }) : t[e] = s,
    pr = (t, e, s) => GE(t, typeof e != "symbol" ? e + "" : e, s);
class JE {
    constructor(e) {
        pr(this, "name", gr), pr(this, "client"), pr(this, "httpProviders"), pr(this, "events"), pr(this, "namespace"), pr(this, "chainId"), this.namespace = e.namespace, this.events = ue("events"), this.client = ue("client"), this.chainId = this.getDefaultChain(), this.httpProviders = this.createHttpProviders()
    }
    updateNamespace(e) {
...
var YE = Object.defineProperty,
    ...
    Gi = (t, e) => {
        for (var s in e || (e = {})) QE.call(e, s) && jo(t, s, e[s]);
        if (pl)
            for (var s of pl(e)) eC.call(e, s) && jo(t, s, e[s]);
        return t
    },
    so = (t, e) => XE(t, ZE(e)),
    It = (t, e, s) => jo(t, typeof e != "symbol" ? e + "" : e, s);
let tC = class pd {
    constructor(e) {
        It(this, "client"), It(this, "namespaces"), It(this, "optionalNamespaces"), It(this, "sessionProperties"), It(this, "scopedProperties"), It(this, "events", new Vo), It(this, "rpcProviders", {}), It(this, "session"), It(this, "providerOpts"), It(this, "logger"), It(this, "uri"), It(this, "disableProviderPing", !1), this.providerOpts = e, this.logger = typeof e ? .logger < "u" && typeof e ? .logger != "string" ? e.logger : Wo(Ai({
            level: e ? .logger || tl
    ...
    sendAsync(e, s, r, i) {
        ...
        this.request(e, r, i).then(o => s(null, gn(n, o))).catch(o => s(o, void 0))
    }
    async enable() {
    ...
    async authenticate(e, s) {
        ...
        const {
            uri: r,
            response: i
        } = await this.client.authenticate(e, s);
        r && (this.uri = r, this.events.emit("display_uri", r));
        const n = await i();
        if (this.session = n.session, this.session) {
            const o = ll(this.session.namespaces);
            this.namespaces = Ki(this.namespaces, o), await this.persist("namespaces", this.namespaces), this.onConnect()
        }
        return n
    }
    on(e, s) {
    ...
    async pair(e) {
        ...
        const i = await r();
        this.session = i;
        const n = ll(i.namespaces);
        return this.namespaces = Ki(this.namespaces, n), await this.persist("namespaces", this.namespaces), await this.persist("optionalNamespaces", this.optionalNamespaces), this.onConnect(), this.session
    }
    setDefaultChain(e, s) {
        try {
            if (!this.session) return;
            const [r, i] = this.validateChain(e), n = this.getProvider(r);
            n.name === gr ? n.setDefaultChain(`${r}:${i}`, s) : n.setDefaultChain(i, s)
        } catch (r) {
    ...
    async createClient() {
        var e, s;
        if (this.client = this.providerOpts.client || await k0.init({
                core: this.providerOpts.core,
                logger: this.providerOpts.logger || tl,
                relayUrl: this.providerOpts.relayUrl || T0,
    ...
    createProviders() {
        ...
        const e = [...new Set(Object.keys(this.session.namespaces).map(s => vr(s)))];
        to("client", this.client), to("events", this.events), to("disableProviderPing", this.disableProviderPing), e.forEach(s => {
            if (!this.session) return;
            const r = pE(s, this.session),
                i = dd(r),
                n = Ki(this.namespaces, this.optionalNamespaces),
                o = so(Gi({}, n[s]), {
                    accounts: r,
                    chains: i
                });
            switch (s) {
                case "eip155":
                    this.rpcProviders[s] = new CE({
                        namespace: o
                    });
                    break;
                case "algorand":
                    this.rpcProviders[s] = new OE({
                        namespace: o
                    });
                    break;
                case "solana":
                    this.rpcProviders[s] = new AE({
                        namespace: o
                    });
                    break;
                case "cosmos":
                    this.rpcProviders[s] = new PE({
                        namespace: o
                    });
                    break;
                case "polkadot":
                    this.rpcProviders[s] = new mE({
                        namespace: o
                    });
                    break;
                case "cip34":
                    this.rpcProviders[s] = new RE({
                        namespace: o
                    });
                    break;
                case "elrond":
                    this.rpcProviders[s] = new LE({
                        namespace: o
                    });
                    break;
                case "multiversx":
                    this.rpcProviders[s] = new jE({
                        namespace: o
                    });
                    break;
                case "near":
                    this.rpcProviders[s] = new WE({
                        namespace: o
                    });
                    break;
                case "tezos":
                    this.rpcProviders[s] = new VE({
                        namespace: o
                    });
                    break;
                default:
                    this.rpcProviders[gr] ? this.rpcProviders[gr].updateNamespace(o) : this.rpcProviders[gr] = new JE({
                        namespace: o
                    })
            }
        })
    ...
    registerEventListeners() {
        ...
        this.client.on("session_ping", e => {
            ...
            if (n.name === "accountsChanged") {
                const o = n.data;
                o && Es(o) && this.events.emit("accountsChanged", o.map(cl))
            ...
            const {
                namespaces: n
            } = s, o = (i = this.client) == null ? void 0 : i.session.get(e);
            this.session = so(Gi({}, o), {
                namespaces: n
            ...
            var s;
            e.topic === ((s = this.session) == null ? void 0 : s.topic) && (await this.cleanup(), this.events.emit("session_delete", e), this.events.emit("disconnect", so(Gi({}, me("USER_DISCONNECTED")), {
                data: e.topic
            })))
    ...
    getProvider(e) {
        return this.rpcProviders[e] || this.rpcProviders[gr]
    }
    onSessionUpdate() {
    ...
    setNamespaces(e) {
        ...
        this.optionalNamespaces = Ki(s, r), this.sessionProperties = i, this.scopedProperties = n
    }
    validateChain(e) {
        const [s, r] = e ? .split(":") || ["", ""];
        if (!this.namespaces || !Object.keys(this.namespaces).length) return [s, r];
        if (s && !Object.keys(this.namespaces || {}).map(o => vr(o)).includes(s)) throw new Error(`Namespace '${s}' is not configured. Please call connect() first with namespace config.`);
        if (s && r) return [s, r];
        const i = vr(Object.keys(this.namespaces)[0]),
    ...
    async onChainChanged(e, s = !1) {
        ...
        s || this.getProvider(r).setDefaultChain(i), this.emitAccountsChangedOnChainChange({
            namespace: r,
            previousChainId: n,
            newChainId: e
    ...
    emitAccountsChangedOnChainChange({
        ...
        try {
            ...
            if (!o) return;
            const a = o.filter(c => c.includes(`${r}:`)).map(cl);
            if (!Es(a)) return;
    ...
    async persist(e, s) {
        ...
        await this.client.core.storage.setItem(`${Hi}/${e}${i}`, s)
    }
    async getFromStore(e) {
        var s;
        const r = ((s = this.session) == null ? void 0 : s.topic) || "";
        return await this.client.core.storage.getItem(`${Hi}/${e}${r}`)
    }
    async deleteFromStore(e) {
        var s;
        const r = ((s = this.session) == null ? void 0 : s.topic) || "";
        await this.client.core.storage.removeItem(`${Hi}/${e}${r}`)
    }
    async cleanupStorage() {
        ...
        try {
            ...
            for (const r of s) r.startsWith(Hi) && await this.client.core.storage.removeItem(r)
        } catch (s) {
...
const hi = {
    ...
    async initializeIfEnabled() {
        ...
        if (!(t && e)) return;
        const [s, r, i] = e.split(":");
        if (p.checkIfSupportedNetwork(s)) try {
            if ((await t.getSessions(`${s}:${r}`, i)).length) return;
            await Fe.open({
                view: "SIWXSignMessage"
            })
        } catch (n) {
            console.error("SIWXUtil:initializeIfEnabled", n), Se.sendEvent({
                type: "track",
                event: "SIWX_AUTH_ERROR",
                properties: this.getSIWXEventProperties()
            }), await Y._getClient() ? .disconnect().catch(console.error), re.reset("Connect"), Rt.showError("A problem occurred while trying initialize authentication")
        }
    },
    async requestSignMessage() {
        const t = S.state.siwx,
            e = X.getPlainAddress(p.getActiveCaipAddress()),
        ...
        try {
            const i = await t.createMessage({
                ...
                n = i.toString();
            j.getConnectorId(s.chainNamespace) === z.CONNECTOR_ID.AUTH && re.pushTransactionStack({});
            const a = await r.signMessage(n);
            await t.addSession({
                data: i,
                message: n,
                signature: a
            }), Fe.close(), Se.sendEvent({
                type: "track",
            ...
            (!Fe.state.open || re.state.view === "ApproveTransaction") && await Fe.open({
                view: "SIWXSignMessage"
    ...
    async cancelSignMessage() {
        try {
            this.getSIWX() ? .getRequired ? .() ? await Y.disconnect() : Fe.close(), re.reset("Connect"), Se.sendEvent({
    ...
    async isSIWXCloseDisabled() {
        ...
        if (t) {
            const e = re.state.view === "ApproveTransaction",
                s = re.state.view === "SIWXSignMessage";
    ...
    async universalProviderAuthenticate({
        ...
        const n = await r.createMessage({
                chainId: p.getActiveCaipNetwork() ? .caipNetworkId || "",
                accountAddress: ""
            }),
        ...
        if (Rt.showLoading("Authenticating...", {
                autoClose: !1
            }), W.setConnectedWalletInfo({ ...o.session.peer.metadata,
                name: o.session.peer.metadata.name,
                icon: o.session.peer.metadata.icons ? .[0],
                type: "WALLET_CONNECT"
            }, Array.from(i)[0]), o ? .auths ? .length) {
            ...
            try {
                await r.setSessions(a), Se.sendEvent({
                    type: "track",
                    event: "SIWX_AUTH_SUCCESS",
                    properties: hi.getSIWXEventProperties()
                })
            } catch (c) {
                throw console.error("SIWX:universalProviderAuth - failed to set sessions", c), Se.sendEvent({
                    type: "track",
                    event: "SIWX_AUTH_ERROR",
                    properties: hi.getSIWXEventProperties()
    ...
    getSIWXEventProperties() {
        ...
        return {
            network: p.state.activeCaipNetwork ? .caipNetworkId || "",
            isSmartAccount: W.state.preferredAccountTypes ? .[t] === ni.ACCOUNT_TYPES.SMART_ACCOUNT
        }
    },
    async clearSessions() {
        const t = this.getSIWX();
...
function sC(t) {
    ...
    let s = [];
    return t ? (s.push([t, p.state.chains.get(t)]), Ji(t, z.CONNECTOR_ID.WALLET_CONNECT) ? e.forEach(r => {
        r !== t && Ji(r, z.CONNECTOR_ID.WALLET_CONNECT) && s.push([r, p.state.chains.get(r)])
    }) : Ji(t, z.CONNECTOR_ID.AUTH) && e.forEach(r => {
        r !== t && Ji(r, z.CONNECTOR_ID.AUTH) && s.push([r, p.state.chains.get(r)])
...
const fr = {
    ...
    ALERT_ERRORS: {
        ...
        INVALID_APP_CONFIGURATION: {
            shortMessage: "Invalid App Configuration",
            longMessage: () => `Origin ${rC()?window.origin:"unknown"} not found on Allowlist - update configuration on cloud.reown.com`
        },
        IFRAME_LOAD_FAILED: {
...
const ro = ["near:mainnet", "solana:5eykt4UsFv8P8NJdTREpY1vzqKqZKvdp", "eip155:1101", "eip155:56", "eip155:42161", "eip155:7777777", "eip155:59144", "eip155:324", "solana:EtWTRABZaYq6iMfeYKouRu166VU2xqa1", "eip155:5000", "solana:4sgjmw1sunhzsxgspuhpqldx6wiyjntz", "eip155:80084", "eip155:5003", "eip155:100", "eip155:8453", "eip155:42220", "eip155:1313161555", "eip155:17000", "eip155:1", "eip155:300", "eip155:1313161554", "eip155:1329", "eip155:84532", "eip155:421614", "eip155:11155111", "eip155:8217", "eip155:43114", "solana:4uhcVJyU9pJkvQyS88uRDiswHXSCkY3z", "eip155:999999999", "eip155:11155420", "eip155:80002", "eip155:97", "eip155:43113", "eip155:137", "eip155:10", "eip155:1301", "bip122:000000000019d6689c085ae165831e93", "bip122:000000000933ea01ad0ee984209779ba"],
    mr = {
        ...
        extendCaipNetwork(t, {
            ...
            const i = this.getChainNamespace(t),
                ...
                u = [...l, a],
                d = [...l];
            return c && !d.includes(c) && d.push(c), { ...t,
                chainNamespace: i,
                caipNetworkId: n,
                assets: {
                    imageId: hn.NetworkImageIds[t.id],
                    imageUrl: e ? .[t.id]
                },
                rpcUrls: { ...t.rpcUrls,
                    default: {
        ...
        extendCaipNetworks(t, {
            ...
            return t.map(i => mr.extendCaipNetwork(i, {
                customNetworkImageUrls: e,
                customRpcUrls: r,
                projectId: s
            }))
        ...
        getViemTransport(t, e, s) {
            const r = [];
            return s ? .forEach(i => {
                r.push(Li(i.url, i.config))
            }), ro.includes(t.caipNetworkId) && r.push(Li(fl(t.caipNetworkId, e), {
                fetchOptions: {
                    headers: {
        ...
        getCaipNetworkFromStorage(t) {
            const e = F.getActiveCaipNetworkId(),
                ...
                r = Array.from(p.state.chains ? .keys() || []),
                i = e ? .split(":")[0],
                n = i ? r.includes(i) : !1,
    ...
    _e = {
        ...
        subscribeProviders(t) {
            return Xe(ot.providers, () => t(ot.providers))
        },
        setProvider(t, e) {
            e && (ot.providers[t] = qs(e))
        },
        getProvider(t) {
            return ot.providers[t]
        },
        setProviderId(t, e) {
            e && (ot.providerIds[t] = e)
        },
        getProviderId(t) {
            if (t) return ot.providerIds[t]
        },
        reset() {
            ot.providers = { ...pn
            }, ot.providerIds = { ...pn
        ...
        resetChain(t) {
            ot.providers[t] = void 0, ot.providerIds[t] = void 0
        }
    },
    oC = {
        VIEW_DIRECTION: {
    ...
    qo = {
        filterOutDuplicatesByRDNS(t) {
            const e = S.state.enableEIP6963 ? j.state.connectors : [],
        ...
        filterOutDuplicatesByIds(t) {
            const e = j.state.connectors.filter(a => a.type === "ANNOUNCED" || a.type === "INJECTED"),
                s = F.getRecentWallets(),
        ...
        markWalletsAsInstalled(t) {
            const {
                ...
                featuredWalletIds: s
            } = S.state, r = e.filter(o => o.type === "ANNOUNCED").reduce((o, a) => (a.info ? .rdns && (o[a.info.rdns] = !0), o), {});
            return t.map(o => ({ ...o,
        ...
        getConnectOrderMethod(t, e) {
            const s = t ? .connectMethodsOrder || S.state.features ? .connectMethodsOrder,
                r = e || j.state.connectors;
            if (s) return s;
            const {
                injected: i,
                announced: n
            } = tn.getConnectorsByType(r, V.state.recommended, V.state.featured), o = i.filter(tn.showConnector), a = n.filter(tn.showConnector);
            return o.length || a.length ? ["wallet", "email", "social"] : oC.DEFAULT_CONNECT_METHOD_ORDER
        },
        isExcluded(t) {
            const e = !!t.rdns && V.state.excludedWallets.some(r => r.rdns === t.rdns),
                s = !!t.name && V.state.excludedWallets.some(r => na.isLowerCaseMatch(r.name, t.name));
            return e || s
        }
    },
    tn = {
        getConnectorsByType(t, e, s) {
            const {
                customWallets: r
            } = S.state, i = F.getRecentWallets(), n = qo.filterOutDuplicateWallets(e), o = qo.filterOutDuplicateWallets(s), a = t.filter(d => d.type === "MULTI_CHAIN"), c = t.filter(d => d.type === "ANNOUNCED"), l = t.filter(d => d.type === "INJECTED"), u = t.filter(d => d.type === "EXTERNAL");
            return {
                custom: r,
                recent: i,
                external: u,
        ...
        showConnector(t) {
            const e = t.info ? .rdns,
                ...
                r = !!t.name && V.state.excludedWallets.some(i => na.isLowerCaseMatch(i.name, t.name));
        ...
        getIsConnectedWithWC() {
            return Array.from(p.state.chains.values()).some(s => j.getConnectorId(s.namespace) === z.CONNECTOR_ID.WALLET_CONNECT)
        },
        getConnectorTypeOrder({
            ...
            multiChain: o,
            external: a,
            overriddenConnectors: c = S.state.features ? .connectorTypeOrder ? ? []
        }) {
            const l = tn.getIsConnectedWithWC(),
                h = [{
                    type: "walletConnect",
            ...
            return Array.from(new Set([...m, ...w].map(({
                type: g
            }) => g)))
        }
    };
const sn = globalThis,
    oa = sn.ShadowRoot && (sn.ShadyCSS === void 0 || sn.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype,
    aa = Symbol(),
    gl = new WeakMap;
let fd = class {
    constructor(e, s, r) {
        if (this._$cssResult$ = !0, r !== aa) throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");
    ...
    get styleSheet() {
        ...
        if (oa && e === void 0) {
            ...
            r && (e = gl.get(s)), e === void 0 && ((this.o = e = new CSSStyleSheet).replaceSync(this.cssText), r && gl.set(s, e))
        }
        return e
    }
    toString() {
...
const Nt = t => new fd(typeof t == "string" ? t : t + "", void 0, aa),
    Ir = (t, ...e) => {
        ...
        return new fd(s, t, aa)
    },
    aC = (t, e) => {
        if (oa) t.adoptedStyleSheets = e.map(s => s instanceof CSSStyleSheet ? s : s.styleSheet);
        else
            for (const s of e) {
    ...
    ml = oa ? t => t : t => t instanceof CSSStyleSheet ? (e => {
        let s = "";
...
const {
    ...
    getOwnPropertyNames: dC,
    getOwnPropertySymbols: hC,
    getPrototypeOf: pC
} = Object, An = globalThis, wl = An.trustedTypes, fC = wl ? wl.emptyScript : "", gC = An.reactiveElementPolyfillSupport, pi = (t, e) => t, Fo = {
    toAttribute(t, e) {
        switch (e) {
            case Boolean:
                t = t ? fC : null;
...
Symbol.metadata ? ? = Symbol("metadata"), An.litPropertyMetadata ? ? = new WeakMap;
let wr = class extends HTMLElement {
    ...
    static finalize() {
        ...
        if (e !== null) {
            ...
            if (s !== void 0)
                for (const [r, i] of s) this.elementProperties.set(r, i)
        }
        this._$Eh = new Map;
    ...
    static finalizeStyles(e) {
        ...
        if (Array.isArray(e)) {
            ...
            for (const i of r) s.unshift(ml(i))
        } else e !== void 0 && s.push(ml(e));
        return s
    }
    static _$Eu(e, s) {
        const r = s.attribute;
    ...
    _$ET(e, s) {
        ...
        if (i !== void 0 && r.reflect === !0) {
            const n = (r.converter ? .toAttribute !== void 0 ? r.converter : Fo).toAttribute(s, r.type);
    ...
    _$AK(e, s) {
        ...
        if (i !== void 0 && this._$Em !== i) {
            const n = r.getPropertyOptions(i),
                ...
                } : n.converter ? .fromAttribute !== void 0 ? n.converter : Fo;
            this._$Em = i;
    ...
    requestUpdate(e, s, r, i = !1, n) {
        if (e !== void 0) {
            ...
            if (i === !1 && (n = this[e]), r ? ? = o.getPropertyOptions(e), !((r.hasChanged ? ? gd)(n, s) || r.useDefault && r.reflect && n === this._$Ej ? .get(e) && !this.hasAttribute(o._$Eu(e, r)))) return;
            this.C(e, s, r)
        }
    ...
    C(e, s, {
        ...
        r && !(this._$Ej ? ? = new Map).has(e) && (this._$Ej.set(e, o ? ? s ? ? this[e]), n !== !0 || o !== void 0) || (this._$AL.has(e) || (this.hasUpdated || r || (s = void 0), this._$AL.set(e, s)), i === !0 && this._$Em !== e && (this._$Eq ? ? = new Set).add(e))
    }
    async _$EP() {
...
wr.elementStyles = [], wr.shadowRootOptions = {
    mode: "open"
}, wr[pi("elementProperties")] = new Map, wr[pi("finalized")] = new Map, gC ? .({
    ReactiveElement: wr
}), (An.reactiveElementVersions ? ? = []).push("2.1.2");
const ca = globalThis,
    bl = t => t,
    fn = ca.trustedTypes,
    vl = fn ? fn.createPolicy("lit-html", {
        createHTML: t => t
    }) : void 0,
    md = "$lit$",
    ...
    Vs = document,
    Ci = () => Vs.createComment(""),
    Ii = t => t === null || typeof t != "object" && typeof t != "function",
    la = Array.isArray,
    wC = t => la(t) || typeof t ? .[Symbol.iterator] == "function",
    io = `[ 	
\f\r]`,
    Zr = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,
    El = /-->/g,
    Cl = />/g,
    Ts = RegExp(`>|${io}(?:([^\\s"'>=/]+)(${io}*=${io}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"),
    Il = /'/g,
    Nl = /"/g,
    yd = /^(?:script|style|textarea|title)$/i,
    bd = t => (e, ...s) => ({
        _$litType$: t,
        strings: e,
        values: s
...
const yC = (t, e) => {
    ...
    for (let a = 0; a < s; a++) {
        ...
        let l, u, d = -1,
            h = 0;
        for (; h < c.length && (o.lastIndex = h, u = o.exec(c), u !== null);) h = o.lastIndex, o === Zr ? u[1] === "!--" ? o = El : u[1] !== void 0 ? o = Cl : u[2] !== void 0 ? (yd.test(u[2]) && (i = RegExp("</" + u[2], "g")), o = Ts) : u[3] !== void 0 && (o = Ts) : o === Ts ? u[0] === ">" ? (o = i ? ? Zr, d = -1) : u[1] === void 0 ? d = -2 : (d = o.lastIndex - u[2].length, l = u[1], o = u[3] === void 0 ? Ts : u[3] === '"' ? Nl : Il) : o === Nl || o === Il ? o = Ts : o === El || o === Cl ? o = Zr : (o = Ts, i = void 0);
        const f = o === Ts && t[a + 1].startsWith("/>") ? " " : "";
        n += o === Zr ? c + mC : d >= 0 ? (r.push(l), c.slice(0, d) + md + c.slice(d) + ms + f) : c + ms + (d === -2 ? a : f)
    }
    return [vd(t, n + (t[s] || "<?>") + (e === 2 ? "</svg>" : e === 3 ? "</math>" : "")), r]
};
class Ni {
    constructor({
        strings: e,
        ...
        const a = e.length - 1,
            c = this.parts,
            [l, u] = yC(e, s);
        if (this.el = Ni.createElement(l, r), Bs.currentNode = this.el.content, s === 2 || s === 3) {
            const d = this.el.content.firstChild;
            d.replaceWith(...d.childNodes)
        }
        for (;
            (i = Bs.nextNode()) !== null && c.length < a;) {
            if (i.nodeType === 1) {
                if (i.hasAttributes())
                    for (const d of i.getAttributeNames())
                        if (d.endsWith(md)) {
                            const h = u[o++],
                                f = i.getAttribute(d).split(ms),
                                m = /([.?@])?(.*)/.exec(h);
                            c.push({
                                type: 1,
                                index: n,
                                name: m[2],
                                strings: f,
                                ctor: m[1] === "." ? vC : m[1] === "?" ? EC : m[1] === "@" ? CC : _n
                            }), i.removeAttribute(d)
                        } else d.startsWith(ms) && (c.push({
                            type: 6,
                            index: n
                        }), i.removeAttribute(d));
                if (yd.test(i.tagName)) {
                    const d = i.textContent.split(ms),
                        h = d.length - 1;
                    if (h > 0) {
                        i.textContent = fn ? fn.emptyScript : "";
                        for (let f = 0; f < h; f++) i.append(d[f], Ci()), Bs.nextNode(), c.push({
                            type: 2,
                            index: ++n
                        });
                        i.append(d[h], Ci())
                ...
                if (i.data === wd) c.push({
                    ...
                    let d = -1;
                    for (;
                        (d = i.data.indexOf(ms, d + 1)) !== -1;) c.push({
                        type: 7,
                        index: n
                    }), d += ms.length - 1
                }
    ...
    static createElement(e, s) {
        const r = Vs.createElement("template");
        return r.innerHTML = e, r
    }
}

function Rr(t, e, s = t, r) {
    if (e === xr) return e;
    let i = r !== void 0 ? s._$Co ? .[r] : s._$Cl;
    const n = Ii(e) ? void 0 : e._$litDirective$;
    return i ? .constructor !== n && (i ? ._$AO ? .(!1), n === void 0 ? i = void 0 : (i = new n(t), i._$AT(t, s, r)), r !== void 0 ? (s._$Co ? ? = [])[r] = i : s._$Cl = i), i !== void 0 && (e = Rr(t, i._$AS(t, e.values), i, r)), e
}
class bC {
    constructor(e, s) {
    ...
    u(e) {
        const {
            ...
            parts: r
        } = this._$AD, i = (e ? .creationScope ? ? Vs).importNode(s, !0);
        Bs.currentNode = i;
        let n = Bs.nextNode(),
            o = 0,
            a = 0,
        ...
        for (; c !== void 0;) {
            if (o === c.index) {
                let l;
                c.type === 2 ? l = new Ri(n, n.nextSibling, this, e) : c.type === 1 ? l = new c.ctor(n, c.name, c.strings, this, e) : c.type === 6 && (l = new IC(n, this, e)), this._$AV.push(l), c = r[++a]
            }
            o !== c ? .index && (n = Bs.nextNode(), o++)
        }
        return Bs.currentNode = Vs, i
    }
    p(e) {
        let s = 0;
...
class Ri {
    ...
    constructor(e, s, r, i) {
        this.type = 2, this._$AH = qe, this._$AN = void 0, this._$AA = e, this._$AB = s, this._$AM = r, this.options = i, this._$Cv = i ? .isConnected ? ? !0
    }
    get parentNode() {
    ...
    _$AI(e, s = this) {
        e = Rr(this, e, s), Ii(e) ? e === qe || e == null || e === "" ? (this._$AH !== qe && this._$AR(), this._$AH = qe) : e !== this._$AH && e !== xr && this._(e) : e._$litType$ !== void 0 ? this.$(e) : e.nodeType !== void 0 ? this.T(e) : wC(e) ? this.k(e) : this._(e)
    }
    O(e) {
    ...
    _(e) {
        this._$AH !== qe && Ii(this._$AH) ? this._$AA.nextSibling.data = e : this.T(Vs.createTextNode(e)), this._$AH = e
    }
    $(e) {
        const {
            values: s,
            _$litType$: r
        } = e, i = typeof r == "number" ? this._$AC(e) : (r.el === void 0 && (r.el = Ni.createElement(vd(r.h, r.h[0]), this.options)), r);
        if (this._$AH ? ._$AD === i) this._$AH.p(s);
        else {
            const n = new bC(i, this),
                o = n.u(this.options);
            n.p(s), this.T(o), this._$AH = n
        }
    }
    _$AC(e) {
        let s = Al.get(e.strings);
        return s === void 0 && Al.set(e.strings, s = new Ni(e)), s
    }
    k(e) {
        la(this._$AH) || (this._$AH = [], this._$AR());
        const s = this._$AH;
        let r, i = 0;
        for (const n of e) i === s.length ? s.push(r = new Ri(this.O(Ci()), this.O(Ci()), this, this.options)) : r = s[i], r._$AI(n), i++;
        i < s.length && (this._$AR(r && r._$AB.nextSibling, i), s.length = i)
    }
    _$AR(e = this._$AA.nextSibling, s) {
        for (this._$AP ? .(!1, !0, s); e !== this._$AB;) {
            const r = bl(e).nextSibling;
            bl(e).remove(), e = r
        }
    }
    setConnected(e) {
...
class _n {
    ...
    constructor(e, s, r, i, n) {
        this.type = 1, this._$AH = qe, this._$AN = void 0, this.element = e, this.name = s, this._$AM = i, this.options = n, r.length > 2 || r[0] !== "" || r[1] !== "" ? (this._$AH = Array(r.length - 1).fill(new String), this.strings = r) : this._$AH = qe
    }
    _$AI(e, s = this, r, i) {
        const n = this.strings;
        let o = !1;
        if (n === void 0) e = Rr(this, e, s, 0), o = !Ii(e) || e !== this._$AH && e !== xr, o && (this._$AH = e);
        else {
            const a = e;
            let c, l;
            for (e = n[0], c = 0; c < n.length - 1; c++) l = Rr(this, a[r + c], s, c), l === xr && (l = this._$AH[c]), o || = !Ii(l) || l !== this._$AH[c], l === qe ? e = qe : e !== qe && (e += (l ? ? "") + n[c + 1]), this._$AH[c] = l
        }
        o && !i && this.j(e)
    }
    j(e) {
...
class CC extends _n {
    ...
    _$AI(e, s = this) {
        if ((e = Rr(this, e, s, 0) ? ? qe) === xr) return;
        const r = this._$AH,
            i = e === qe && r !== qe || e.capture !== r.capture || e.once !== r.once || e.passive !== r.passive,
            n = e !== qe && (r === qe || i);
...
const NC = ca.litHtmlPolyfillSupport;
NC ? .(Ni, Ri), (ca.litHtmlVersions ? ? = []).push("3.3.2");
const AC = (t, e, s) => {
    const r = s ? .renderBefore ? ? e;
    let i = r._$litPart$;
    if (i === void 0) {
        const n = s ? .renderBefore ? ? null;
        r._$litPart$ = i = new Ri(e.insertBefore(Ci(), n), n, void 0, s ? ? {})
    }
    return i._$AI(t), i
};
const ua = globalThis;
class rn extends wr {
    ...
    update(e) {
        const s = this.render();
        this.hasUpdated || (this.renderOptions.isConnected = this.isConnected), super.update(e), this._$Do = AC(s, this.renderRoot, this.renderOptions)
    }
    connectedCallback() {
...
rn._$litElement$ = !0, rn.finalized = !0, ua.litElementHydrateSupport ? .({
    LitElement: rn
});
const _C = ua.litElementPolyfillSupport;
_C ? .({
    LitElement: rn
});
(ua.litElementVersions ? ? = []).push("4.2.2");
let fi, Is, Ns;

function uI(t, e) {
    fi = document.createElement("style"), Is = document.createElement("style"), Ns = document.createElement("style"), fi.textContent = Nr(t).core.cssText, Is.textContent = Nr(t).dark.cssText, Ns.textContent = Nr(t).light.cssText, document.head.appendChild(fi), document.head.appendChild(Is), document.head.appendChild(Ns), Ed(e)
}

function Ed(t) {
    Is && Ns && (t === "light" ? (Is.removeAttribute("media"), Ns.media = "enabled") : (Ns.removeAttribute("media"), Is.media = "enabled"))
}

function SC(t) {
    fi && Is && Ns && (fi.textContent = Nr(t).core.cssText, Is.textContent = Nr(t).dark.cssText, Ns.textContent = Nr(t).light.cssText)
}
...
function Nr(t) {
    return {
      ...
      :root {
        ...
        --w3m-color-mix-strength: ${Nt(t?.["--w3m-color-mix-strength"]?`${t["--w3m-color-mix-strength"]}%`:"0%")};
        --w3m-font-family: ${Nt(t?.["--w3m-font-family"]||"Inter, Segoe UI, Roboto, Oxygen, Ubuntu, Cantarell, Fira Sans, Droid Sans, Helvetica Neue, sans-serif;")};
        --w3m-font-size-master: ${Nt(t?.["--w3m-font-size-master"]||"10px")};
        --w3m-border-radius-master: ${Nt(t?.["--w3m-border-radius-master"]||"4px")};
        --w3m-z-index: ${Nt(t?.["--w3m-z-index"]||999)};
    ...
    `,
        light: Ir `
      :root {
        --w3m-color-mix: ${Nt(t?.["--w3m-color-mix"]||"#fff")};
        --w3m-accent: ${Nt(ws(t,"dark")["--w3m-accent"])};
        --w3m-default: #fff;

        --wui-color-modal-bg-base: ${Nt(ws(t,"dark")["--w3m-background"])};
    ...
    `,
        dark: Ir `
      :root {
        --w3m-color-mix: ${Nt(t?.["--w3m-color-mix"]||"#000")};
        --w3m-accent: ${Nt(ws(t,"light")["--w3m-accent"])};
        --w3m-default: #000;

        --wui-color-modal-bg-base: ${Nt(ws(t,"light")["--w3m-background"])};
        --wui-color-accent-base-100: var(--w3m-accent);
        ...
        createNamespaces(t, e) {
            const s = t.reduce((r, i) => {
                const {
                    ...
                    chainNamespace: o,
                    rpcUrls: a
                } = i, c = a.default.http[0];
                r[o] || (r[o] = this.createDefaultNamespace(o));
                const l = `${o}:${n}`,
                    u = r[o];
                switch (u.chains.push(l), l) {
                    case _l.caipNetworkId:
                        u.chains.push(_l.deprecatedCaipNetworkId);
                        break;
                    case Sl.caipNetworkId:
                        u.chains.push(Sl.deprecatedCaipNetworkId);
                        break
                }
                return u ? .rpcMap && c && (u.rpcMap[n] = c), r
            }, {});
            return this.applyNamespaceOverrides(s, e)
        },
        resolveReownName: async t => {
            const e = await ai.resolveName(t);
...
class Cd {
    ...
    async authenticate() {
        ...
        return hi.universalProviderAuthenticate({
...
const kC = ["eth_accounts", "eth_requestAccounts", "eth_sendRawTransaction", "eth_sign", "eth_signTransaction", "eth_signTypedData", "eth_signTypedData_v3", "eth_signTypedData_v4", "eth_sendTransaction", "personal_sign", "wallet_switchEthereumChain", "wallet_addEthereumChain", "wallet_getPermissions", "wallet_requestPermissions", "wallet_registerOnboarding", "wallet_watchAsset", "wallet_scanQRCode", "wallet_getCallsStatus", "wallet_sendCalls", "wallet_getCapabilities", "wallet_grantPermissions", "wallet_revokePermissions", "wallet_getAssets"];
class TC {
    constructor(e) {
        this.availableConnectors = [], this.eventListeners = new Map, this.getCaipNetworks = s => p.getCaipNetworks(s), e && this.construct(e)
    }
    construct(e) {
    ...
    setAuthProvider(e) {
        this.addConnector({
            ...
            provider: e,
            imageId: hn.ConnectorImageIds[z.CONNECTOR_ID.AUTH],
    ...
    getWalletConnectConnector() {
        const e = this.connectors.find(s => s instanceof Cd);
...
class OC extends TC {
    ...
    async getAccounts({
        ...
        return Promise.resolve({
            accounts: r.map(i => X.createAccount(e, i, e === "bip122" ? "payment" : "eoa"))
        })
    }
    ...
    async getBalance(e) {
        if (!(e.caipNetwork && be.BALANCE_SUPPORTED_CHAINS.includes(e.caipNetwork ? .chainNamespace)) || e.caipNetwork ? .testnet) return {
            balance: "0.00",
            symbol: e.caipNetwork ? .nativeCurrency.symbol || ""
        };
        if (W.state.balanceLoading && e.chainId === p.state.activeCaipNetwork ? .id) return {
    ...
    async signMessage(e) {
        ...
        let n = "";
        return p.state.activeCaipNetwork ? .chainNamespace === z.CHAIN.SOLANA ? n = (await s.request({
            method: "solana_signMessage",
            params: {
                message: kl.encode(new TextEncoder().encode(r)),
                pubkey: i
            }
        }, p.state.activeCaipNetwork ? .caipNetworkId)).signature : n = await s.request({
    ...
    async switchNetwork(e) {
        ...
        if (s.chainNamespace === z.CHAIN.EVM) try {
            ...
            if (i.code === ii.ERROR_CODE_UNRECOGNIZED_CHAIN_ID || i.code === ii.ERROR_INVALID_CHAIN_ID || i.code === ii.ERROR_CODE_DEFAULT || i ? .data ? .originalError ? .code === ii.ERROR_CODE_UNRECOGNIZED_CHAIN_ID) try {
                await r.provider ? .request({
...
const $C = ["email", "socials", "swaps", "onramp", "activity", "reownBranding"],
    Yi = {
        email: {
        ...
        socials: {
            ...
            processFallback: t => t === void 0 ? be.DEFAULT_REMOTE_FEATURES.socials : typeof t == "boolean" ? t ? be.DEFAULT_REMOTE_FEATURES.socials : !1 : t
        },
        swaps: {
            apiFeatureName: "swap",
            ...
            processFallback: t => t === void 0 ? be.DEFAULT_REMOTE_FEATURES.swaps : typeof t == "boolean" ? t ? be.DEFAULT_REMOTE_FEATURES.swaps : !1 : t
        },
        onramp: {
            ...
            processFallback: t => t === void 0 ? be.DEFAULT_REMOTE_FEATURES.onramp : typeof t == "boolean" ? t ? be.DEFAULT_REMOTE_FEATURES.onramp : !1 : t
        },
        activity: {
    ...
    xC = {
        ...
        processApiFeature(t, e) {
            return Yi[t].processApi(e)
        },
        processFallbackFeature(t, e) {
            return Yi[t].processFallback(e)
        },
        async fetchRemoteFeatures(t) {
            ...
            const n = i && !e ? be.DEFAULT_REMOTE_FEATURES : be.DEFAULT_REMOTE_FEATURES_DISABLED;
            try {
                for (const o of $C) {
...
class RC {
    constructor(e) {
        this.chainNamespaces = [], this.remoteFeatures = {}, this.reportedAlertErrors = {}, this.getCaipNetwork = (s, r) => {
            if (s) {
                const i = p.getNetworkData(s) ? .requestedCaipNetworks ? .find(a => a.id === r);
                if (i) return i;
                const n = p.getNetworkData(s) ? .caipNetwork;
                return n || p.getRequestedCaipNetworks(s).filter(a => a.chainNamespace === s) ? .[0]
            }
            ...
            J.setClientId(s)
        }, this.getProvider = s => _e.getProvider(s), this.getProviderType = s => _e.getProviderId(s), this.getPreferredAccountType = s => W.state.preferredAccountTypes ? .[s], this.setCaipAddress = (s, r) => {
            W.setCaipAddress(s, r), s && S.state.enableEmbedded && this.close()
            ...
            p.setChainNetworkData(r, {
                caipNetwork: s
            })
        }, this.setAllAccounts = (s, r) => {
            W.setAllAccounts(s, r), S.setHasMultipleAddresses(s ? .length > 1)
        }, this.setStatus = (s, r) => {
            W.setStatus(s, r), j.isConnected() ? F.setConnectionStatus("connected") : F.setConnectionStatus("disconnected")
        }, this.getAddressByChainNamespace = s => p.getAccountProp("address", s), this.setConnectors = s => {
            const r = [...j.state.allConnectors, ...s];
            j.setConnectors(r)
        }, this.setConnections = (s, r) => {
            Y.setConnections(s, r)
        }, this.fetchIdentity = s => J.fetchIdentity(s), this.getReownName = s => ai.getNamesForAddress(s), this.getConnectors = () => j.getConnectors(), this.getConnectorImage = s => Rl.getConnectorImage(s), this.setConnectedWalletInfo = (s, r) => {
            const i = _e.getProviderId(r),
                n = s ? { ...s,
                    type: i
                } : void 0;
    ...
    async initialize(e) {
        this.initializeProjectSettings(e), this.initControllers(e), await this.initChainAdapters(), this.sendInitializeEvent(e), await this.syncExistingConnection(), this.remoteFeatures = await xC.fetchRemoteFeatures(e), S.setRemoteFeatures(this.remoteFeatures), this.remoteFeatures.onramp && uo.setOnrampProviders(this.remoteFeatures.onramp), (S.state.remoteFeatures ? .email || Array.isArray(S.state.remoteFeatures ? .socials) && S.state.remoteFeatures ? .socials.length > 0) && await this.checkAllowedOrigins()
    }
    async checkAllowedOrigins() {
        const e = await V.fetchAllowedOrigins();
        if (e && X.isClient()) {
            const s = window.location.origin;
            nn.isOriginAllowed(s, e, ii.DEFAULT_ALLOWED_ANCESTORS) || xs.open(fr.ALERT_ERRORS.INVALID_APP_CONFIGURATION, "error")
        } else xs.open(fr.ALERT_ERRORS.PROJECT_ID_NOT_CONFIGURED, "error")
    }
    ...
    setUnsupportedNetwork(e) {
        ...
        if (s) {
            const r = mr.getUnsupportedNetwork(`${s}:${e}`);
            p.setActiveCaipNetwork(r)
        }
    }
    getDefaultNetwork() {
        return mr.getCaipNetworkFromStorage(this.defaultCaipNetwork)
    }
    extendCaipNetwork(e, s) {
        return mr.extendCaipNetwork(e, {
            customNetworkImageUrls: s.chainImages,
            projectId: s.projectId
        })
    }
    extendCaipNetworks(e) {
        return mr.extendCaipNetworks(e.networks, {
    ...
    extendDefaultCaipNetwork(e) {
        ...
        return s ? mr.extendCaipNetwork(s, {
            customNetworkImageUrls: e.chainImages,
            customRpcUrls: e.customRpcUrls,
            projectId: e.projectId
        }) : void 0
    ...
    async disconnectNamespace(e) {
        try {
            const s = this.getAdapter(e),
                r = _e.getProvider(e),
                i = _e.getProviderId(e),
                {
                    caipAddress: n
                } = p.getAccountData(e) || {};
            this.setLoading(!0, e), n && s ? .disconnect && await s.disconnect({
                provider: r,
                providerType: i
            }), F.removeConnectedNamespace(e), _e.resetChain(e), this.setUser(void 0, e), this.setStatus("disconnected", e), this.setConnectedWalletInfo(void 0, e), j.removeConnectorId(e), p.resetAccount(e), p.resetNetwork(e), this.setLoading(!1, e)
        } catch (s) {
    ...
    createClients() {
        this.connectionControllerClient = {
            connectWalletConnect: async () => {
                ...
                this.close(), this.setClientId(i ? .clientId || null), F.setConnectedNamespaces([...p.state.chains.keys()]), this.chainNamespaces.forEach(n => {
                    j.setConnectorId(hs.CONNECTOR_TYPE_WALLET_CONNECT, n)
            ...
            connectExternal: async ({
                ...
                const d = this.getCaipNetwork(l),
                    h = await u.connect({
                        ...
                        socialUri: a,
                        chainId: o ? .id || d ? .id,
                        rpcUrl: o ? .rpcUrls ? .default ? .http ? .[0] || d ? .rpcUrls ? .default ? .http ? .[0]
                    });
                if (!h) return;
                F.addConnectedNamespace(l), this.syncProvider({ ...h,
                    chainNamespace: l
                });
                ...
                this.setAllAccounts(m, l), this.setStatus("connected", l), this.syncConnectedWalletInfo(l)
            },
            reconnectExternal: async ({
                ...
                }), F.addConnectedNamespace(n), this.syncConnectedWalletInfo(n))
            },
            disconnect: async e => {
                const s = sC(e);
                try {
                    const r = await Promise.allSettled(s.map(async ([n]) => this.disconnectNamespace(n)));
                    de.resetSend(), Y.resetWcConnection(), await hi.clearSessions(), j.setFilterByNamespace(void 0);
                    const i = r.filter(n => n.status === "rejected");
                    if (i.length > 0) throw new Error(i.map(n => n.reason.message).join(", "));
                    F.deleteConnectedSocialProvider(), Se.sendEvent({
                        type: "track",
            ...
            signMessage: async e => (await this.getAdapter(p.state.activeChain) ? .signMessage({
                message: e,
            ...
            sendTransaction: async e => {
                ...
                if (be.SEND_SUPPORTED_NAMESPACES.includes(s)) {
                    const r = this.getAdapter(p.state.activeChain),
                        i = _e.getProvider(s);
                    return (await r ? .sendTransaction({ ...e,
            ...
            getEnsAddress: async e => await nn.resolveReownName(e),
            writeContract: async e => {
                const s = this.getAdapter(p.state.activeChain),
                    r = this.getCaipNetwork(),
                    i = this.getCaipAddress(),
                    n = _e.getProvider(p.state.activeChain);
                if (!r || !i) throw new Error("CaipNetwork or CaipAddress is undefined");
                return (await s ? .writeContract({ ...e,
                    caipNetwork: r,
                    provider: n,
                    caipAddress: i
                })) ? .hash
            },
            parseUnits: (e, s) => this.getAdapter(p.state.activeChain) ? .parseUnits({
                value: e,
                decimals: s
            }) ? ? 0 n,
            formatUnits: (e, s) => this.getAdapter(p.state.activeChain) ? .formatUnits({
                value: e,
                decimals: s
            }) ? ? "0",
            getCapabilities: async e => await this.getAdapter(p.state.activeChain) ? .getCapabilities(e),
            grantPermissions: async e => await this.getAdapter(p.state.activeChain) ? .grantPermissions(e),
            revokePermissions: async e => {
                const s = this.getAdapter(p.state.activeChain);
                return s ? .revokePermissions ? await s.revokePermissions(e) : "0x"
            },
            walletGetAssets: async e => await this.getAdapter(p.state.activeChain) ? .walletGetAssets(e) ? ? {},
            updateBalance: e => {
    ...
    getApprovedCaipNetworksData() {
        if (_e.getProviderId(p.state.activeChain) === hs.CONNECTOR_TYPE_WALLET_CONNECT) {
    ...
    async switchCaipNetwork(e) {
        ...
        if (this.getAddressByChainNamespace(e.chainNamespace)) {
            const i = _e.getProvider(s),
                n = _e.getProviderId(s);
            if (e.chainNamespace === p.state.activeChain) await this.getAdapter(s) ? .switchNetwork({
                caipNetwork: e,
                provider: i,
                providerType: n
            });
            else if (this.setCaipNetwork(e), n === hs.CONNECTOR_TYPE_WALLET_CONNECT) this.syncWalletConnectAccount();
            else {
    ...
    listenAdapter(e) {
        ...
        r === "connected" ? this.setStatus("connecting", e) : r === "disconnected" ? (F.clearAddressCache(), this.setStatus(r, e)) : this.setStatus(r, e), s.on("switchNetwork", ({
            address: i,
            chainId: n
        }) => {
            ...
            o && n ? this.syncAccount({
                ...
                chainId: n,
                chainNamespace: e
            }) : o && p.state.activeCaipNetwork ? .id ? this.syncAccount({
                address: i,
                chainId: p.state.activeCaipNetwork ? .id,
                chainNamespace: e
    ...
    async syncNamespaceConnection(e) {
        try {
            e === z.CHAIN.EVM && X.isSafeApp() && j.setConnectorId(z.CONNECTOR_ID.SAFE, e);
            const s = j.getConnectorId(e);
    ...
    async syncAdapterConnection(e) {
        const s = this.getAdapter(e),
            r = j.getConnectorId(e),
            i = this.getCaipNetwork(e),
            o = j.getConnectors(e).find(a => a.id === r);
        try {
            ...
            if (a) {
                ...
                c && c.accounts.length > 0 ? this.setAllAccounts(c.accounts, e) : this.setAllAccounts([X.createAccount(e, a.address, "eoa")], e), this.syncProvider({ ...a,
                    chainNamespace: e
                }), await this.syncAccount({ ...a,
                    chainNamespace: e
    ...
    async syncWalletConnectAccount() {
        const e = this.chainNamespaces.map(async s => {
            const r = this.getAdapter(s),
                ...
                n = p.state.activeCaipNetwork ? .id,
                o = i.find(a => {
                    const {
                        chainId: c
                    } = as.parseCaipAddress(a);
                    return c === n ? .toString()
                }) || i[0];
            if (o) {
                const a = as.validateCaipAddress(o),
                    {
                        chainId: c,
                        address: l
                    } = as.parseCaipAddress(a);
                if (_e.setProviderId(s, hs.CONNECTOR_TYPE_WALLET_CONNECT), this.caipNetworks && p.state.activeCaipNetwork && r ? .namespace !== z.CHAIN.EVM) {
                    ...
                    _e.setProvider(s, u)
                } else _e.setProvider(s, this.universalProvider);
                j.setConnectorId(z.CONNECTOR_ID.WALLET_CONNECT, s), F.addConnectedNamespace(s), this.syncWalletConnectAccounts(s), await this.syncAccount({
                    address: l,
                    chainId: c,
                    chainNamespace: s
                })
    ...
    syncWalletConnectAccounts(e) {
        const s = this.universalProvider ? .session ? .namespaces ? .[e] ? .accounts ? .map(r => {
            const {
                address: i
            } = as.parseCaipAddress(r);
            return i
        }).filter((r, i, n) => n.indexOf(r) === i);
        s && this.setAllAccounts(s.map(r => X.createAccount(e, r, e === "bip122" ? "payment" : "eoa")), e)
    }
    syncProvider({
        type: e,
        provider: s,
        ...
        _e.setProviderId(i, e), _e.setProvider(i, s), j.setConnectorId(r, i)
    }
    ...
    async syncAccount(e) {
        const s = e.chainNamespace === p.state.activeChain,
            ...
            {
                chainId: a
            } = F.getActiveNetworkProps(),
            c = n || a,
            l = p.state.activeCaipNetwork ? .name === z.UNSUPPORTED_NETWORK_NAME,
            u = p.getNetworkProp("supportsAllNetworks", o);
        if (this.setStatus("connected", o), !(l && !u) && c) {
            let d = this.getCaipNetworks().find(m => m.id.toString() === c.toString()),
                h = this.getCaipNetworks().find(m => m.chainNamespace === o);
            if (!u && !d && !h) {
                const m = this.getApprovedCaipNetworkIds() || [],
                    w = m.find(y => as.parseCaipNetworkId(y) ? .chainId === c.toString()),
                    g = m.find(y => as.parseCaipNetworkId(y) ? .chainNamespace === o);
                d = this.getCaipNetworks().find(y => y.caipNetworkId === w), h = this.getCaipNetworks().find(y => y.caipNetworkId === g || "deprecatedCaipNetworkId" in y && y.deprecatedCaipNetworkId === g)
            }
            const f = d || h;
            f ? .chainNamespace === p.state.activeChain ? S.state.enableNetworkSwitch && !S.state.allowUnsupportedChain && p.state.activeCaipNetwork ? .name === z.UNSUPPORTED_NETWORK_NAME ? p.showUnsupportedChainUI() : this.setCaipNetwork(f) : s || r && this.setCaipNetworkOfNamespace(r, o), this.syncConnectedWalletInfo(o), na.isLowerCaseMatch(i, W.state.address) || this.syncAccountInfo(i, f ? .id, o), s ? await this.syncBalance({
                address: i,
                chainId: f ? .id,
                chainNamespace: o
    ...
    syncConnectedWalletInfo(e) {
        const s = j.getConnectorId(e),
            r = _e.getProviderId(e);
        if (r === hs.CONNECTOR_TYPE_ANNOUNCED || r === hs.CONNECTOR_TYPE_INJECTED) {
            if (s) {
                ...
                if (i) {
                    const {
                        ...
                        name: o,
                        imageUrl: a
                    } = i, c = a || this.getConnectorImage(i);
        ...
        } else if (r === hs.CONNECTOR_TYPE_WALLET_CONNECT) {
            const i = _e.getProvider(e);
            i ? .session && this.setConnectedWalletInfo({ ...i.session.peer.metadata,
    ...
    async syncBalance(e) {
        !$l.getNetworksByNamespace(this.getCaipNetworks(), e.chainNamespace).find(r => r.id.toString() === e.chainId ? .toString()) || !e.chainId || await this.updateNativeBalance(e.address, e.chainId, e.chainNamespace)
    }
    async ready() {
    ...
    async initializeUniversalAdapter() {
        ...
        S.setManualWCControl(!!this.options ? .manualWCControl), this.universalProvider = this.options.universalProvider ? ? await tC.init(s), this.listenWalletConnect()
    }
    listenWalletConnect() {
        this.universalProvider && (this.universalProvider.on("display_uri", e => {
            ...
            if (nn.isSessionEventData(e)) {
                const {
                    name: s,
                    data: r
                } = e.params.event;
                s === "accountsChanged" && Array.isArray(r) && X.isCaipAddress(r[0]) && this.syncAccount(as.parseCaipAddress(r[0]))
            }
        }))
    }
    createUniversalProvider() {
        return !this.universalProviderInitPromise && X.isClient() && this.options ? .projectId && (this.universalProviderInitPromise = this.initializeUniversalAdapter()), this.universalProviderInitPromise
    }
    ...
    handleAlertError(e) {
        const s = Object.entries(fr.UniversalProviderErrors).find(([, {
                message: a
        ...
        if (r && n && !this.reportedAlertErrors[r]) {
            const a = fr.ALERT_ERRORS[o];
            a && (xs.open(a, "error"), this.reportedAlertErrors[r] = !0)
        }
    }
    getAdapter(e) {
    ...
    async open(e) {
        return await this.injectModalUi(), e ? .uri && Y.setUri(e.uri), e ? .arguments && e ? .view === "Swap" ? Fe.open({ ...e,
            data: {
                swap: e.arguments
            }
        }) : Fe.open(e)
    ...
    async close() {
        await this.injectModalUi(), Fe.close()
    }
    setLoading(e, s) {
        Fe.setLoading(e, s)
    }
    ...
    async switchNetwork(e) {
        ...
        if (!s) {
            xs.open(fr.ALERT_ERRORS.SWITCH_NETWORK_NOT_FOUND, "error");
            return
        }
    ...
    setThemeMode(e) {
        pt.setThemeMode(e), Ed(pt.state.themeMode)
    }
    ...
    setThemeVariables(e) {
        pt.setThemeVariables(e), SC(pt.state.themeVariables)
    }
    subscribeTheme(e) {
    ...
    subscribeAccount(e, s) {
        ...
        s ? p.subscribeChainProp("accountState", r, s) : p.subscribe(r), j.subscribe(r)
    }
    subscribeNetwork(e) {
        return p.subscribe(({
            activeCaipNetwork: s
    ...
    getConnectMethodsOrder() {
        return qo.getConnectOrderMethod(S.state.features, j.getConnectors())
    }
    addNetwork(e, s) {
...
class Id extends RC {
    ...
    async injectModalUi() {
        if (!Pl && X.isClient()) {
            if (await no(() =>
                    import ("./basic-pibtUUpJ.js"), __vite__mapDeps([3, 4, 1, 2])), await no(() =>
                    import ("./w3m-modal-f4LYPdeb.js"), __vite__mapDeps([5, 4, 1, 2])), !document.querySelector("w3m-modal")) {
...
export {
    V as A, gd as B, j as C, Fo as D, Se as E, xr as F, ZC as G, pp as H, Sa as I, zl as J, rp as K, fp as L, Fe as M, QC as N, S as O, XC as P, mn as Q, re as R, F as S, pt as T, tI as U, eI as V, qo as W, fI as X, rn as a, cI as b, X as c, tn as d, hI as e, Rl as f, Y as g, z as h, Ir as i, p as j, xt as k, Rt as l, be as m, qe as n, pI as o, bt as p, Xe as q, dI as r, Ze as s, Ae as t, hi as u, xs as v, lI as w, oC as x, W as y, uI as z
};
//# sourceMappingURL=core-1l-sul3R.js.map